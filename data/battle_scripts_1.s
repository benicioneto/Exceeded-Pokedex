...
gBattleScriptsForMoveEffects::
	...
	.4byte BattleScript_EffectSpecialPharmacy         @ EFFECT_SPECIAL_PHARMACY
	...
	.4byte BattleScript_EffectEclipse                 @ EFFECT_BYPASS_ACCURACY_CHECK_IN_NIGHT_LOWER_SPATK_ON_HIT
	.4byte BattleScript_EffectHit                     @ EFFECT_SOLAR_BEAM
	.4byte BattleScript_EffectThunder                 @ EFFECT_BYPASS_ACCURACY_CHECK_IN_RAIN_PARALYZE_ON_HIT
	...
	.4byte BattleScript_EffectArgumentEffectHit       @ EFFECT_REVENGE
	.4byte BattleScript_EffectBrickBreak              @ EFFECT_BRICK_BREAK
	.4byte BattleScript_EffectYawn                    @ EFFECT_YAWN
	.4byte BattleScript_EffectKnockOff                @ EFFECT_USER_REMOVE_TARGET_ITEM_ON_HIT
	...
	.4byte BattleScript_EffectVCreate                 @ EFFECT_LOWER_USER_DEF_SPDEF_SPEED
	...
	.4byte BattleScript_EffectThroatChop              @ EFFECT_TARGET_CANNOT_USE_SOUND_MOVES
	...
	.4byte BattleScript_EffectHit                     @ EFFECT_DAMAGE_USING_SPECIFIC_STAT
	...
	.4byte BattleScript_EffectHit			          @ EFFECT_PHOTON_GEYSER placeholder
	.4byte BattleScript_EffectPoisonHit	 	          @ EFFECT_SHELL_SIDE_ARM
	...
	.4byte BattleScript_EffectHit										@ EFFECT_MAGICAL_BULLET	unused
	...
	.4byte BattleScript_EffectSacredFire								@ EFFECT_DAMAGE_FOE_OR_HEAL_AND_REMOVE_STATUS_ALLY
	...
	.4byte BattleScript_EffectPoisonHit									@ EFFECT_DOUBLE_DAMAGE_ON_POISON_STATUS_APPLY_POISON_ON_HIT
	.4byte BattleScript_EffectTripleArrows								@ EFFECT_TRIPLE_ARROWS
	.4byte BattleScript_EffectArgumentEffectHit							@ EFFECT_DOUBLE_DAMAGE_ON_ANY_STATUS_APPLY_STATUS_ON_HIT
	.4byte BattleScript_EffectCeaselessEdge								@ EFFECT_SET_SPIKES_ON_HIT
	...
	.4byte BattleScript_EffectEbonFirst									@ EFFECT_ONLY_EXECUTED_AFTER_SPECIFIC_MOVE
	...
	.4byte BattleScript_EffectHit           							@ EFFECT_IMPROVISED_BLOW
	.4byte BattleScript_EffectMarriagetoxin           					@ EFFECT_MARRIAGETOXIN
	.4byte BattleScript_EffectBlackShroud           					@ EFFECT_BLACK_SHROUD
	.4byte BattleScript_EffectAllergicExplosion           				@ EFFECT_ALLERGIC_EXPLOSION
	.4byte BattleScript_EffectColosseumTerrain           				@ EFFECT_COLOSSEUM_TERRAIN
	.4byte BattleScript_EffectDraconicTerrain           				@ EFFECT_DRACONIC_TERRAIN
	.4byte BattleScript_EffectArgumentEffectHit           				@ EFFECT_ARGUMENT_HIT
	.4byte BattleScript_EffectHit                     					@ EFFECT_TARGET_BLAST_COMBO
	.4byte BattleScript_EffectDizzyPunch                     			@ EFFECT_DIZZY_PUNCH
	.4byte BattleScript_EffectOasisWellspring                 			@ EFFECT_OASIS_WELLSPRING
	.4byte BattleScript_EffectAbsorb50									@ EFFECT_CROWSTORM
	.4byte BattleScript_EffectStatDownPerTurn         					@ EFFECT_TARGET_STAT_DOWN_1_EVERY_TURN
	.4byte BattleScript_EffectDehydrate		         					@ EFFECT_DEHYDRATE
	.4byte BattleScript_EffectChillingWisp               				@ EFFECT_CHILLING_WHISP
	.4byte BattleScript_EffectHungryFeast               				@ EFFECT_HUNGRY_FEAST
	.4byte BattleScript_EffectPillage		               				@ EFFECT_USER_STEAL_ALL_TARGET_ITEM_ON_HIT
	.4byte BattleScript_EffectDefendOrder               				@ EFFECT_DEFEND_ORDER
	.4byte BattleScript_EffectSummerTime	               				@ EFFECT_SUMMER_TIME
	.4byte BattleScript_EffectDeflorestation              				@ EFFECT_DEFLORESTATION
	.4byte BattleScript_EffectScrapyardTerrain             				@ EFFECT_SCRAPYARD_TERRAIN
	.4byte BattleScript_EffectIcyKiss             						@ EFFECT_ICY_KISS
	.4byte BattleScript_EffectHeatedKiss             					@ EFFECT_HEATED_KISS
	.4byte BattleScript_EffectFissure	             					@ EFFECT_USER_REMOVE_ALL_TARGET_ITEM_ON_HIT
	.4byte BattleScript_EffectNeedCertainAbility       					@ EFFECT_USER_NEED_CERTAIN_ABILITY
...
BattleScript_EffectSpecialPharmacy::
	jumpiftype BS_TARGET, TYPE_POISON, BattleScript_SpecialPharmacyHeal
	attackcanceler
	attackstring
	ppreduce
	call BattleScript_TryPoisonTarget
	attackanimation
	waitanimation
...
BattleScript_SpecialPharmacyHeal:
	attackcanceler
	attackstring
	ppreduce
	accuracycheck BattleScript_ButItFailed, NO_ACC_CALC_CHECK_LOCK_ON
	goto BattleScript_PurifyWorks

BattleScript_TryPoisonTarget:
	jumpifstatus BS_TARGET, STATUS1_POISON | STATUS1_TOXIC_POISON, BattleScript_AlreadyPoisoned
	jumpifabilityprotected BS_TARGET, STATUS1_POISON, BattleScript_AbilityProtected
...
BattleScript_EffectCorrosiveGasOnHit::
	...
	trysetcorrosivegas BS_TARGET, BattleScript_EffectCorrosiveGasOnHitEnd
	printstring STRINGID_ITEMMELTED
	waitmessage 0x40
BattleScript_EffectCorrosiveGasOnHitEnd:
	tryfaintmon BS_TARGET, FALSE, NULL
	goto BattleScript_MoveEnd

BattleScript_EffectNeedCertainAbility::
	jumpifbattlerhas BS_ATTACKER, 0, BattleScript_EffectArgumentEffectHit
	goto BattleScript_PokemonCantUseTheMoveDueAbility

BattleScript_EffectFissure::
	call BattleScript_EffectHit_Ret
...
BattleScript_EffectHeatedKiss::
	jumpifoppositegenders BattleScript_HeatedKissEffect
	goto BattleScript_EffectHit
BattleScript_HeatedKissEffect:
	setmoveeffect MOVE_EFFECT_BURN
	goto BattleScript_EffectHit

BattleScript_EffectIcyKiss::
	jumpifoppositegenders BattleScript_IcyKissEffect
	goto BattleScript_EffectHit
BattleScript_IcyKissEffect:
	setmoveeffect MOVE_EFFECT_FROSTBITE
	goto BattleScript_EffectHit

BattleScript_EffectDeflorestation::
	attackcanceler
	attackstring
	ppreduce
	jumpiftype BS_ATTACKER, TYPE_GRASS, BattleScript_DeflorestationWorks
	goto BattleScript_ButItFailed
BattleScript_DeflorestationWorks:
	accuracycheck BattleScript_MoveMissedPause, ACC_CURR_MOVE
	call BattleScript_EffectDamage_Ret
	losetype BS_ATTACKER, TYPE_GRASS
	printstring STRINGID_ATTACKERLOSTGRASSTYPE
	waitmessage B_WAIT_TIME_LONG
	tryfaintmon BS_TARGET, FALSE, NULL
	goto BattleScript_MoveEnd

BattleScript_EffectSummerTime::
	attackcanceler
	attackstring
	ppreduce
	jumpifhalfword CMP_COMMON_BITS, gBattleWeather, WEATHER_SUN_PRIMAL, BattleScript_EffectSummerTimeSunnyDayFailedTryTerrain
	jumpifhalfword CMP_COMMON_BITS, gBattleWeather, WEATHER_RAIN_PRIMAL, BattleScript_EffectSummerTimeSunnyDayFailedTryTerrain
	jumpifhalfword CMP_COMMON_BITS, gBattleWeather, WEATHER_STRONG_WINDS, BattleScript_EffectSummerTimeSunnyDayFailedTryTerrain
	setsunny
	attackanimation
	waitanimation
...
BattleScript_EffectSummerTimeSunnyDaySucessTryTerrain:
	setterrain BattleScript_MoveEnd
	printfromtable gTerrainStartingStringIds
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_EffectSummerTimeSunnyDayFailedTryTerrain:
...
BattleScript_EffectDefendOrder::
	jumpifbattlerorsideability BS_TARGET, ABILITY_BEE_QUEEN, BattleScript_DefendOrderAllStats
	goto BattleScript_EffectCosmicPower
BattleScript_DefendOrderAllStats:
	attackcanceler
	attackstring
	ppreduce
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_ATK, MAX_STAT_STAGE, BattleScript_DefendOrderDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_DEF, MAX_STAT_STAGE, BattleScript_DefendOrderDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPEED, MAX_STAT_STAGE, BattleScript_DefendOrderDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPATK, MAX_STAT_STAGE, BattleScript_DefendOrderDoMoveAnim
...
BattleScript_DefendOrderDoMoveAnim::
	...
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_DefendOrderUpDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_DefendOrderUpDef::
	setstatchanger STAT_DEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_DefendOrderUpSpeed
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_DefendOrderUpSpeed::
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_DefendOrderUpSpAtk
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_DefendOrderUpSpAtk::
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_DefendOrderUpSpDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_DefendOrderUpSpDef::
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_DefendOrderEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_DefendOrderEnd::
	goto BattleScript_MoveEnd

BattleScript_EffectPillage::
	call BattleScript_EffectHit_Ret
...
BattleScript_EffectHungryFeast::
	attackcanceler
	attackstring
	ppreduce
	...
	attackanimation
	waitanimation
BattleScript_HungryFeastEatBerry:
	...
	tryabilityitemremoved BS_ATTACKER, 0
	tryabilityitemremoved BS_ATTACKER, 1
	tryabilityitemremoved BS_ATTACKER, 2
	tryabilityitemremoved BS_ATTACKER, 3
	tryactivatefouldigest BS_ATTACKER
	setstatchanger STAT_ATK, 2, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_HungryFeastEnd
	setgraphicalstatchangevalues
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_HungryFeastEnd @ cant raise atk
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_HungryFeastEnd:
	goto BattleScript_MoveEnd

BattleScript_EffectChillingWisp::
	attackcanceler
	attackstring
	ppreduce
	jumpifsubstituteblocks BattleScript_ButItFailed
	jumpifstatus BS_TARGET, STATUS1_FROSTBITE, BattleScript_AlreadyFrostbited
	jumpiftype BS_TARGET, TYPE_ICE, BattleScript_NotAffected
	jumpifabilityprotected BS_TARGET, STATUS1_FROSTBITE, BattleScript_AbilityProtected
	jumpifstatus BS_TARGET, STATUS1_ANY, BattleScript_ButItFailed
	jumpifterrainaffected BS_TARGET, STATUS_FIELD_MISTY_TERRAIN, BattleScript_MistyTerrainPrevents
	accuracycheck BattleScript_ButItFailed, ACC_CURR_MOVE
	jumpifsafeguard BattleScript_SafeguardProtected
...
BattleScript_EffectDehydrate::
	setmoveeffect MOVE_EFFECT_ABSORB_50 | MOVE_EFFECT_CERTAIN
	setbyte cMULTISTRING_CHOOSER, B_MSG_ABSORB_WATER
	call BattleScript_EffectHit_Ret
	seteffectwithchance
	call TryRemoveTargetTypeFromArgument
	tryfaintmon BS_TARGET, FALSE, NULL
	goto BattleScript_MoveEnd

TryRemoveTargetTypeFromArgument:
	movefailedtoremovebattlertype BS_TARGET, FailedToRemoveType
	printstring STRINGID_TARGETLOSTITSTYPE
	waitmessage B_WAIT_TIME_LONG
FailedToRemoveType:
	return

BattleScript_EffectStatDownPerTurn::
	setmoveeffect MOVE_EFFECT_STAT_DOWN_PER_TURN | MOVE_EFFECT_CERTAIN
	goto BattleScript_EffectHit

BattleScript_EffectOasisWellspring::
	attackcanceler
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
	attackstring
	ppreduce
	call BattleScript_EffectDamage_Ret
	setterrain BattleScript_OasisWellspringEnd
	printfromtable gTerrainStartingStringIds
	waitmessage B_WAIT_TIME_LONG
	playanimation BS_ATTACKER, B_ANIM_RESTORE_BG, NULL
	call BattleScript_TerrainFormChanges
	call BattleScript_TerrainSeedLoop
BattleScript_OasisWellspringEnd:
	tryfaintmon BS_TARGET, FALSE, NULL
	moveendall
	end

BattleScript_EffectDizzyPunch::
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_DRUNKEN_FIST, BattleScript_DoDrunkenFist
	setmoveeffect MOVE_EFFECT_CONFUSE
	goto BattleScript_EffectHit
BattleScript_DoDrunkenFist:
	setmoveeffect MOVE_EFFECT_DRUNKEN_FIST
	goto BattleScript_EffectHit

BattleScript_EffectDrunkenFist::
	printstring STRINGID_TARGETBECOMEDRUNK
	waitmessage B_WAIT_TIME_LONG
	updatestatusicon BS_TARGET
	return

BattleScript_EffectArgumentEffectHit::
	attackcanceler
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
	attackstring
	ppreduce
...
BattleScript_EffectMarriagetoxin::
	attackcanceler
	attackstring
	ppreduce
	accuracycheck BattleScript_ButItFailed, ACC_CURR_MOVE
	setmarriagetoxin BattleScript_ButItFailed
	attackanimation
	waitanimation
	updatestatusicon BS_TARGET
	setallytonexttarget BattleScript_MarriagetoxinAlly
BattleScript_MarriagetoxinAlly:
	updatestatusicon BS_TARGET
	printfromtable gMarriagetoxinStringIds
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_MoveEnd

BattleScript_EffectAllergicExplosion::
	attackcanceler
	attackstring
	ppreduce
	accuracycheck BattleScript_ButItFailed, ACC_CURR_MOVE
	jumpifsafeguard BattleScript_SafeguardProtected
	jumpifkingsgrace BattleScript_KingsGraceProtected
	setallergicexplosion BattleScript_ButItFailed
	attackanimation
	waitanimation
	printfromtable gAllergicExplosionStringIds
	waitmessage B_WAIT_TIME_LONG
	updatestatusicon BS_TARGET
	goto BattleScript_MoveEnd
...
BattleScript_ShowtimeLoop::
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_INNER_FOCUS, BattleScript_ShowtimeLoopIncrement
...
BattleScript_EffectAzureSpyVision:
	...
	attackstring
	ppreduce
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_SLOTTED_SHELL, BattleScript_AzureSpyVisionLoadSpecialBullet
	goto BattleScript_ButItFailed
...
BattleScript_EffectBlackShroud::
	call BattleScript_EffectHit_Ret
	tryfaintmon BS_TARGET, FALSE, NULL
	jumpiffainted BS_TARGET, TRUE, BattleScript_EffectBlackShroud_End
	call BattleScript_ApplyBlackShroud_Ret
BattleScript_EffectBlackShroud_End:
	goto BattleScript_MoveEnd
BattleScript_ApplyBlackShroud_Ret:
	setbattlerstatus BS_TARGET, 4, STATUS4_BLACK_SHROUD, BattleScript_EffectBlackShroud_End
...
BattleScript_EffectSaltCure:
	...
	call BattleScript_ApplySaltCure_Ret
BattleScript_EffectSaltCure_End:
	goto BattleScript_MoveEnd

BattleScript_SaltRitualActivates::
	waitstate
	call BattleScript_AbilityPopUp
BattleScript_ApplySaltCure_Ret:
...
BattleScript_EffectSupersonic:
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_OWN_TEMPO, BattleScript_InnateOwnTempoPrevents
...
BattleScript_EffectDragonCombo::
	...
	attackstring
	ppreduce
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_COMBO_FIST, BattleScript_DragonComboNoHPCost
	damagewithbattlerhp BS_ATTACKER, FALSE
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
BattleScript_DragonComboNoHPCost:
	critcalc
	damagecalc
...
BattleScript_EffectSpellFistAffected::
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_SPELL_FIST, BattleScript_EffectSpAtkUpHit
...
BattleScript_ShedTailSwitchOut::
	...
	switchoutabilities BS_ATTACKER, 0
	switchoutabilities BS_ATTACKER, 1
	switchoutabilities BS_ATTACKER, 2
	switchoutabilities BS_ATTACKER, 3
...
BattleScript_TeatimeLoop:
	...
	tryabilityitemremoved BS_TARGET, 0
	tryabilityitemremoved BS_TARGET, 1
	tryabilityitemremoved BS_TARGET, 2
	tryabilityitemremoved BS_TARGET, 3
	tryactivatefouldigest BS_TARGET
	moveendto MOVEEND_NEXT_TARGET
...
BattleScript_PokemonCantUseTheMoveDueAbility::
	attackstring
	ppreduce
	pause B_WAIT_TIME_SHORT
	printstring STRINGID_BUTPOKEMONCANTUSETHEMOVEDUEABILITY
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_MoveEnd
...
BattleScript_EffectConfusion:
	setmoveeffect MOVE_EFFECT_CONFUSE_BOTH | MOVE_EFFECT_CERTAIN
	goto BattleScript_EffectHit
...
BattleScript_EffectWithdraw:
	...
	attackstring
	ppreduce
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_DEF, MAX_STAT_STAGE BattleScript_WithdrawDoAnim
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPDEF, MAX_STAT_STAGE BattleScript_WithdrawDoAnim
	jumpifstat BS_ATTACKER, CMP_GREATER_THAN, STAT_ATK, MIN_STAT_STAGE, BattleScript_WithdrawDoAnim
	jumpifstat BS_ATTACKER, CMP_GREATER_THAN, STAT_SPATK, MIN_STAT_STAGE, BattleScript_WithdrawDoAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPEED, MIN_STAT_STAGE, BattleScript_ButItFailed
BattleScript_WithdrawDoAnim::
	attackanimation
	waitanimation
	call BattleScript_WithdrawTryDef
	goto BattleScript_MoveEnd
...
BattleScript_WithdrawTryDef:
	...
	setstatchanger STAT_DEF, 2, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR | MOVE_EFFECT_CERTAIN, BattleScript_WithdrawTrySpDef
...
BattleScript_WithdrawTrySpDef:
	setstatchanger STAT_SPDEF, 2, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR | MOVE_EFFECT_CERTAIN, BattleScript_WithdrawTryAttack
...
BattleScript_WithdrawTryAttack:
	...
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_WithdrawTrySpAtk
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_WithdrawTrySpAtk:
	...
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_WithdrawTrySpeed
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_WithdrawTrySpeed:
	setstatchanger STAT_SPEED, 1, TRUE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR | MOVE_EFFECT_CERTAIN, BattleScript_WithdrawReturn
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_WithdrawReturn
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_WithdrawReturn:
	return
...
BattleScript_EffectWarmUp:
	...
	printstring STRINGID_PKMNREGAINEDHEALTH
	waitmessage B_WAIT_TIME_LONG
	jumpifbattlerorsideability BS_TARGET, ABILITY_MULTITYPE, BattleScript_MoveEnd
	jumpifbattlerorsideability BS_TARGET, ABILITY_RKS_SYSTEM, BattleScript_MoveEnd
...
BattleScript_FlingMiracleSeed:
	...
	setmoveeffect MOVE_EFFECT_LEECH_SEED | MOVE_EFFECT_CERTAIN
	seteffectwithchance
	goto BattleScript_FlingEnd
...
BattleScript_EffectStatDownEveryTurn::
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPEED, MIN_STAT_STAGE, BattleScript_EffectStatDownEveryTurnEnd
	playanimation BS_ATTACKER, B_ANIM_TURN_TRAP, sB_ANIM_ARG1
	waitanimation
BattleScript_EffectStatDownEveryTurnDoAnim::
	statbuffchange 0, NULL
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_FELL, BattleScript_EffectStatDownEveryTurnEnd
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_EffectStatDownEveryTurnEnd:
	end2
...
BattleScript_FirstTurnChargingEffect:
	...
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_SHALLOW_DIVER, BattleScript_ShallowDiver
...
BattleScript_EffectMagneticFluxStart:
	jumpifbattlerorsideability BS_TARGET, ABILITY_MINUS, BattleScript_EffectMagneticFluxCheckStats
	jumpifbattlerorsideability BS_TARGET, ABILITY_PLUS, BattleScript_EffectMagneticFluxCheckStats
...
BattleScript_EffectGearUpStart:
	jumpifbattlerorsideability BS_TARGET, ABILITY_MINUS, BattleScript_EffectGearUpCheckStats
	jumpifbattlerorsideability BS_TARGET, ABILITY_PLUS, BattleScript_EffectGearUpCheckStats
...
BattleScript_EffectHitSwitchTarget:
	...
	call BattleScript_EffectDamage_Ret
	tryfaintmon BS_TARGET, FALSE, NULL
	jumpifbattlerorsideability BS_TARGET, ABILITY_SUCTION_CUPS, BattleScript_AbilityPreventsPhasingOut
...
BattleScript_EffectVenomDrenchCanBeUsed:
	...
	attackanimation
	waitanimation
	setmoveeffect MOVE_EFFECT_VENOM_DRENCH
	seteffectprimary
	goto BattleScript_MoveEnd

BattleScript_MoveEffectVenomDrench::
...
BattleScript_EffectSoak:
	...
	attackstring
	ppreduce
	jumpifbattlerorsideability BS_TARGET, ABILITY_MULTITYPE, BattleScript_ButItFailed
	jumpifbattlerorsideability BS_TARGET, ABILITY_RKS_SYSTEM, BattleScript_ButItFailed
	jumpifsubstituteblocks BattleScript_ButItFailed
	attackanimation
	waitanimation
...
BattleScript_EffectColosseumTerrain::
BattleScript_EffectDraconicTerrain::
BattleScript_EffectScrapyardTerrain::
	attackcanceler
	attackstring
	ppreduce
	setterrain BattleScript_ButItFailed
...
BattleScript_EffectMircleEye:
	...
	waitmessage B_WAIT_TIME_LONG
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPATK, MAX_STAT_STAGE, BattleScript_MiracleEyeDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_ACC, MAX_STAT_STAGE, BattleScript_MiracleEyeEnd
BattleScript_MiracleEyeDoMoveAnim:
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_SPATK  | BIT_ACC, 0
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_MiracleEyeTryAcc
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_MiracleEyeTryAcc
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_MiracleEyeTryAcc:
	setstatchanger STAT_ACC, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_MiracleEyeEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_MiracleEyeEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_MiracleEyeEnd:
	goto BattleScript_MoveEnd
...
BattleScript_EffectHealBlock:
	...
	attackstring
	ppreduce
	jumpifbattlerorsideability BS_TARGET_SIDE, ABILITY_AROMA_VEIL, BattleScript_AromaVeilProtects
...
BattleScript_EffectHitEscape:
	...
	call BattleScript_EffectDamage_Ret
	jumpifmovehadnoeffect BattleScript_MoveEnd
	jumpifbattlerorsideability BS_TARGET, ABILITY_GUARD_DOG, BattleScript_MoveEnd
	seteffectwithchance
	tryfaintmon BS_TARGET, FALSE, NULL
...
BattleScript_EffectNaturalGift:
	...
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_KLUTZ, BattleScript_ButItFailed
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_OLD_SCHOOL, BattleScript_ButItFailed
...
BattleScript_EffectSleep::
	...
	jumpifuproar BattleScript_CantMakeAsleep
	jumpifabilityprotected BS_TARGET, STATUS1_SLEEP, BattleScript_AbilityProtected
	jumpifstatus BS_TARGET, STATUS1_ANY, BattleScript_ButItFailed
...
BattleScript_MirrorHerbCopyStatChange::
	...
	tryabilityitemremoved BS_SCRIPTING, 0
	tryabilityitemremoved BS_SCRIPTING, 1
	tryabilityitemremoved BS_SCRIPTING, 2
	tryabilityitemremoved BS_SCRIPTING, 3
	tryactivatefouldigest BS_SCRIPTING
...
BattleScript_MoveEffectAbsorb::
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_LIQUID_OOZE, BattleScript_AbsorbLiquidOoze
	jumpifbattlerorsideability BS_TARGET, ABILITY_ROUGH_SKIN, BattleScript_NegateRoughSkin
...
BattleScript_EffectExplosion::
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_SIEGE_PAYLOAD, BattleScript_EffectMindBlown
	attackcanceler
	attackstring
	ppreduce
...
BattleScript_EffectForceHealing::
	...
	printstring STRINGID_PKMNREGAINEDHEALTH
	waitmessage B_WAIT_TIME_LONG
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_LORD_SITH, BattleScript_EffectForceHealingStatus
	goto BattleScript_MoveEnd
...
BattleScript_EffectToxic::
	...
	seteffectprimary
	resultmessage
	setadditionalmoveeffect BS_TARGET
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_MoveEnd
...
BattleScript_EffectTriAttackFireType:
	critcalc
	customdamagecalculation MOVE_NONE, TYPE_FIRE, 0, TRUE, TRUE
	adjustdamage
	attackanimation
	waitanimation
	effectivenesssound
...
BattleScript_EffectTriAttackElectricType:
	critcalc
	customdamagecalculation MOVE_NONE, TYPE_ELECTRIC, 0, TRUE, TRUE
	adjustdamage
	effectivenesssound
	hitanimation BS_TARGET
	waitstate
...
BattleScript_EffectTriAttackIceType:
	critcalc
	customdamagecalculation MOVE_NONE, TYPE_ICE, 0, TRUE, TRUE
	adjustdamage
	effectivenesssound
	hitanimation BS_TARGET
	waitstate
...
BattleScript_EffectRest::
	...
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_COMATOSE, BattleScript_RestIsAlreadyAsleep
	jumpifuproar BattleScript_RestCantSleep
	jumpifabilityprotected BS_TARGET, STATUS1_SLEEP, BattleScript_AbilityProtected
...
BattleScript_EffectLeechSeed::
	...
	ppreduce
	jumpifsubstituteblocks BattleScript_ButItFailed
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_PHYTOPARASITE, BattleScript_SkipGrassImmunity
	jumpiftype BS_TARGET, TYPE_GRASS, BattleScript_NotAffected
BattleScript_SkipGrassImmunity:
	jumpifstatus3 BS_TARGET, STATUS3_LEECHSEED, BattleScript_NotAffected
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
...
BattleScript_EffectParalyze:
	...
	attackstring
	ppreduce
	jumpifabilityprotected BS_TARGET, STATUS1_PARALYSIS, BattleScript_AbilityProtected
	jumpifsubstituteblocks BattleScript_ButItFailed
...
BattleScript_EffectSnore::
	attackcanceler
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_COMATOSE, BattleScript_SnoreIsAsleep
...
BattleScript_EffectSleepTalk::
	attackcanceler
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_COMATOSE, BattleScript_SleepTalkIsAsleep
...
BattleScript_EffectNightmare::
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_COMATOSE, BattleScript_NightmareWorked
	goto BattleScript_ButItFailed
...
BattleScript_IdentifiedFoe:
	...
	printstring STRINGID_PKMNIDENTIFIED
	waitmessage B_WAIT_TIME_LONG
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_ATK, MAX_STAT_STAGE, BattleScript_ForesightDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_ACC, MAX_STAT_STAGE, BattleScript_ForesightEnd
BattleScript_ForesightDoMoveAnim:
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_ATK  | BIT_ACC, 0
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_ForesightTryAcc
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ForesightTryAcc
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ForesightTryAcc:
	setstatchanger STAT_ACC, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_ForesightEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ForesightEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ForesightEnd:
	goto BattleScript_MoveEnd
...
BattleScript_PerishSongLoop::
	jumpifbattlerorsideability BS_TARGET, ABILITY_SOUNDPROOF, BattleScript_PerishSongBlocked
...
BattleScript_EffectFickleBeam::
	jumpifword CMP_COMMON_BITS, gHitMarker, HITMARKER_NO_ATTACKSTRING | HITMARKER_NO_PPDEDUCT, BattleScript_EffectFickleBeamTarget 
	attackcanceler
	attackstring
	ppreduce
	ficklebeamdamagecalculation BattleScript_EffectFickleBeamTarget
	pause B_WAIT_TIME_SHORT
	printstring STRINGID_FICKLEBEAMDOUBLED
	waitmessage B_WAIT_TIME_LONG
BattleScript_EffectFickleBeamTarget:
	accuracycheck BattleScript_MoveMissedPause, ACC_CURR_MOVE
	goto BattleScript_HitFromCritCalc
...
BattleScript_FirstTurnSemiInvulnerable::
	...
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_SHALLOW_DIVER, BattleScript_ShallowDiver2
	jumpifnoholdeffect BS_ATTACKER, HOLD_EFFECT_POWER_HERB, BattleScript_MoveEnd
	call BattleScript_PowerHerbActivation
...
BattleScript_EffectWillOWisp::
	...
	jumpifabilityprotected BS_TARGET, STATUS1_BURN, BattleScript_AbilityProtected
	jumpifstatus BS_TARGET, STATUS1_ANY, BattleScript_ButItFailed
	jumpifterrainaffected BS_TARGET, STATUS_FIELD_MISTY_TERRAIN, BattleScript_MistyTerrainPrevents
	accuracycheck BattleScript_ButItFailed, ACC_CURR_MOVE
	jumpifsafeguard BattleScript_SafeguardProtected
...
BattleScript_AlreadyFrostbited::
	setalreadystatusedmoveattempt BS_ATTACKER
	pause B_WAIT_TIME_SHORT
...
BattleScript_EffectCharge::
	...
	ppreduce
	setcharge BS_TARGET
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPDEF, MAX_STAT_STAGE, BattleScript_ChargeUpDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPEED, MAX_STAT_STAGE, BattleScript_CantRaiseMultipleStats
BattleScript_ChargeUpDoMoveAnim::
	attackanimation
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_SPDEF | BIT_SPEED, 0
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_ChargeUpTrySpeed
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ChargeUpTrySpeed
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ChargeUpTrySpeed::
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_ChargeUpEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ChargeUpEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ChargeUpEnd::
	goto BattleScript_MoveEnd
...
BattleScript_EffectYawn::
	...
	jumpifkingsgrace BattleScript_KingsGraceProtected
	accuracycheck BattleScript_ButItFailed, NO_ACC_CALC_CHECK_LOCK_ON
	jumpifuproar BattleScript_ButItFailed
...
BattleScript_TeeterDanceLoop::
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_OWN_TEMPO, BattleScript_TeeterDanceInnateOwnTempoPrevents
...
BattleScript_FaintAttacker::
	...
	tryactivateabilitiesonfaint BS_ATTACKER, 0
	tryactivateabilitiesonfaint BS_ATTACKER, 1
	tryactivateabilitiesonfaint BS_ATTACKER, 2
	tryactivateabilitiesonfaint BS_ATTACKER, 3
	tryactivateabilitiesonpartnerfaint BS_ATTACKER, 0
	tryactivateabilitiesonpartnerfaint BS_ATTACKER, 1
	tryactivateabilitiesonpartnerfaint BS_ATTACKER, 2
	tryactivateabilitiesonpartnerfaint BS_ATTACKER, 3
...
BattleScript_FaintTarget::
	...
	tryactivatesoulheart
	tryactivatesouleater
	tryactivateabilitiesonfaint BS_TARGET, 0
	tryactivateabilitiesonfaint BS_TARGET, 1
	tryactivateabilitiesonfaint BS_TARGET, 2
	tryactivateabilitiesonfaint BS_TARGET, 3
	tryactivateabilitiesonpartnerfaint BS_TARGET, 0
	tryactivateabilitiesonpartnerfaint BS_TARGET, 1
	tryactivateabilitiesonpartnerfaint BS_TARGET, 2
	tryactivateabilitiesonpartnerfaint BS_TARGET, 3
	tryactivateattackerabilitiesonfaint 0
	tryactivateattackerabilitiesonfaint 1
	tryactivateattackerabilitiesonfaint 2
	tryactivateattackerabilitiesonfaint 3
...
BattleScript_GenericTerrainEnds::
	printstring STRINGID_GENERICTERRAINENDS
	waitmessage B_WAIT_TIME_LONG
	playanimation BS_ATTACKER, B_ANIM_RESTORE_BG, NULL
	call BattleScript_TerrainFormChanges
	end2
...
BattleScript_LeechSeedTurnDrain::
	call BattleScript_LeechSeedDrainReturn
	end2 

BattleScript_LeechSeedDrainReturn:
	playanimation BS_ATTACKER, B_ANIM_LEECH_SEED_DRAIN, sB_ANIM_ARG1
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
	copyword gBattleMoveDamage, gHpDealt
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_LIQUID_OOZE, BattleScript_LeechSeedTurnPrintLiquidOoze
...
BattleScript_CordycepsTurnDrain::
	...
	datahpupdate BS_ATTACKER
	copyword gBattleMoveDamage, gHpDealt
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_LIQUID_OOZE, BattleScript_CordycepsTurnPrintLiquidOoze
...
BattleScript_RoarSuccessRet_Ret:
	switchoutabilities BS_TARGET, 0
	switchoutabilities BS_TARGET, 1
	switchoutabilities BS_TARGET, 2
	switchoutabilities BS_TARGET, 3
...
BattleScript_StickyWebDmgHazardsOnAttacker::
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
	call BattleScript_PrintHurtByDmgHazards
	tryfaintmon BS_ATTACKER, FALSE, NULL
	tryfaintmon BS_ATTACKER, TRUE, BattleScript_DmgHazardsOnAttackerFainted
	call BattleScript_StickyWebDmgHazardsLowerSpeed
	return
...
BattleScript_StickyWebDmgHazardsOnTarget::
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	healthbarupdate BS_TARGET
	datahpupdate BS_TARGET
	call BattleScript_PrintHurtByDmgHazards
	tryfaintmon BS_TARGET, FALSE, NULL
	tryfaintmon BS_TARGET, TRUE, BattleScript_DmgHazardsOnTargetFainted
BattleScript_StickyWebDmgHazardsLowerSpeed:
	savetarget
	copybyte gBattlerTarget, sBATTLER
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_StickyWebDmgOnSwitchInEnd
	jumpifbyte CMP_LESS_THAN, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_StickyWebDmgOnSwitchInStatAnim
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_FELL_EMPTY, BattleScript_StickyWebDmgOnSwitchInEnd
	pause B_WAIT_TIME_SHORT
	goto BattleScript_StickyWebDmgOnSwitchInPrintStatMsg
BattleScript_StickyWebDmgOnSwitchInStatAnim:
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
BattleScript_StickyWebDmgOnSwitchInPrintStatMsg:
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_StickyWebDmgOnSwitchInEnd:
	restoretarget
	return
...
BattleScript_SpatialWarp_End3::
	call BattleScript_SpatialWarpAttackerActivates
	setsemiinvulnerablehelper BS_ATTACKER, 1
	end3
...
BattleScript_SelectingNotAllowedMoveColosseum::
	printselectionstring STRINGID_PKMNCANTUSEMOVECOLOSSEUM
	endselectionscript

BattleScript_MoveUsedIsColosseum::
	printstring STRINGID_PKMNCANTUSEMOVECOLOSSEUM
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_MoveEnd
...
BattleScript_LastRitesTakesPp::
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNLOSTPPABILITY
	waitmessage B_WAIT_TIME_LONG
	return
...
BattleScript_RiftwalkedMsg::
	copybyte gBattlerAbility, gBattlerTarget
	pause B_WAIT_TIME_SHORTEST
	call BattleScript_AbilityPopUp
	printstring STRINGID_RIFTWALKED
	waitmessage B_WAIT_TIME_LONG
	return
...
BattleScript_SAtkDown1::
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_SPATK, STAT_CHANGE_CANT_PREVENT | STAT_CHANGE_NEGATIVE
	setstatchanger STAT_SPATK, 1, TRUE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | MOVE_EFFECT_CERTAIN | STAT_CHANGE_ALLOW_PTR, BattleScript_SAtkDown1End
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_SAtkDown1End
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_SAtkDown1End::
	return
...
BattleScript_MoveEffectStatTwoDown::
...
BattleScript_MoveUsedIsVigilanceRet::
	printstring STRINGID_PKMNFASTASLEEP
	waitmessage B_WAIT_TIME_LONG
	statusanimation BS_ATTACKER
	call BattleScript_AbilityPopUp
...
BattleScript_PowderMoveNoEffect::
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_OVERCOAT, BattleScript_PowderMoveNoEffectInnateOvercoat
	jumpifbattlerorsideability BS_TARGET, ABILITY_SOOT_VEIL, BattleScript_PowderMoveNoEffectInnateOvercoat
...
BattleScript_MoveUsedFlinched::
	...
	waitmessage B_WAIT_TIME_LONG
	jumpifbattlerorsideability BS_ATTACKER ABILITY_STEADFAST BattleScript_TryActivateSteadFast
...
BattleScript_MoveUsedIsConfused::
	...
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_TANGLED_FEET, BattleScript_AbilityProtect
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_HEADACHE, BattleScript_AbilityProtect
...
BattleScript_MoveUsedIsEnraged::
	printstring STRINGID_PKMNISENRAGED
	waitmessage B_WAIT_TIME_LONG
	playanimation BS_ATTACKER, B_ANIM_ENRAGED, NULL
	waitanimation
	@status2animation BS_ATTACKER, STATUS2_CONFUSION
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, FALSE, BattleScript_MoveUsedIsEnragedRet
BattleScript_UseRandomMove::
	cancelmultiturnmoves BS_ATTACKER
	printstring STRINGID_USEDRANDOMMOVE
	waitmessage B_WAIT_TIME_LONG
BattleScript_MoveUsedIsEnragedRet::
	return
...
BattleScript_TurbulenceActivates::
	bicword gHitMarker, HITMARKER_NO_ATTACKSTRING | HITMARKER_ATTACKSTRING_PRINTED
	attackstring
	ppreduce
	pause B_WAIT_TIME_SHORT
	...
	@hitanimation BS_ATTACKER
	@waitstate
	playmoveanimation BS_ATTACKER, MOVE_GUST
	waitanimation
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
	printstring STRINGID_TURBULENCE
	waitmessage B_WAIT_TIME_LONG
	tryfaintmon BS_ATTACKER, FALSE, NULL
	goto BattleScript_MoveEnd
...
BattleScript_MoveEffectRecoil::
	...
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_ROCK_HEAD, BattleScript_RecoilEnd
...
BattleScript_DefiantActivates::
	...
	call BattleScript_AbilityPopUp
	statbuffchange 0, NULL
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_FELL, BattleScript_DefiantActivatesEnd
	setgraphicalstatchangevalues
	playanimation BS_ABILITY_BATTLER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printstring STRINGID_DEFENDERSSTATROSE
	waitmessage B_WAIT_TIME_LONG
BattleScript_DefiantActivatesEnd:
	return

BattleScript_SubjugateActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER, NULL
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_FELL, BattleScript_DefiantActivatesEnd
	setgraphicalstatchangevalues
	playanimation BS_ABILITY_BATTLER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
...
BattleScript_FoulDigestActivates::
	call BattleScript_AbilityPopUp
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE | HITMARKER_IGNORE_DISGUISE
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
	printstring STRINGID_ACTIVE_BATTLER_WAS_HURT_BY_ABILITY
	waitmessage B_WAIT_TIME_LONG
	tryfaintmon BS_ATTACKER, FALSE, NULL
	restoreattacker
	return

BattleScript_IncreaseOneStatStageAfterConsumingItem::
	copybyte sSAVED_BATTLER, gBattlerAttacker
	copybyte gBattlerAttacker, gBattlerAbility
	call BattleScript_AbilityPopUp
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_BUFF_NOT_PROTECT_AFFECTED | MOVE_EFFECT_CERTAIN, NULL
...
BattleScript_BerryBulkActivates::
	copybyte sSAVED_BATTLER, gBattlerAttacker
	copybyte gBattlerAttacker, gBattlerAbility
	call BattleScript_AbilityPopUp
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_DEF, MAX_STAT_STAGE, BattleScript_BerryBulkDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPDEF, MAX_STAT_STAGE, BattleScript_CantRaiseMultipleStats
BattleScript_BerryBulkDoMoveAnim::
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_DEF | BIT_SPDEF, 0
	setstatchanger STAT_DEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_BerryBulkTrySpDef
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_BerryBulkTrySpDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_BerryBulkTrySpDef::
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_BerryBulkEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_BerryBulkEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_BerryBulkEnd::
	copybyte gBattlerAttacker, sSAVED_BATTLER
	return
...
BattleScript_HibernateActivates::
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_COMATOSE, BattleScript_HibernateReturn
	jumpifuproar BattleScript_HibernateReturn
...
BattleScript_NurseryActivates::
	call BattleScript_AbilityPopUp
	printstring STRINGID_NURSERYACTIVATES
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_StormcallActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printstring STRINGID_ASTORMWASCALLED
	waitstate
	playanimation BS_BATTLER_0, B_ANIM_RAIN_CONTINUES, NULL
	call BattleScript_WeatherFormChanges
	return
...
BattleScript_FrightenActivatesLoop:
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_GUARD_DOG, BattleScript_FrightenInReverse
...
BattleScript_IntimidateActivatesLoop:
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_GUARD_DOG, BattleScript_IntimidateInReverse
...
BattleScript_TropicalBreezeActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printfromtable gTerrainStartingStringIds
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_TerrainAbilitySurgeActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printfromtable gTerrainStartingStringIds
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_SpacetimeStrainActivates::
	setbyte gBattlerTarget, 0
	call BattleScript_AbilityPopUp
BattleScript_SpatialDistortionLoop:
	jumpifmagicguarded BS_TARGET, BattleScript_SpatialDistortionIncrement
	trygetnextabilitytarget ABILITY_SPACETIME_STRAIN, BattleScript_SpatialDistortionEnd
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	printstring STRINGID_SPACETIMESTRAIN
	waitmessage B_WAIT_TIME_LONG
	healthbarupdate BS_TARGET
	datahpupdate BS_TARGET
	tryfaintmon BS_TARGET, FALSE, NULL
...
BattleScript_AntimatterVeilActivates::
	setbyte gBattlerTarget, 0
	call BattleScript_AbilityPopUp
BattleScript_AntimatterVeilLoop:
	jumpifmagicguarded BS_TARGET, BattleScript_AntimatterVeilIncrement
	trygetnextabilitytarget ABILITY_ANTIMATTER_VEIL, BattleScript_AntimatterVeilEnd
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	printstring STRINGID_ANTIMATTER_VEIL
	waitmessage B_WAIT_TIME_LONG
	healthbarupdate BS_TARGET
	datahpupdate BS_TARGET
	tryfaintmon BS_TARGET, FALSE, NULL
	goto BattleScript_AntimatterVeilIncrement
BattleScript_AntimatterVeilIncrement:
	addbyte gBattlerTarget, 1
	goto BattleScript_AntimatterVeilLoop
BattleScript_AntimatterVeilEnd:
	end3

BattleScript_TookAttackDueAbility::
	attackstring
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
...
BattleScript_AbilityPrevention::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printstring STRINGID_ITDOESNTAFFECT
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_ObliviousProtected::
	attackstring
	ppreduce
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
...
BattleScript_RemodelingFrameActivates::
	call BattleScript_AbilityPopUp
...
BattleScript_RenewingSpinesActivates::
	copybyte sSAVED_BATTLER, gBattlerAttacker
	copybyte gBattlerAttacker, gBattlerAbility
	call BattleScript_AbilityHpHeal
	copybyte gBattlerAttacker, sSAVED_BATTLER
...
BattleScript_InfusedCoreActivates::
	call BattleScript_AbilityPopUp
	printstring STRINGID_INFUSED_CORE
	waitmessage B_WAIT_TIME_LONG
	return

BattleScript_DNARecombinationActivates::
	call BattleScript_AbilityPopUp
	printstring STRINGID_DNA_RECOMBINATION
	waitmessage B_WAIT_TIME_LONG
	return

BattleScript_MistyEscapeActivates::
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNCHANGEDTYPEWITH
	waitmessage B_WAIT_TIME_LONG
	return

BattleScript_MistyEscapeSwitchIn::
	call BattleScript_MistyEscapeActivates
	end3
...
BattleScript_TurtleUpActivates::
	call BattleScript_AbilityPopUp
...
BattleScript_PowerObeliskActivates::
	call BattleScript_AbilityPopUp
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_SPATK | BIT_SPDEF, 0
	setstatchanger STAT_SPATK, 6, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_PowerObeliskTryDef
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_PowerObeliskTryDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_PowerObeliskTryDef::
	setstatchanger STAT_SPDEF, 6, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_PowerObeliskEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_PowerObeliskEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_PowerObeliskEnd::
	end3

BattleScript_FullThrottleActivates::
	call BattleScript_AbilityPopUp
	setstatchanger STAT_SPEED, 6, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_BUFF_NOT_PROTECT_AFFECTED | MOVE_EFFECT_CERTAIN, BattleScript_FullThrottleEnd
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	waitanimation
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_FullThrottleEnd::
	end3
...
BattleScript_DrunkenFistActivates::
	...
	playmoveanimation BS_TARGET, MOVE_NONE
	waitanimation
	printstring STRINGID_BECOMEDRUNK
	waitmessage B_WAIT_TIME_LONG
	end3
...
BattleScript_AttackerAbilityLoweredAttackerStatOnMoveEnd::
	call BattleScript_AbilityPopUp
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_BUFF_NOT_PROTECT_AFFECTED, NULL
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	waitanimation
	printstring STRINGID_ATTACKERABILITYLOWEREDOWNSTAT
	waitmessage B_WAIT_TIME_LONG
	return

BattleScript_AttackerAbilityLoweredTargetStatOnMoveEnd::
	call BattleScript_AbilityPopUp
	statbuffchange STAT_BUFF_NOT_PROTECT_AFFECTED, BattleScript_AttackerAbilityLoweredTargetStatOnMoveEndReturn
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_AttackerAbilityLoweredTargetStatOnMoveEndReturn
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	waitanimation
	printstring STRINGID_BATTLERABILITYLOWEREDSTAT
	waitmessage B_WAIT_TIME_LONG
BattleScript_AttackerAbilityLoweredTargetStatOnMoveEndReturn:
	return
...
BattleScript_TargetAbilityTwoStatsLowerOnMoveEnd::
	call BattleScript_AbilityPopUp
	jumpifbyteequal sSTATCHANGER, sZero, BattleScript_TargetSecondLower
	statbuffchange MOVE_EFFECT_CERTAIN | STAT_BUFF_NOT_PROTECT_AFFECTED, BattleScript_TargetSecondLower
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_FELL, BattleScript_TargetSecondLower
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_TargetSecondLower:
	jumpifbyteequal sSAVED_STAT_CHANGER, sZero, BattleScript_TargetAbilityLowerEnd
	copybyte sSTATCHANGER, sSAVED_STAT_CHANGER
	statbuffchange MOVE_EFFECT_CERTAIN | STAT_BUFF_NOT_PROTECT_AFFECTED, BattleScript_TargetAbilityLowerEnd
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_FELL, BattleScript_TargetAbilityLowerEnd
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_TargetAbilityLowerEnd:
	updatestatusicon BS_TARGET
	return

BattleScript_AttackerAbilityTwoStatsRaiseOnMoveEnd::
	call BattleScript_AbilityPopUp
	jumpifbyteequal sSTATCHANGER, sZero, BattleScript_AttackerSecondRaise
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | MOVE_EFFECT_CERTAIN | STAT_BUFF_NOT_PROTECT_AFFECTED, BattleScript_AttackerSecondRaise
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_ROSE, BattleScript_AttackerSecondRaise
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_AttackerSecondRaise:
	jumpifbyteequal sSAVED_STAT_CHANGER, sZero, BattleScript_AttackerAbilityRaiseEnd
	copybyte sSTATCHANGER, sSAVED_STAT_CHANGER
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | MOVE_EFFECT_CERTAIN | STAT_BUFF_NOT_PROTECT_AFFECTED, BattleScript_AttackerAbilityRaiseEnd
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_ROSE, BattleScript_AttackerAbilityRaiseEnd
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_AttackerAbilityRaiseEnd:
	updatestatusicon BS_ATTACKER
	return
...
BattleScript_WeakArmorTrySpeed:
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_TARGET, BIT_SPEED | BIT_ATK | BIT_SPATK, STAT_CHANGE_MULTIPLE_STATS
	setstatchanger STAT_SPEED, 1, FALSE
...
BattleScript_OuroborosActivates::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_OUROBOROS_COUNT
	waitmessage B_WAIT_TIME_LONG
	return	
...
BattleScript_DelibirdRidesWyrdeer::
	call BattleScript_AbilityPopUp
	playmoveanimation BS_TARGET, MOVE_DELIBIRD_RIDE
	waitanimation
	printstring STRINGID_DELIBIRD_RIDES
	waitmessage B_WAIT_TIME_LONG
	call BattleScript_AllStatsUpTwice
	tatsugiriinvulnerable BS_TARGET, TRUE
	end3
...
BattleScript_SwitchInCoilUp::
	...
	playstatchangeanimation BS_ATTACKER, BIT_ATK | BIT_DEF | BIT_ACC, 0
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_CoilUpTryDef
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_CoilUpTryDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_CoilUpTryDef:
	setstatchanger STAT_DEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_CoilUpTryAcc
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_CoilUpTryAcc
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_CoilUpTryAcc:
	setstatchanger STAT_ACC, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_CoilUpEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_CoilUpEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_CoilUpEnd:
	end3

BattleScript_SwitchInChargeUp::
	call BattleScript_AbilityPopUp
	playmoveanimation BS_TARGET, MOVE_NONE
	waitanimation
	printfromtable gSwitchInAbilityStringIds
	...
	playstatchangeanimation BS_ATTACKER, BIT_SPDEF | BIT_SPEED, 0
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_ChargeUpTrySpeed2
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ChargeUpTrySpeed2
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ChargeUpTrySpeed2:
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_ATTACKER | STAT_CHANGE_ALLOW_PTR, BattleScript_ChargeUpEnd2
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ChargeUpEnd2
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ChargeUpEnd2:
	end3
...
BattleScript_ReactiveArmorActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE | HITMARKER_IGNORE_DISGUISE
	healthbarupdate BS_ATTACKER
...
BattleScript_VampireAscendantActivates::
	call BattleScript_AbilityPopUp
	swapattackerwithtarget
	call BattleScript_LeechSeedDrainReturn
	swapattackerwithtarget
...
BattleScript_PhantomStarFirstTechnique::
	call BattleScript_AbilityPopUp	
	playmoveanimation BS_TARGET, MOVE_DESTINY_BOND
	printstring STRINGID_PHANTOMFISTTECHNIQUE
	waitmessage B_WAIT_TIME_LONG
	return
...
BattleScript_CoralFilterEffect::
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE
	bichalfword gMoveResultFlags, MOVE_RESULT_NO_EFFECT
	healthbarupdate BS_TARGET
	datahpupdate BS_TARGET
...
BattleScript_WaterloggingActivates::
	waitstate
	call BattleScript_AbilityPopUp
	printstring STRINGID_TRANSFORMEDINTOWATERTYPE
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_MagicalDustActivates::
	waitstate
	call BattleScript_AbilityPopUp
...
BattleScript_ToxicDustActivates::
	waitstate
	call BattleScript_AbilityPopUp
	playmoveanimation BS_ATTACKER, MOVE_POISON_POWDER
	swapattackerwithtarget
	printstring STRINGID_BATTLERTYPECHANGEDTO
	waitmessage B_WAIT_TIME_LONG
	swapattackerwithtarget
...
BattleScript_PowderDustActivates::
	waitstate
	call BattleScript_AbilityPopUp
	playmoveanimation BS_ATTACKER, MOVE_POWDER
	swapattackerwithtarget
	printstring STRINGID_COVEREDINPOWDER
	waitmessage B_WAIT_TIME_LONG
	swapattackerwithtarget
...
BattleScript_BombardimentActivates::
	waitstate
	call BattleScript_AbilityPopUp
	playmoveanimation BS_ATTACKER, MOVE_ROCK_THROW
	swapattackerwithtarget
	customdamagecalculation MOVE_ROCK_THROW, TYPE_ROCK, 50, TRUE, FALSE
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_PASSIVE_DAMAGE
	hitanimation BS_TARGET
	healthbarupdate BS_TARGET
	datahpupdate BS_TARGET
...
BattleScript_BlinkActivates::
	waitstate
	call BattleScript_AbilityPopUp
	@swapattackerwithtarget
	playanimation BS_TARGET, B_ANIM_BLINK, NULL
	waitanimation
	printstring STRINGID_ABILITYTELEPORT
	waitmessage B_WAIT_TIME_LONG
	setbattlerstatus BS_TARGET, 3, STATUS3_PHANTOM_FORCE, BattleScript_BlinkReturn
	setsemiinvulnerablehelper BS_TARGET, 1
BattleScript_BlinkReturn:
	@swapattackerwithtarget
	return
...
BattleScript_MutualismActivates::
	waitstate
	copybyte gBattlerAbility, sBATTLER
	call BattleScript_AbilityPopUp
	pause B_WAIT_TIME_LONG
	...
	playanimation BS_ABILITY_BATTLER, B_ANIM_FORM_CHANGE, NULL
	waitanimation
	getCommensalismDMG 1
	printstring STRINGID_SKRELPUSEDMOVE
	waitmessage B_WAIT_TIME_LONG
	hitanimation BS_TARGET
	waitstate
	changespeciesto BS_ATTACKER SPECIES_CORSOLA
	handleformchange BS_ABILITY_BATTLER, 0
	handleformchange BS_ABILITY_BATTLER, 1
	playanimation BS_ABILITY_BATTLER, B_ANIM_FORM_CHANGE, NULL
	waitanimation
...
BattleScript_ItemHealHP_RemoveItemRet::
	jumpifbattlerorsideability BS_SCRIPTING, ABILITY_RIPEN, BattleScript_ItemHealHP_RemoveItemRet_AbilityPopUp
...
BattleScript_ItemHealHP_RemoveItemEnd2::
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_RIPEN, BattleScript_ItemHealHP_RemoveItemEnd2_AbilityPopUp
...
BattleScript_BerryPPHealRet::
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_RIPEN, BattleScript_BerryPPHeal_AbilityPopup
...
BattleScript_SelectingNotAllowedMoveCannonMode::
	printselectionstring STRINGID_CANNONMODEDOESNTALLOW
	endselectionscript
...
BattleScript_BerryConfuseHealEnd2::
	jumpifbattlerorsideability BS_SCRIPTING, ABILITY_RIPEN, BattleScript_BerryConfuseHealEnd2_AbilityPopup
...
BattleScript_BerryConfuseHealRet::
	jumpifbattlerorsideability BS_SCRIPTING, ABILITY_RIPEN, BattleScript_BerryConfuseHealRet_AbilityPopup
...
BattleScript_BerryStatRaiseEnd2::
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_RIPEN, BattleScript_BerryStatRaiseEnd2_AbilityPopup
...
BattleScript_BerryStatRaiseRet::
	jumpifbattlerorsideability BS_SCRIPTING, ABILITY_RIPEN, BattleScript_BerryStatRaiseRet_AbilityPopup
...
BattleScript_MicleBerryActivateEnd2::
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_RIPEN, BattleScript_MicleBerryActivateEnd2_Ripen
...
BattleScript_MicleBerryActivateRet::
	jumpifbattlerorsideability BS_SCRIPTING, ABILITY_RIPEN, BattleScript_MicleBerryActivateRet_Ripen
...
BattleScript_JabocaRowapBerryActivates::
	jumpifbattlerorsideability BS_TARGET, ABILITY_RIPEN, BattleScript_JabocaRowapBerryActivate_Ripen
...
BattleScript_Pickpocket::
	call BattleScript_AbilityPopUp
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_STICKY_HOLD, BattleScript_PickpocketPrevented
	jumpifbattlerorsideability BS_ATTACKER, ABILITY_WEAPON_BOND, BattleScript_PickpocketPrevented2
	swapattackerwithtarget
...
BattleScript_PickpocketPrevented2:
	sethword sABILITY_OVERWRITE, ABILITY_WEAPON_BOND
	pause B_WAIT_TIME_SHORT
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_ITEMCANNOTBEREMOVED
...
BattleScript_RedCardActivates::
	...
	jumpifbattlerorsideability BS_EFFECT_BATTLER, ABILITY_SUCTION_CUPS, BattleScript_RedCardSuctionCups
...
BattleScript_StenchSwitchBattlers:
	...
	jumpifbattlerorsideability BS_TARGET, ABILITY_SUCTION_CUPS, BattleScript_StenchSuctionCups
...
BattleScript_EjectButtonActivates::
	...
	switchoutabilities BS_SCRIPTING, 0
	switchoutabilities BS_SCRIPTING, 1
	switchoutabilities BS_SCRIPTING, 2
	switchoutabilities BS_SCRIPTING, 3
