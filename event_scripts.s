...
Common_EventScript_ReceivedMint:
	msgbox gText_ReceivedMint, MSGBOX_DEFAULT
	release
	end

Common_EventScript_GiveOneMint:
    msgbox gText_Collected, MSGBOX_DEFAULT
    call Common_EventScript_GiveMint
    return

Common_EventScript_GiveTwoMint:
    msgbox gText_Collected, MSGBOX_DEFAULT
    call Common_EventScript_GiveMint
    call Common_EventScript_GiveMint
    return

Common_EventScript_GiveThreeMint:
    msgbox gText_Collected, MSGBOX_DEFAULT
    call Common_EventScript_GiveMint
    call Common_EventScript_GiveMint
    call Common_EventScript_GiveMint
...
Common_EventScript_GiveMint:
    random 21
    switch VAR_RESULT
    case 0, GiveLonelyMint
    case 1, GiveAdamantMint
    case 2, GiveNaughtyMint
    case 3, GiveBraveMint
    case 4, GiveBoldMint
    case 5, GiveImpishMint
    case 6, GiveLaxMint
    case 7, GiveRelaxedMint
    case 8, GiveModestMint
    case 9, GiveMildMint
    case 10, GiveRashMint
    case 11, GiveQuietMint
    case 12, GiveCalmMint
    case 13, GiveGentleMint
    case 14, GiveCarefulMint
    case 15, GiveSassyMint
    case 16, GiveTimidMint
    case 17, GiveHastyMint
    case 18, GiveJollyMint
    case 19, GiveNaiveMint
    case 20, GiveSeriousMint
    return
...
gText_ReceivedMint:
	.string "I don't have anymore mints.\n"
	.string "But, you can come back tomorrow!$"

gText_Collected:
	.string "I collected some mints today!$"
	...
	.include "data/maps/MtChimney_PokemonCenter/scripts.inc"

	.include "data/maps/LittlerootTown_ProfessorBirchHouse/scripts.inc"

	.include "data/maps/LittlerootTown_ProfessorBirchHouse_2F/scripts.inc"

	.include "data/maps/OldChateau/scripts.inc"

	.include "data/maps/Ruins_Of_Alph/scripts.inc"
	...
	.include "data/maps/MagmaCave/scripts.inc"

	.include "data/maps/LagoonCave/scripts.inc"

	.include "data/maps/MossdeepCity_Bills_House/scripts.inc"
	...
	.include "data/maps/ProfBirchRanch/scripts.inc"

	.include "data/maps/PacifidlogCave_1F/scripts.inc"

	.include "data/maps/PacifidlogIsland_House1/scripts.inc"

	.include "data/maps/PacifidlogIsland_House2/scripts.inc"

	.include "data/maps/PacifidlogIsland_House3/scripts.inc"

	.include "data/maps/Route141/scripts.inc"

	.include "data/maps/UnderwaterAltar/scripts.inc"

	.include "data/maps/UnderwaterLugiaAltar/scripts.inc"

	.include "data/maps/PetalburgCity_School/scripts.inc"

	.include "data/maps/MauvilleCity_School/scripts.inc"

	.include "data/maps/FortreeCity_School/scripts.inc"

	.include "data/maps/Route142/scripts.inc"

	.include "data/maps/MeteorFalls_BehindWaterfall/scripts.inc"

	.include "data/maps/MeteorFalls_BehindWaterfall_1F/scripts.inc"

	.include "data/maps/MeteorFalls_BehindWaterfall_2F/scripts.inc"

	.include "data/maps/MeteorFalls_DraconidTribe/scripts.inc"

	.include "data/maps/MeteorFalls_ZinniaHouse/scripts.inc"

	.include "data/maps/Meteor_NecrozmaHome/scripts.inc"

	.include "data/maps/MeteorFalls_House2/scripts.inc"

	.include "data/maps/MeteorFalls_House3/scripts.inc"

	.include "data/maps/MeteorFalls_House4/scripts.inc"

	.include "data/maps/MeteorFalls_House5/scripts.inc"

	.include "data/maps/LavaridgeTown_Blacksmith/scripts.inc"

	.include "data/maps/BlacksmithCave/scripts.inc"
