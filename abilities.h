...
static const u8 sOrichalcumPulseDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons harsh sunligh-\nt for five turns that boosts t-\nhe its Attack stat by 33%. Har-\nsh Sunlight: Any Grass-type Po-\nkémon have their Speed stat in-\ncreased by 33%, Solar Beam and\nSolar Blade become one-turn m-\noves, Growth have its effect d-\noubled, Synthesis restore more\nHP.");
...
static const u8 sHemotoxicVenomDescriptionExtended[] = _("When a Pokémon is poisoned by\nthe Pokémon's moves, it will \nalso take double damage from P-\noison status and take addition-\nal 33% damage from contact mov-\nes.");
static const u8 sSolenoglyphs2DescriptionExtended[] = _("The power of biting moves use-\nd by the Pokémon are increased\nby 20% and the chance of seco-\nndary effects doubled. ");
static const u8 sProspectingDescriptionExtended[] = _("The Pokémon deals 20% more da-\nmage to Bug-type Pokémon. Also\n, increases the odds of catchi-\nng Bug-type Pokémon by 25%.");
static const u8 sOccultismDescriptionExtended[] = _("The Pokémon deals 20% more da-\nmage to Bug-type Pokémon. Also\n, increases the odds of catchi-\nng Bug-type Pokémon by 25%.");
static const u8 sSpellweaverDescriptionExtended[] = _("The Pokémon deals 20% more da-\nmage to Bug-type Pokémon. Also\n, increases the odds of catchi-\nng Bug-type Pokémon by 25%.");
static const u8 sTurnToOilDescriptionExtended[] = _("The Pokémon deals 20% more da-\nmage to Bug-type Pokémon. Also\n, increases the odds of catchi-\nng Bug-type Pokémon by 25%.");
...
static const u8 sContaminateDescriptionExtended[] = _("The Pokémon deals 20% more da-\nmage to Bug-type Pokémon. Also\n, increases the odds of catchi-\nng Bug-type Pokémon by 25%.");
static const u8 sSawtoothRushDescriptionExtended[] = _("The Pokémon deals 20% more da-\nmage to Bug-type Pokémon. Also\n, increases the odds of catchi-\nng Bug-type Pokémon by 25%.");
