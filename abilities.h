...
static const u8 sWeaknessExploitDescription[] = _("Moves before weakened foes.");
...
static const u8 sUnicornsHornDescription[] = _("Heal next {PKMN} when KOed.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_UNICORNS_HORN] = _("Unicorn's Horn"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_UNICORNS_HORN] = sUnicornsHornDescription,
...
static const u8 sDrySkinDescriptionExtended[] = _("During harsh sunlight or burn-\ning terrain, the Pokémon will \nlose 1/16 of its maximum HP at\nthe end of each turn. During \nrain or swamp terrain, the Pok-\némon will regain 1/8 of its ma-\nximum HP at the end of each tu-\nrn. Fire-type attacks do 25% m-\nore damage to the Pokémon. Whe-\nn the Pokémon is hit by a Wate-\nr-type move, its HP is restore-\nd by 25% of its maximum HP.");
...
static const u8 sPerfectionistDescriptionExtended[] = _("Increases priority by 1 of mo-\nves with base power of 20 or l-\ness. Increases critical hit ra-\nte by 1 of moves with base pow-\ner of 40 or less. Increases cr-\nitical hit rate by 1 of moves \nwith base power of 60 or less.\nThese effects stacks.");
...
static const u8 sDestructionCocoonDescriptionExtended[] = _("When the Pokémon faints, it t-\nurns into a Cocoon of Destruct-\nion instead. When the Pokémon \nturns into a Cocoon, removes a-\nny status conditions, absorbs \n5% of current HP of all other \nPokémon in the battlefield and\nin both Trainer's party while\nstealing any positive stat st-\nages (if any), but it is unabl-\ne to act. At the end of the tu-\nrn, it awakens as Yveltal.");
...
static const u8 sEternalLifeDescriptionExtended[] = _("When the Pokémon faints, star-\nts a 15 turns countdown. When \nthe countdown reaches 0, it re-\nvives the Pokémon in the end o-\nf the turn while restoring its\nHP by half of its maximum HP \nand PPs to up to 5. Each time \nthe Pokémon faints, increases \nthe next coundown by 15 and re-\nduces the restored HP and PP.");
...
static const u8 sFrictionManeDescriptionExtended[] = _("Whenever the Pokémon uses a d-\namaging move, or other Pokémon\nuses an Electric-type damagin-\ng move, the Pokémon gains 1 fr-\niction charge. When the Pokémo-\nn is hit by a move that makes \ncontact, consumes all charges \nto deal Electric-type damage w-\nith 20 power per charge. If th-\ne Pokémon reaches 4 charges, c-\nonsumes all charges to use Dis-\ncharge.");
...
const u8 *const gAbilityDescriptionExtendedPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_UNICORNS_HORN] = sUnicornsHornDescriptionExtended,
