...
static const u8 sCreationOfSpaceDescriptionExtended[] = _("The Pokémon and its allies ca-\nnnot be affected by moves that\ntarget multiple Pokémon. Also\n, Spacial Rend has a 30% chanc-\ne to trap the target in that d-\nimension.");
static const u8 sGreatEchoDescriptionExtended[] = _("Causes sound-based moves used\nby the Pokémon to become two-\nstrike moves, with the second \nstrike having its damage halve-\nd. It does not affect multi-st-\nrike moves.");
static const u8 sAcidifiedRainDescriptionExtended[] = _("While the Pokémon is on the f-\nield, all non-Poison-type Poké-\nmon takes damage equal to 1/16\nof their maximum HP at the en-\nd of each turn, increased to 1\n/8 against Water- or Steel-typ-\ne Pokémon. Also, increases the\npower of Poison-type moves by\n50% during rain.");
