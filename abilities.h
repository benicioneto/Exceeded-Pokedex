...
static const u8 sSkitterizeDescription[] = _("Normal moves become Flying.");
...
static const u8 sPolarGuardDescription[] = _(".");
...
static const u8 sChargedWebDescription[] = _("Electrify Sticky Web.");
...
static const u8 sSubjugateDescription[] = _(".");
...
static const u8 sPhototropismDescription[] = _(".");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_LOVELY_FRAGRANCE] = _("Loverly Fragrance"),
    ...
    [ABILITY_CHARGED_WEB] = _("Charged Web"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_CHARGED_WEB] = sChargedWebDescription,
...
static const u8 sSpatialWarpDescriptionExtended[] = _("The Pokémon and its allies ca-\nnnot be affected by moves that\ntarget multiple Pokémon. On t-\nhe first turn, Spacial Rend wa-\nrps the user into another dime-\nnsion for the rest of the turn-\n. It also has a 20% chance to \ntrap the target in that dimens-\nion.");
...
static const u8 sNecrotoxicVenomDescriptionExtended[] = _("When a Pokémon is poisoned by\nthe Pokémon's moves, it will \nalso take damage from healing \neffect instead of regaining HP\n, but takes half damage from P-\noison status.");
...
static const u8 sVenomOverdriveDescriptionExtended[] = _("This Pokémon's Poison-type mo-\nves receive STAB regardless of\nits typing. If it hits a pois-\noned target with a damaging mo-\nve, that target becomes badly \npoisoned, or its toxic counter\nincreases by 1 if it is alrea-\ndy badly poisoned.");
...
static const u8 sPolarGuardDescriptionExtended[] = _("(Not Implemented)");
...
static const u8 sThreadlockDescriptionExtended[] = _("When the Pokémon is hit by an\nattack, it raises its defensi-\nve stats by the total number o-\nf the attacker's lowered Speed\nstat stages, up to +6.");
...
static const u8 sSilkenAmbushDescriptionExtended[] = _("When the Pokémon attacks, it \nraises its offensive stats by \nthe total number of the target-\n's lowered Speed stat stages, \nup to +6.");
static const u8 sChargedWebDescriptionExtended[] = _("While the Pokémon is on the f-\nield, opposing Pokémon take da-\nmage when switching in. The da-\nmage is based on Electric-type\neffectiveness against the tar-\nget, starting at 1/8 of its ma-\nximum HP at normal effectivene-\nss.");
...
static const u8 sDirtyFightingDescriptionExtended[] = _("This Pokémon's Dark-type move-\ns receive STAB regardless of i-\nts typing. Also, when the Poké-\nmon attacks with a move that m-\nakes contact, there is a 30% c-\nhance that the opposing Pokémo-\nn will become poisoned. ");
...
static const u8 sInfusedCoreDescriptionExtended[] = _("Each time the Pokémon is hit \nby a type, increases that type\nof moves used by the Pokémon \nfor the rest of the battle by \n33%. 'Regi' Pokémon automatica-\nlly infuses their original typ-\ne.");
...
static const u8 sVigilanceDescriptionExtended[] = _("If the Pokémon executes its m-\nove after all other Pokémon ha-\nve made their move, the damage\ntaken by the Pokémon is reduc-\ned by 30%. Also, the Pokémon m-\nay execute its move even while\nasleep.");
...
static const u8 sSubjugateDescriptionExtended[] = _("(not implemented) When the Po-\nkémon lowers the stat stage of\nan opposing Pokémon, increase-\ns the Pokémon's stat stage by \nthe same amount.");
...
static const u8 sPhototropismDescriptionExtended[] = _("(NOT IMPLEMENTED)");
...
static const u8 sMakerOfOceansDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons swamp terrain-\n. The swamp terrain last as lo-\nng as the Pokémon is in the fi-\neld, and can only be replaced \nby another terrain. Swamp Terr-\nain: Increases the power of Wa-\nter-type and mud moves by 30% \nof Pokémon that are on the gro-\nund, reduces the Speed stat of\nall non-Water-type Pokémon th-\nat are on the ground by 25% an");
static const u8 sMakerOfLandsDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons sandy terrain-\n. The sandy terrain last as lo-\nng as the Pokémon is in the fi-\neld, and can only be replaced \nby another terrain. Sandy Terr-\nain: Increases the power of Gr-\nound-type moves by 30% of Poké-\nmon that are on the ground and\nnon-Ground- and Rock-type Pok-\némon have their Evasion reduce-\nd by 67%. Halves the power of ");
static const u8 sSuperAncientDescriptionExtended[] = _("The Pokémon is immune to stat\nstages reduction, including s-\nelf-inflicted stat stages redu-\nction.");
static const u8 sDragonLordDescriptionExtended[] = _("The power of Dragon-type move-\ns used by the Pokémon and its \nallies is increased by 50%. Th-\nis effect stacks if multiple P-\nokémon with this ability are o-\nn the field. Also, the Pokémon\ntakes 25% less damage from ot-\nher Dragon-type Pokémon.");
...
const u8 *const gAbilityDescriptionExtendedPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_CHARGED_WEB] = sChargedWebDescriptionExtended,
