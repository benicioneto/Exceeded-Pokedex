...
static const u8 sIndomitableDescriptionExtended[] = _("Lowers the Accuracy of status\nmoves used against the Pokémo-\nn to 50%.");
...
static const u8 sMasterFencerDescriptionExtended[] = _("Air Cutter has increased prio-\nrity +1. Fury Cutter always ha-\ns its maximum stacks. Cut igno-\nres target's abilities. Leaf B-\nlade restores 50% of the damag-\ne dealt. Night Slash hits even\nif target switches out.");
...
static const u8 sAsteroidBeltDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Stone Wall. The stone wal-\nl lasts for three turns. Stone\nWall: reduces the damage of p-\nhysical and special moves by h-\nalf, reduced to 1/3 in double \nbattles.");
