...
static const u8 sNocturnalDescriptionExtended[] = _("At night or while under gloom\nmoonlight, it adds the Dark-t-\nype to the Pokémon, in additio-\nn to the Pokémon's original ty-\npe(s). Also, the Speed stat of\nthe Pokémon is doubled while \nunder gloom moonlight.");
...
static const u8 sSpatialWarpDescriptionExtended[] = _("Prevents the Pokémon and its \nallies from being affected by \nmoves that targets more than o-\nne Pokémon.");
static const u8 sTemporalFlowDescriptionExtended[] = _("All opposing Pokémon have the-\nir priority decreased by -1. A-\nlso, Roar of Time makes all ot-\nher Pokémon unable to move dur-\ning the recharge turn.");
...
static const u8 sMaleficentDescriptionExtended[] = _("During a moony night, increas-\nes the Pokémon's highest offen-\nsive stat by 50% but it loses \nHP equal to 1/16 of its maximu-\nm HP every turn.");
...
static const u8 sDarkBribeDescriptionExtended[] = _("During a gloomy moonlight, th-\ne Pokémon's HP is restored by \n1/8 of its maximum HP at the e-\nnd of each turn.");
