...
static const u8 sPlaceholder18Description[] = _("Bites may badly poison.");
...
static const u8 sIroncladKeelDescription[] = _("Adds Steel-type to Pokémon.");
...
static const u8 sPetrifiedWoodDescription[] = _("Grass moves ups defenses.");
...
static const u8 sRewindDescription[] = _("End of turn happens twice.");
static const u8 sAntarcticBirdDescription[] = _("Ups Water-, Ice- & Flying-type.");
...
static const u8 sTapDancerDescription[] = _("Tap dances when dancing.");
...
static const u8 sPlaceholder_15Description[] = _("Decoys after weakened.");
...
static const u8 sDarkSideDescription[] = _("Adds Dark-type to Pokémon.");
...
static const u8 sDragonHoardDescription[] = _("Ups Dragon Breath using gems.");
static const u8 sBugCatcherDescription[] = _("Ups damage against Bugs.");
static const u8 sNeurotoxicVenomDescription[] = _("Poison paralyze foe.");
static const u8 sHemotoxicVenomDescription[] = _("Poison has more damage.");
static const u8 sSolenoglyphsDescription[] = _("Ups biting dmg & effect.");
static const u8 sProspectingDescription[] = _("Ups Def on status moves.");
static const u8 sOccultismDescription[] = _("Ups damage against Bugs.");
static const u8 sSpellweaverDescription[] = _("Ups SpDef on status moves.");
static const u8 sTurnToOilDescription[] = _("All Water becomes Ground.");
static const u8 sCollosusDescription[] = _("Bigger to reduce damage.");
static const u8 sContaminateDescription[] = _("Poison hits Water-type.");
static const u8 sSawtoothRushDescription[] = _("Bite ignores high Defense.");
...
static const u8 sChiliFeverDescription[] = _("Burns the foe on hit.");
static const u8 sRemodelingFrameDescription[] = _("Changes type on hit.");
static const u8 sNurseryDescription[] = _("Heals ally each turn.");
static const u8 sAfterimageDescription[] = _("More Speed more defense.");
static const u8 sAeroVoiceDescription[] = _("Makes sound moves Flying.");
static const u8 sSaltRitualDescription[] = _("Salt Cure on moves.");
static const u8 sVelocityShiftDescription[] = _("Speed as damage.");
static const u8 sFaeBaneDescription[] = _("Fairy protection.");
static const u8 sBombardmentDescription[] = _("Uses Rock Throw.");
static const u8 sHellishResistanceDescription[] = _("Powers up on fire.");
static const u8 sFaeTouchedDescription[] = _("Heals upon switching out.");
static const u8 sLastRitesDescription[] = _("Lose all PP on faint.");
static const u8 sLatentPsycheDescription[] = _("Adds Psychic-type.");
static const u8 sPsionicDominanceDescription[] = _("Draws psychic moves.");
static const u8 sPsionicBacklashDescription[] = _("Special moves hurts.");
static const u8 sMindFractureDescription[] = _("Special moves may confuse.");
static const u8 sGoreRushDescription[] = _(".");
static const u8 sUnerringImpaleDescription[] = _("Bypass acc on full HP.");
static const u8 sPerilousStakeDescription[] = _("Ensures that all moves crit.");
static const u8 sSkySovereignDescription[] = _("Summons Tailwind on entry.");
static const u8 sNecrotoxicVenomDescription[] = _("Poison inverts healing.");
static const u8 sStoneScatterDescription[] = _("Stealth Rock on entry.");
static const u8 sFreecastDescription[] = _(".");
static const u8 sSkullbreakerDescription[] = _("Contact evades protection.");
static const u8 sVenomOverdriveDescription[] = _("Poison moves gain STAB.");
static const u8 sDuneTrapDescription[] = _(".");
static const u8 sSandGliderDescription[] = _("Ups Speed in sandstorm.");
static const u8 sLoverlyFragranceDescription[] = _(".");
static const u8 sDisgustingPollenDescription[] = _("Lowers non-Grass Speed.");
static const u8 sDiamondReflectDescription[] = _("Uses Power Split.");
static const u8 sChainReactionDescription[] = _("Better Shell Trap.");
static const u8 sPowerKegDescription[] = _("Powers up if hit by physi.");
static const u8 sSulfurFeedDescription[] = _("Powers up if hit by poison.");
static const u8 sSmokeSignalDescription[] = _("Switch out after Smog.");
static const u8 sSootVeilDescription[] = _("Prevents added effects.");
static const u8 sReactiveArmorDescription[] = _("Lowered stats hit foe.");
static const u8 sSiegePayloadDescription[] = _("Explosion takes half HP.");
static const u8 sLivingMonolithDescription[] = _("Weight moves are maximized.");
static const u8 sPowerObeliskDescription[] = _("Maximize Special.");
static const u8 sStoneSentinelDescription[] = _("Ally takes half on entry.");
static const u8 sRunicStoneDescription[] = _("Lowered stats up Attack.");
static const u8 sLovelyFragranceDescription[] = _("Lowers non-Grass power.");
static const u8 sGravekeeperDescription[] = _("Up Sp Defense on Cursed.");
static const u8 sOverclockDescription[] = _("Electric or Fire max Speed.");
static const u8 sFlavorAdaptationDescription[] = _(".");
static const u8 sAwakenedMindDescription[] = _("Boost Sp Defense.");
static const u8 sSilentFlightDescription[] = _("Flying prio on first turn.");
static const u8 sTempestWakeDescription[] = _("Whirldpool on entry.");
static const u8 sLeechSporeDescription[] = _("Leech Seed on contact.");
static const u8 sMagmaChamberDescription[] = _(".");
static const u8 sAbyssalWellspringDescription[] = _(".");
static const u8 sFeedingFrenzyDescription[] = _("Damaging moves drain HP.");
static const u8 sDreadfulSmellDescription[] = _(".");
static const u8 sIronChimeDescription[] = _("Lowers damage to partner.");
static const u8 sImprovisedWeaponGrassDescription[] = _("Improvised Blow: Grass.");
static const u8 sImprovisedWeaponSteelDescription[] = _("Improvised Blow: Steel.");
static const u8 sImprovisedWeaponRockDescription[] = _("Improvised Blow: Rock.");
static const u8 sBoneCageDescription[] = _("Inherits fallen's defense.");
static const u8 sSovereignCrestDescription[] = _("Take less damage.");
static const u8 sOilyCarapaceDescription[] = _("Ups defenses after ground.");
static const u8 sPowerOverflowDescription[] = _("Maximize some moves.");
static const u8 sMegaSolDescription[] = _("Moves have sunlight effect.");
static const u8 sPiercingDrillDescription[] = _("Contact evades protection.");
static const u8 sSpicySprayDescription[] = _("Burns attacking Pokémon.");
static const u8 sStormWingsDescription[] = _(".");
static const u8 sSkitterizeDescription[] = _("Normal moves become Bug.");
static const u8 sAdrenalineSurgeDescription[] = _("KOs raise Speed stat.");
static const u8 sPhantomStarFistDescription[] = _("Punch evades protection.");
static const u8 sSunforgedGoldDescription[] = _("Steel resists Fire.");
static const u8 sSilverArmorDescription[] = _("Steel resists Ghost/Dark.");
static const u8 sPolarGuardDescription[] = _("Up def in electric terrain.");
static const u8 sTeslaCoilDescription[] = _(".");
static const u8 sFluxBreakDescription[] = _(".");
static const u8 sColosseumSurgeDescription[] = _("Field becomes colosseum.");
static const u8 sDraconicSurgeDescription[] = _("Field becomes draconic.");
static const u8 sEverburnSpearDescription[] = _("No contact and burns.");
static const u8 sHydrenchymaDescription[] = _("Adds Water-type.");
static const u8 sNightSynthesisDescription[] = _("Sunlight effect at night.");
static const u8 sWaxyGuardDescription[] = _("Raises Defense.");
static const u8 sNeedleSkinDescription[] = _("Hurts to touch.");
static const u8 sMasterPugilistDescription[] = _("Punching moves gain STAB.");
static const u8 sTheWayOfTheKickDescription[] = _("Ups Attack and locks move.");
static const u8 sMartialProdigyDescription[] = _("Ups Punch and Kick moves.");
static const u8 sFutureGazeDescription[] = _("Ups Acc & Eva in sunlight.");
static const u8 sStradivariusDescription[] = _("Sound moves indice sleep.");
static const u8 sPressureBurstDescription[] = _("Its stats change when hit.");
static const u8 sPowerSplasherDescription[] = _("Boosts Splash move.");
static const u8 sJuicemakerDescription[] = _("Hold Juice after berry.");
...
static const u8 sDesertFlowerDescription[] = _("Rain effect at sunlight.");
static const u8 sScarecrowVigilDescription[] = _("Lowers the foe's offense.");
static const u8 sHeavySleeperDescription[] = _("Up defenses while sleeping.");
static const u8 sDeepSlumberDescription[] = _("Regain HP while sleeping.");
static const u8 sLogLauncherDescription[] = _("Launches logs at opponents.");
static const u8 sLumberPillowDescription[] = _("Physical moves indice sleep.");
static const u8 sAllJustADreamDescription[] = _("Prevents fainting once.");
static const u8 sEelevateDescription[] = _("Immune to Ground. Up on KO.");
static const u8 sFireManeDescription[] = _("Boosts Fire-type moves.");
static const u8 sTrainingGroundDescription[] = _("Ups Attack on entry hazards.");
static const u8 sGrappleGuardDescription[] = _(".");
static const u8 sThreadlockDescription[] = _("Resists slowed attackers.");
static const u8 sTrapTerritoryDescription[] = _("Ups Speed on entry hazards.");
static const u8 sSilkenAmbushDescription[] = _("Damages slowed targets.");
static const u8 sElectrifiedWireDescription[] = _("Electrify Sticky Web.");
static const u8 sRogueTacticsDescription[] = _("Boosts certain moves.");
static const u8 sDirtyFightingDescription[] = _("Boosts Dark-type moves.");
static const u8 sPoisonousNestDescription[] = _("Sticky Web & Toxic Spikes.");
...
static const u8 sBerserkFuryDescription[] = _("Ups Attack, use random move.");
static const u8 sIntoxicateDescription[] = _(".");
static const u8 sThirdEyeDescription[] = _("Boosts Psychic-type moves.");
static const u8 sPsionizeDescription[] = _("Normal moves become Psychic.");
static const u8 sScryDescription[] = _("Sets Future Sight.");
static const u8 sWishUponAStarDescription[] = _("Sets Wish.");
static const u8 sOraclesProphecyDescription[] = _("Sets Doom Desire.");
static const u8 sStarlightVeilDescription[] = _("Prevents status moves.");
static const u8 sMilleniumCometDescription[] = _("Immune to Fire.");
static const u8 sSixthSenseDescription[] = _("Psychic moves go first.");
static const u8 sHealingFactorDescription[] = _("Heals each turn.");
static const u8 sWaterloggingDescription[] = _("Water moves changes type.");
static const u8 sBattleAuraDescription[] = _("Boosts Atk, Def & Speed.");
static const u8 sTerraformDescription[] = _(".");
static const u8 sFirstStrikeDescription[] = _("Fighting moves go first.");
static const u8 sDoubleStrikeDescription[] = _("Fighting move strike twice.");
static const u8 sHasteDescription[] = _(".");
static const u8 sLifelinkDescription[] = _("Drains target's HP.");
static const u8 sReachDescription[] = _("Resists Flying-type moves.");
static const u8 sTrampleDescription[] = _("Exceeded dmg on switch in.");
static const u8 sDeathtouchDescription[] = _("Damages on contact.");
static const u8 sCryostasisDescription[] = _("Freezes on KOed.");
static const u8 sGeneralistDescription[] = _("Boosts all move types.");
static const u8 sHexproofDescription[] = _("Prevents added effects.");
static const u8 sHerdLeaderDescription[] = _("Ups stats for each equine.");
static const u8 sMenaceDescription[] = _("Ignore doubles penalty.");
static const u8 sPlaneswalkerDescription[] = _("Vanishes on entry.");
static const u8 sVigilanceDescription[] = _("Moving last boosts defenses.");
static const u8 sHypnoticGazeDescription[] = _("Confuses on entry.");
static const u8 sIndomitableDescription[] = _("May avoid status moves.");
static const u8 sNightstalkerDescription[] = _("Dark moves go first.");
static const u8 sVengefulSpiritDescription[] = _(".");
static const u8 sSpiritualOfferingsDescription[] = _("Changes souls into HP.");
static const u8 sChargeUpDescription[] = _("Charges on entry.");
static const u8 sBattleTranceDescription[] = _(".");
static const u8 sLoveSerenadeDescription[] = _("Heals ally when KOed.");
static const u8 sLostTechnologyDescription[] = _("Removes PP on entry.");
static const u8 sClayVesselDescription[] = _("Heals HP in sandstorm.");
static const u8 sAnimatedConstructDescription[] = _("Prevents status moves.");
static const u8 sOceansCovenantDescription[] = _("Sets Aqua Veil.");
static const u8 sDarkBribeDescription[] = _("Heals at night.");
static const u8 sRevenantCoralDescription[] = _("Ups Rock & Water moves.");
static const u8 sCoralBleachingDescription[] = _("Fire ups Sp. Def.");
static const u8 sZooxanthellaeDescription[] = _("Adds Grass-type.");
static const u8 sDinoflagellateDescription[] = _("Adds Poison-type.");
static const u8 sAlgalShieldDescription[] = _("Immune to Grass moves.");
static const u8 sBarrierReefDescription[] = _("Ups Water mons defenses.");
static const u8 sMutualismDescription[] = _("Skrelp helps.");
static const u8 sUntappedPotencialDescription[] = _("Punch & Kick go first.");
static const u8 sLittleChampionDescription[] = _("Ups Punch & Kick accuracy.");
static const u8 sUnstableCoreDescription[] = _("Uses Self-Destruct on KOed.");
static const u8 sBerryBulkDescription[] = _("Eat berry ups defenses.");
static const u8 sDebilitateDescription[] = _("Lowers stats when poison.");
static const u8 sPolarCurrentDescription[] = _("Summons a hailstorm.");
static const u8 sKillerWhaleDescription[] = _("Sound hurts Water mons.");
static const u8 sEcholocationDescription[] = _("Boosts Accuracy.");
static const u8 sFirebrandDescription[] = _("Fire hits Fire.");
static const u8 sMasterFencerDescription[] = _("Boosts certain moves.");
static const u8 sEnGardeDescription[] = _("Moving last boosts defenses.");
static const u8 sRuthlessPredatorDescription[] = _("Boosts certain moves.");
static const u8 sReignOfAngerDescription[] = _(".");
static const u8 sReindeerRiderDescription[] = _("Rides Wyrdeer.");
static const u8 sDeflectorHullDescription[] = _("Defense boosts Sp. Def.");
static const u8 sLurkingMenaceDescription[] = _("Moves before weakened foes.");
static const u8 sLostKnowledgeDescription[] = _("Removes moves.");
static const u8 sClearMindedDescription[] = _("Changes mind into HP.");
static const u8 sMadnessMindDescription[] = _(".");
static const u8 sSubjugateDescription[] = _("Up stat if lower foe's.");
static const u8 sGeneticModifiedSDescription[] = _(".");
static const u8 sGeneticModifiedADescription[] = _(".");
static const u8 sGeneticModifiedBDescription[] = _(".");
static const u8 sGeneticModifiedCDescription[] = _(".");
static const u8 sGeneticModifiedDDescription[] = _(".");
static const u8 sHomunculusDescription[] = _(".");
static const u8 sHawkEyeDescription[] = _("Boosts Accuracy.");
static const u8 sVultureEyeDescription[] = _("Ups damage weaknene foes.");
static const u8 sFalconEyeDescription[] = _("Ups “not very effective”..");
static const u8 sOwlEyeDescription[] = _("Prevents multitarget moves.");
static const u8 sEagleEyeDescription[] = _("Boosts critical hit ratio.");
static const u8 sBugColonyDescription[] = _("Ups defeses for each Bug.");
static const u8 sWardingBellsDescription[] = _("Prevents status moves.");
static const u8 sBeeQueenDescription[] = _("Boosts certain moves.");
static const u8 sMastermindDescription[] = _("Boosts Psychic moves.");
static const u8 sMesmerizeDescription[] = _("Sleep on contact.");
static const u8 sWarDrumsDescription[] = _("Sound becomes physical.");
static const u8 sToxicDustDescription[] = _("Attackers become Poison.");
static const u8 sBubbleMaskDescription[] = _(".");
static const u8 sTimeSkipDescription[] = _("Negate end of turn effects.");
static const u8 sViralBoostDescription[] = _(".");
static const u8 sFertilizerDescription[] = _("Sun on grassy terrain.");
static const u8 sMegamorphosisDescription[] = _("Exchanges base stats.");
static const u8 sArchmorphosisDescription[] = _("Exchanges base stats.");
static const u8 sProboscisDescription[] = _("Ups dranning moves healing.");
static const u8 sMycelialNetworkDescription[] = _("Ups draining moves power.");
static const u8 sFloressenceDescription[] = _("Grass moves go first.");
static const u8 sPoseidonGuardDescription[] = _("Weakens “supereffective”.");
static const u8 sVerdantOvergrowDescription[] = _("Frenzy Plant no recharge.");
static const u8 sInfernoBlazeDescription[] = _("Blast Burn no recharge.");
static const u8 sRagingTorrentDescription[] = _("Hydro Cannon no recharge.");
static const u8 sFishHarpoonDescription[] = _("Horn hits Water mons.");
static const u8 sGoremasterDescription[] = _("Boosts horn moves.");
static const u8 sWildStallionDescription[] = _("Ups stats per equine.");
static const u8 sGallopHerdDescription[] = _("Ups stats per equine.");
static const u8 sGillFilterDescription[] = _("Ups defense using Water.");
static const u8 sBranchialShieldDescription[] = _("Ups Sp Def on swamp.");
static const u8 sRelentlessFistDescription[] = _("Punch gets stronger.");
static const u8 sBrawlerFistDescription[] = _("More weight more punch.");
static const u8 sGentleFistDescription[] = _("Punch may paralize.");
static const u8 sComboFistDescription[] = _("Punch hits twice.");
static const u8 sPhytoparasiteDescription[] = _("Can seed & spore Grass.");
static const u8 sDandelionDriftDescription[] = _(".");
static const u8 sCottonCushionDescription[] = _("Weakens “supereffective”.");
static const u8 sSeedScatterDescription[] = _("Sets Leech Seed");
static const u8 sCrazyVinesDescription[] = _("Ups defense using Grass.");
static const u8 sYokaiDescription[] = _("Adds Ghost-type.");
static const u8 sOniDescription[] = _("Adds Dark-type.");
static const u8 sMonkeyKingDescription[] = _("Ups stats per primate.");
static const u8 sPrimateTroopDescription[] = _("Ups stats per primate.");
static const u8 sStringVeilDescription[] = _("Lowers Speed on contact.");
static const u8 sUltraSpacianDescription[] = _("Boosts stats on entry.");
static const u8 sRocketBoostersDescription[] = _("Boosts Fire-type moves.");
static const u8 sPowderDustDescription[] = _("Powder attackers.");
static const u8 sIcebreakerDescription[] = _("Ice hit Ice.");
static const u8 sDragonbornDescription[] = _("Adds Dragon-type.");
static const u8 sEarthwormDescription[] = _("Adds Ground-type.");
static const u8 sWeaponBondDescription[] = _("No item lost.");
static const u8 sEldritchStrikeDescription[] = _(".");
static const u8 sSharedBulwarkDescription[] = _("Uses Guard Split.");
static const u8 sRadiantCrystalDescription[] = _("Ups Sp. Def. in sun.");
static const u8 sPrismaticCoreDescription[] = _("Special moves use Sp. Def.");
static const u8 sRenewingSpinesDescription[] = _("Heals on contact.");
static const u8 sAdamantineClawsDescription[] = _("Contact ignore abilities.");
static const u8 sCriticalMassDescription[] = _("Explode hit more.");
static const u8 sPerfectMimicDescription[] = _("Boosts Mimicked moves.");
static const u8 sCoalIgnitionDescription[] = _("Fire ups Sp. Def.");
static const u8 sWarPriestDescription[] = _("Swaps physical and special.");
static const u8 sSnakeEyeDescription[] = _("Boosts crit and Accuracy.");
static const u8 sPhotosynthesisDescription[] = _("Heals HP in sun.");
static const u8 sMasterChefDescription[] = _("Boosts Food moves.");
static const u8 sOmeleteMakerDescription[] = _("Turn food into HP.");
static const u8 sCrowdedNestDescription[] = _(".");
static const u8 sPlayDeadDescription[] = _("Resists most types.");
static const u8 sSlowMetabolismDescription[] = _("May heal status problem.");
static const u8 sThickSkinDescription[] = _("Prevents biting moves.");
static const u8 sParrotMimicryDescription[] = _("Sets Copycat.");
static const u8 sTransmutationDescription[] = _(".");
static const u8 sFleetFootworkDescription[] = _("Speed ups Sp. Def.");
static const u8 sStormsFavorDescription[] = _("Boosts Hurricane.");
static const u8 sGoodLuckDescription[] = _("Always benefits user.");
static const u8 sReliabilityDescription[] = _(".");
static const u8 sTrustworthyDescription[] = _("Boosts friendship moves.");
static const u8 sFastLearningDescription[] = _("Earns more experience.");
static const u8 sFrostbornDescription[] = _("Adds Ice-type.");
static const u8 sBreakthroughDescription[] = _("Ups damage on screens.");
static const u8 sLostEmotionsDescription[] = _("Removes items.");
static const u8 sLostWillpowerDescription[] = _("Removes abilities.");
static const u8 sRiftwalkDescription[] = _("Reappears when Koed.");
static const u8 sSpacetimeStrainDescription[] = _("Damages each turn.");
static const u8 sAntimatterVeilDescription[] = _("Ignores type & abilities.");
static const u8 sTunnelRunnerDescription[] = _("Ups Speed at max HP.");
static const u8 sHyperactiveDescription[] = _("Field moves up Speed.");
static const u8 sSkyDiverDescription[] = _("Ups Speed at max HP.");
static const u8 sCannonModeDescription[] = _("Boosts base Sp. Attack.");
static const u8 sJetModeDescription[] = _("Boosts base Speed.");
static const u8 sHoarfrostSkinDescription[] = _("Ups Defense in hail.");
static const u8 sAsteroidBeltDescription[] = _("Sets Stone Wall.");
static const u8 sReflectDamageDescription[] = _("Reflects damage.");
static const u8 sJackFrostDescription[] = _("Boosts Ice-type moves.");
static const u8 sDunewardDescription[] = _("Ups Sp. Defense on sandy.");
static const u8 sTurbulenceDescription[] = _("Hurts wind users.");
static const u8 sVampireAscendantDescription[] = _("Drains target's HP.");
static const u8 sWatchfulEyeballDescription[] = _("Resists non-crit.");
static const u8 sIronWillDescription[] = _("Resists non-SE moves.");
static const u8 sOilyLocksDescription[] = _("Fire & Water ups def.");
static const u8 sCurlyHairDescription[] = _("Traps on contact.");
static const u8 sMegaManeDescription[] = _("Doubles Defense stat.");
static const u8 sMocousCoatDescription[] = _("Doubles Defense stat.");
static const u8 sHealingAromaDescription[] = _("Uses Aromatherapy.");
static const u8 sMalignateDescription[] = _("Normal moves become Dark.");
static const u8 sGravitropismDescription[] = _(".");
static const u8 sPhototropismDescription[] = _("Boosts defenses in sun.");
static const u8 sLurelightDescription[] = _("Boosts ally's Accuracy.");
static const u8 sDeepDwellerDescription[] = _("Resists strong moves.");
static const u8 sBenthicOrganismDescription[] = _("Adds Ground-type.");
static const u8 sFromTheVoidDescription[] = _("Reappears from the void.");
static const u8 sAuraGuardDescription[] = _("Resists contact moves.");
static const u8 sGrimOmenDescription[] = _("Promotes added effects.");
static const u8 sChronobreakDescription[] = _("Rewinds time when KOed.");
static const u8 sOutlanderDescription[] = _("Boosts Water & Ground.");
static const u8 sMedicineScaleDescription[] = _("May heal status problem.");
static const u8 sGodOfCreationDescription[] = _("Above all Legendaries.");
static const u8 sOriginalOneDescription[] = _("Prevents status moves.");
static const u8 sOmniscientDescription[] = _("Moves hit through abilities.");
static const u8 sOverdriveModeDescription[] = _("Power up in a pinch.");
static const u8 sBiofrostDescription[] = _("Moves hit through abilities.");
static const u8 sMetallizeDescription[] = _("Normal moves become Steel.");
static const u8 sMineralizeDescription[] = _("Normal moves become Rock.");
static const u8 sMakerOfOceansDescription[] = _("Summons ocean.");
static const u8 sMakerOfLandsDescription[] = _("Summons desert.");
static const u8 sSuperAncientDescription[] = _("Prevents stat reduction.");
static const u8 sDragonLordDescription[] = _("Boosts Dragon-type moves.");
static const u8 sMineralDietDescription[] = _("Eats mineral to heal HP.");
static const u8 sSeginStarmobileDescription[] = _("Allow Wicked Torque.");
static const u8 sSchedarStarmobileDescription[] = _("Allow Blazing Torque.");
static const u8 sNaviStarmobileDescription[] = _("Allow Noxious Torque.");
static const u8 sRuchbahStarmobileDescription[] = _("Allow Magical Torque.");
static const u8 sCaphStarmobileDescription[] = _("Allow Combat Torque.");
static const u8 sNitroEngineDescription[] = _("Boosts torque moves.");
static const u8 sFullThrottleDescription[] = _("Maximizes Speed on entry.");
static const u8 sMeteorSeekerDescription[] = _("Draco Meteor never miss.");
static const u8 sPestilenceDescription[] = _("Damages if inflict status.");
static const u8 sContagionDescription[] = _("Infections hit both.");
static const u8 sPlagueDoctorDescription[] = _("Infections ignore abilities.");
static const u8 sFoulDigestDescription[] = _("Foes take damage eating.");
static const u8 sMicogenesisDescription[] = _("Powder also seeds foes.");
static const u8 sPressurizedGasDescription[] = _("Boosts gas moves.");
static const u8 sCarbonEmitterDescription[] = _(".");
static const u8 sMoonGuardDescription[] = _("Ups defenses in night.");
static const u8 sTurtleUpDescription[] = _("Uses Withdraw on entry.");
static const u8 sArcanePowerDescription[] = _("Doubles Sp. Atk.");
static const u8 sRepellentFurDescription[] = _("Water raises Speed.");
static const u8 sAirBubbleDescription[] = _("Protects ally in water.");
static const u8 sMistyEscapeDescription[] = _("Turns into steam.");
static const u8 sTropicBreezeDescription[] = _("Summons Tailwind on entry.");
static const u8 sFreshPickedFruitDescription[] = _("Eating Berries restores HP.");
static const u8 sDeadlyInfectionDescription[] = _("Infections hurts on apply.");
static const u8 sFullMoonDescription[] = _("Moves have moonlight effect.");
static const u8 sDeflectorLashDescription[] = _("Attack boosts Sp. Def.");
static const u8 sWinterPowerDescription[] = _("Adds Ice-type.");
static const u8 sSummerPowerDescription[] = _("Adds Fire-type.");
static const u8 sAutumnPowerDescription[] = _("Adds Ghost-type.");
static const u8 sSpringPowerDescription[] = _("Adds Fairy-type.");
static const u8 sDarkestDayDescription[] = _(".");
static const u8 sOminousAuraDescription[] = _("Enrages nearby Pokémon.");
static const u8 sOuroborosDescription[] = _("Three KOes, win.");
static const u8 sHeadRegrowthDescription[] = _("Restores HP after move.");
static const u8 sGoldDiggerDescription[] = _("Increases prize.");
static const u8 sMagnetHoverDescription[] = _("Raises Speed on electric terrain.");
static const u8 sSwiftPowerDescription[] = _("Doubles the Speed.");
static const u8 sNeutronPulsarDescription[] = _("Inverts immunities.");
static const u8 sBlinkDescription[] = _("May avoid moves.");
static const u8 sMatterAnnihilationDescription[] = _("Ignores immunities.");
static const u8 sDanceLessonsDescription[] = _("Speed become defenses.");
static const u8 sCreationOfAntimatterDescription[] = _("Prevents contact moves.");
static const u8 sCreationOfTimeDescription[] = _("Prevents priority moves.");
static const u8 sCreationOfSpaceDescription[] = _("Prevents multi-target moves.");
static const u8 sGreatEchoDescription[] = _("Sound hits twice.");
static const u8 sAcidifiedRainDescription[] = _("Rain hurts.");
static const u8 sBlackQuasarDescription[] = _("Ignores type immunities.");
static const u8 sPowerBouncerDescription[] = _("Boosts the Bounce.");
static const u8 sViralVectorDescription[] = _("Transfers status conditions.");
static const u8 sMutagenesisDescription[] = _(".");
static const u8 sDnaRecombinationDescription[] = _("Resists after being hit.");
static const u8 sBlitzkriegDescription[] = _("More Speed more damage.");
static const u8 sAgm65MaverickDescription[] = _("Damages grounded Pokémon.");
static const u8 sTrackingDescription[] = _("Boosts Accuracy.");
static const u8 sShellderCommandDescription[] = _(".");
static const u8 sSlowpokeTailDescription[] = _("Traps Water-type Pokémon.");
static const u8 sGeneticNexusDescription[] = _("Boosts all stats.");
static const u8 sPowerGateDescription[] = _("Ups moves while shielded.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_PLACEHOLDER_18] = _("placeholder"),
    ...
    [ABILITY_IRONCLAD_KEEL] = _("Ironclad Keel"),
    ...
    [ABILITY_TAP_DANCER] = _("Tap Dancer"),
    ...
    [ABILITY_PLACEHOLDER_15] = _("placeholder"),
    ...
    [ABILITY_DRAGON_HOARD] = _("Dragon Hoard"),
    [ABILITY_BUG_CATCHER] = _("Bug Catcher"),
    [ABILITY_NEUROTOXIC_VENOM] = _("Neurotoxic Venom"),
    [ABILITY_HEMOTOXIC_VENOM] = _("Hemotoxic Venom"),
    [ABILITY_SOLENOGLYPHS] = _("Solenoglyphs"),
    [ABILITY_PROSPECTING] = _("Prospecting"),
    [ABILITY_OCCULTISM] = _("Occultism"),
    [ABILITY_SPELLWEAVER] = _("Spellweaver"),
    [ABILITY_TURN_TO_OIL] = _("Turn to Oil"),
    [ABILITY_COLLOSUS] = _("Collosus"),
    [ABILITY_CONTAMINATE] = _("Contaminate"),
    [ABILITY_SAWTOOTH_RUSH] = _("Sawtooth Rush"),
    ...
    [ABILITY_CHILI_FEVER] = _("Chili Fever"),
    [ABILITY_REMODELING_FRAME] = _("Remodeling Frame"),
    [ABILITY_NURSERY] = _("Nursery"),
    [ABILITY_AFTERIMAGE] = _("Afterimage"),
    [ABILITY_AERO_VOICE] = _("Aero Voice"),
    [ABILITY_GRAVEKEEPER] = _("Gravekeeper"),
    [ABILITY_SALT_RITUAL] = _("Salt Ritual"),
    [ABILITY_VELOCITY_SHIFT] = _("Velocity Shift"),
    [ABILITY_FAE_BANE] = _("Fae Bane"),
    [ABILITY_BOMBARDMENT] = _("Bombardment"),
    [ABILITY_HELLISH_RESISTANCE] = _("Hellish Resistance"),
    [ABILITY_FAE_TOUCHED] = _("Fae Touched"),
    [ABILITY_LAST_RITES] = _("Last Rites"),
    [ABILITY_LATENT_PSYCHE] = _("Latent Psyche"),
    [ABILITY_PSIONIC_DOMINANCE] = _("Psionic Dominance"),
    [ABILITY_PSIONIC_BACKLASH] = _("Psionic Backlash"),
    [ABILITY_MIND_FRACTURE] = _("Mind Fracture"),
    [ABILITY_GORE_RUSH] = _("Gore Rush"),
    [ABILITY_UNERRING_IMPALE] = _("Unerring Impale"),
    [ABILITY_PERILOUS_STAKE] = _("Perilous Stake"),
    [ABILITY_SKY_SOVEREIGN] = _("Sky Sovereign"),
    [ABILITY_NECROTOXIC_VENOM] = _("Necrotoxic Venom"),
    [ABILITY_STONE_SCATTER] = _("Stone Scatter"),
    [ABILITY_FREECAST] = _("Freecast"),
    [ABILITY_PLACEHOLDER_11] = _(""),
    [ABILITY_SKULLBREAKER] = _("Skullbreaker"),
    [ABILITY_VENOM_OVERDRIVE] = _("Venom Overdrive"),
    [ABILITY_DUNE_TRAP] = _("Dune Trap"),
    [ABILITY_SAND_GLIDER] = _("Sand Glider"),
    [ABILITY_PLACEHOLDER_14] = _("placeholder"),
    [ABILITY_DISGUSTING_POLLEN] = _("Disgusting Pollen"),
    [ABILITY_DIAMOND_REFLECT] = _("Diamond Reflect"),
    [ABILITY_CHAIN_REACTION] = _("Chain Reaction"),
    [ABILITY_POWER_KEG] = _("Power Keg"),
    [ABILITY_SULFUR_FEED] = _("Sulfur Feed"),
    [ABILITY_SMOKE_SIGNAL] = _("Smoke Signal"),
    [ABILITY_SOOT_VEIL] = _("Soot Veil"),
    [ABILITY_REACTIVE_ARMOR] = _("Reactive Armor"),
    [ABILITY_SIEGE_PAYLOAD] = _("Siege Payload"),
    [ABILITY_LIVING_MONOLITH] = _("Living Monolith"),
    [ABILITY_POWER_OBELISK] = _("Power Obelisk"),
    [ABILITY_STONE_SENTINEL] = _("Stone Sentinel"),
    [ABILITY_RUNIC_STONE] = _("Runic Stone"),
    [ABILITY_LOVELY_FRAGRANCE] = _("Lovely Fragrance"),
    [ABILITY_OVERCLOCK] = _("Overclock"),
    [ABILITY_FLAVOR_ADAPTATION] = _("Flavor Adaptation"),
    [ABILITY_AWAKENED_MIND] = _("Awakened Mind"),
    [ABILITY_SILENT_FLIGHT] = _("Silent Flight"),
    [ABILITY_TEMPEST_WAKE] = _("Tempest Wake"),
    [ABILITY_LEECH_SPORE] = _("Leech Spore"),
    [ABILITY_MAGMA_CHAMBER] = _("Magma Chamber"),
    [ABILITY_ABYSSAL_WELLSPRING] = _("Abyssal Wellspring"),
    [ABILITY_FEEDING_FRENZY] = _("Feeding Frenzy"),
    [ABILITY_DREADFUL_SMELL] = _("Dreadful Smell"),
    [ABILITY_IRON_CHIME] = _("Iron Chime"),
    [ABILITY_IMPROVISED_WEAPON_GRASS] = _("Timber Block"),
    [ABILITY_IMPROVISED_WEAPON_STEEL] = _("Iron Girder"),
    [ABILITY_IMPROVISED_WEAPON_ROCK] = _("Concrete Pillars"),
    [ABILITY_BONE_CAGE] = _("Bone Cage"),
    [ABILITY_SOVEREIGN_CREST] = _("Sovereign Crest"),
    [ABILITY_OILY_CARAPACE] = _("Oily Carapace"),
    [ABILITY_POWER_OVERFLOW] = _("Power Overflow"),    
    [ABILITY_MEGA_SOL] = _("Mega Sol"),
    [ABILITY_PIERCING_DRILL] = _("Piercing Drill"),
    [ABILITY_SPICY_SPRAY] = _("Spicy Spray"),
    [ABILITY_STORM_WINGS] = _("Storm Wings"),
    [ABILITY_SKITTERIZE] = _("Skitterize"),
    [ABILITY_ADRENALINE_SURGE] = _("Adrenaline Surge"),
    [ABILITY_PHANTOM_STAR_FIST] = _("Phantom Star Fist"),
    [ABILITY_SUNFORGED_GOLD] = _("Sunforged Gold"),
    [ABILITY_SILVER_ARMOR] = _("Silver Armor"),
    [ABILITY_POLAR_GUARD] = _("Polar Guard"),
    [ABILITY_TESLA_COIL] = _("Tesla Coil"),
    [ABILITY_FLUX_BREAK] = _("Flux Break"),
    [ABILITY_COLOSSEUM_SURGE] = _("Colosseum Surge"),
    [ABILITY_DRACONIC_SURGE] = _("Draconic Surge"),
    [ABILITY_EVERBURN_SPEAR] = _("Everburn Spear"),
    [ABILITY_HYDRENCHYMA] = _("Hydrenchyma"),
    [ABILITY_NIGHT_SYNTHESIS] = _("Night Synthesis"),
    [ABILITY_WAXY_GUARD] = _("Waxy Guard"),
    [ABILITY_NEEDLE_SKIN] = _("Needle Skin"),
    [ABILITY_MASTER_PUGILIST] = _("Master Pugilist"),
    [ABILITY_THE_WAY_OF_THE_KICK] = _("Way of The Kick"),
    [ABILITY_MARTIAL_PRODIGY] = _("Martial Prodigy"),
    [ABILITY_FUTURE_GAZE] = _("Future Gaze"),
    [ABILITY_STRADIVARIUS] = _("Stradivarius"),
    [ABILITY_PRESSURE_BURST] = _("Pressure Burst"),
    [ABILITY_POWER_SPLASHER] = _("Power Splasher"),
    [ABILITY_JUICEMAKER] = _("Juicemaker"),
    ...
    [ABILITY_DESERT_FLOWER] = _("Desert Flower"),
    [ABILITY_SCARECROW_VIGIL] = _("Scarecrow Vigil"),
    [ABILITY_HEAVY_SLEEPER] = _("Heavy Sleeper"),
    [ABILITY_DEEP_SLUMBER] = _("Deep Slumber"),
    [ABILITY_LOG_LAUNCHER] = _("Log Launcher"),
    [ABILITY_LUMBER_PILLOW] = _("Lumber Pillow"),
    [ABILITY_ALL_JUST_A_DREAM] = _("All Just A Dream"),
    [ABILITY_TRAINING_GROUND] = _("Training Ground"),
    [ABILITY_GRAPPLE_GUARD] = _("Grapple Guard"),
    [ABILITY_THREADLOCK] = _("Threadlock"),
    [ABILITY_TRAP_TERRITORY] = _("Trap Territory"),
    [ABILITY_SILKEN_AMBUSH] = _("Silken Ambush"),
    [ABILITY_ELECTRIFIED_WIRE] = _("Electried Wire"),
    [ABILITY_ROGUE_TACTICS] = _("Rogue Tactics"),
    [ABILITY_DIRTY_FIGHTING] = _("Dirty Fighting"),
    [ABILITY_POISONOUS_NEST] = _("Poisonous Nest"),
    ...
    [ABILITY_BERSERK_FURY] = _("Berserk Fury"),
    [ABILITY_INTOXICATE] = _("Intoxicate"),
    [ABILITY_THIRD_EYE] = _("Third Eye"),
    [ABILITY_PSIONIZE] = _("Psionize"),
    [ABILITY_SCRY] = _("Scry"),
    [ABILITY_WISH_UPON_A_STAR] = _("Wish Upon A Star"),
    [ABILITY_ORACLES_PROPHECY] = _("Oracles Prophecy"),
    [ABILITY_STARLIGHT_VEIL] = _("Starlight Veil"),
    [ABILITY_MILLENIUM_COMET] = _("Millenium Comet"),
    [ABILITY_SIXTH_SENSE] = _("Sixth Sense"),
    [ABILITY_HEALING_FACTOR] = _("Healing Factor"),
    [ABILITY_WATERLOGGING] = _("Waterlogging"),
    [ABILITY_BATTLE_AURA] = _("Battle Aura"),
    [ABILITY_TERRAFORM] = _("Terraform"),
    [ABILITY_FIRST_STRIKE] = _("First Strike"),
    [ABILITY_DOUBLE_STRIKE] = _("Double Strike"),
    [ABILITY_HASTE] = _("Haste"),
    [ABILITY_LIFELINK] = _("Lifelink"),
    [ABILITY_REACH] = _("Reach"),
    [ABILITY_TRAMPLE] = _("Trample"),
    [ABILITY_DEATHTOUCH] = _("Deathtouch"),
    [ABILITY_CRYOSTASIS] = _("Cryostasis"),
    [ABILITY_GENERALIST] = _("Generalist"),
    [ABILITY_HEXPROOF] = _("Hexproof"),
    [ABILITY_HERD_LEADER] = _("Herd Leader"),
    [ABILITY_MENACE] = _("Menace"),
    [ABILITY_PLANESWALKER] = _("Planeswalker"),
    [ABILITY_VIGILANCE] = _("Vigilance"),
    [ABILITY_HYPNOTIC_GAZE] = _("Hypnotic Gaze"),
    [ABILITY_INDOMITABLE] = _("Indomitable"),
    [ABILITY_NIGHTSTALKER] = _("Nightstalker"),
    [ABILITY_VENGEFUL_SPIRIT] = _("Vengeful Spirit"),
    [ABILITY_SPIRITUAL_OFFERINGS] = _("Spirit Offerings"),
    [ABILITY_CHARGE_UP] = _("Charge Up"),
    [ABILITY_BATTLE_TRANCE] = _("Battle Trance"),
    [ABILITY_LOVE_SERENADE] = _("Love Serenade"),
    [ABILITY_LOST_TECHNOLOGY] = _("Lost Technology"),
    [ABILITY_CLAY_VESSEL] = _("Clay Vessel"),
    [ABILITY_ANIMATED_CONSTRUCT] = _("Animated Construct"),
    [ABILITY_OCEANS_COVENANT] = _("Oceans Covenant"),
    [ABILITY_DARK_BRIBE] = _("Dark Bribe"),
    [ABILITY_REVENANT_CORAL] = _("Revenant Coral"),
    [ABILITY_CORAL_BLEACHING] = _("Coral Bleaching"),
    [ABILITY_ZOOXANTHELLAE] = _("Zooxanthellae"),
    [ABILITY_DINOFLAGELLATE] = _("Dinoflagellate"),
    [ABILITY_ALGAL_SHIELD] = _("Algal Shield"),
    [ABILITY_BARRIER_REEF] = _("Barrier Reef"),
    [ABILITY_MUTUALISM] = _("Mutualism"),
    [ABILITY_UNTAPPED_POTENCIAL] = _("Untapped Potencial"),
    [ABILITY_LITTLE_CHAMPION] = _("Little Champion"),
    [ABILITY_UNSTABLE_CORE] = _("Unstable Core"),
    [ABILITY_BERRY_BULK] = _("Berry Bulk"),
    [ABILITY_DEBILITATE] = _("Debilitate"),
    [ABILITY_POLAR_CURRENT] = _("Polar Current"),
    [ABILITY_KILLER_WHALE] = _("Killer Whale"),
    [ABILITY_ECHOLOCATION] = _("Echolocation"),
    [ABILITY_FIREBRAND] = _("Firebrand"),
    [ABILITY_MASTER_FENCER] = _("Master Fencer"),
    [ABILITY_EN_GARDE] = _("En Garde!"),
    [ABILITY_RUTHLESS_PREDATOR] = _("Ruthless Predator"),
    [ABILITY_REIGN_OF_ANGER] = _("Reign of Anger"),
    [ABILITY_REINDEER_RIDER] = _("Reindeer Rider"),
    [ABILITY_DEFLECTOR_HULL] = _("Deflector Hull"),
    [ABILITY_LURKING_MENACE] = _("Lurking Menace"),
    [ABILITY_LOST_KNOWLEDGE] = _("Lost Knowledge"),
    [ABILITY_CLEAR_MINDED] = _("Clear Minded"),
    [ABILITY_MADNESS_MIND] = _("Madness Mind"),
    [ABILITY_SUBJUGATE] = _("Subjugate"),
    [ABILITY_GENETIC_MODIFIED_S] = _("Genetic Modified S"),
    [ABILITY_GENETIC_MODIFIED_A] = _("Genetic Modified A"),
    [ABILITY_GENETIC_MODIFIED_B] = _("Genetic Modified B"),
    [ABILITY_GENETIC_MODIFIED_C] = _("Genetic Modified C"),
    [ABILITY_GENETIC_MODIFIED_D] = _("Genetic Modified D"),
    [ABILITY_HOMUNCULUS] = _("Homunculus"),
    [ABILITY_HAWK_EYE] = _("Hawk Eye"),
    [ABILITY_VULTURE_EYE] = _("Vulture Eye"),
    [ABILITY_FALCON_EYE] = _("Falcon Eye"),
    [ABILITY_OWL_EYE] = _("Owl Eye"),
    [ABILITY_EAGLE_EYE] = _("Eagle Eye"),
    [ABILITY_BUG_COLONY] = _("Bug Colony"),
    [ABILITY_WARDING_BELLS] = _("Warding Bells"),
    [ABILITY_BEE_QUEEN] = _("Bee Queen"),
    [ABILITY_MASTERMIND] = _("Mastermind"),
    [ABILITY_MESMERIZE] = _("Mesmerize"),
    [ABILITY_WAR_DRUMS] = _("War Drums"),
    [ABILITY_TOXIC_DUST] = _("Toxic Dust"),
    [ABILITY_BUBBLE_MASK] = _("Bubble Mask"),
    [ABILITY_TIME_SKIP] = _("Time Skip"),
    [ABILITY_VIRAL_BOOST] = _("Viral Boost"),
    [ABILITY_FERTILIZER] = _("Fertilizer"),
    [ABILITY_MEGAMORPHOSIS] = _("Megamorphosis"),
    [ABILITY_ARCHMORPHOSIS] = _("Archmorphosis"),
    [ABILITY_PROBOSCIS] = _("Proboscis"),
    [ABILITY_MYCELIAL_NETWORK] = _("Mycelial Network"),
    [ABILITY_FLORESSENCE] = _("Floressence"),
    [ABILITY_POSEIDON_GUARD] = _("Poseidon Guard"),
    [ABILITY_VERDANT_OVERGROW] = _("Verdant Overgrow"),
    [ABILITY_INFERNO_BLAZE] = _("Inferno Blaze"),
    [ABILITY_RAGING_TORRENT] = _("Raging Torrent"),
    [ABILITY_FISH_HARPOON] = _("Fish Harpoon"),
    [ABILITY_GOREMASTER] = _("Goremaster"),
    [ABILITY_WILD_STALLION] = _("Wild Stallion"),
    [ABILITY_GALLOP_HERD] = _("Gallop Herd"),
    [ABILITY_GILL_FILTER] = _("Gill Filter"),
    [ABILITY_BRANCHIAL_SHIELD] = _("Branchial Shield"),
    [ABILITY_RELENTLESS_FIST] = _("Relentless Fist"),
    [ABILITY_BRAWLER_FIST] = _("Brawler Fist"),
    [ABILITY_GENTLE_FIST] = _("Gentle Fist"),
    [ABILITY_COMBO_FIST] = _("Combo Fist"),
    [ABILITY_PHYTOPARASITE] = _("Phytoparasite"),
    [ABILITY_DANDELION_DRIFT] = _("Dandelion Drift"),
    [ABILITY_COTTON_CUSHION] = _("Cotton Cushion"),
    [ABILITY_SEED_SCATTER] = _("Seed Scatter"),
    [ABILITY_CRAZY_VINES] = _("Crazy Vines"),
    [ABILITY_YOKAI] = _("Yokai"),
    [ABILITY_ONI] = _("Oni"),
    [ABILITY_MONKEY_KING] = _("Monkey King"),
    [ABILITY_PRIMATE_TROOP] = _("Primate Troop"),
    [ABILITY_STRING_VEIL] = _("String Veil"),
    [ABILITY_ULTRA_SPACIAN] = _("Ultra Spacian"),
    [ABILITY_ROCKET_BOOSTERS] = _("Rocket Boosters"),
    [ABILITY_POWDER_DUST] = _("Powder Dust"),
    [ABILITY_ICEBREAKER] = _("Icebreaker"),
    [ABILITY_DRAGONBORN] = _("Dragonborn"),
    [ABILITY_EARTHWORM] = _("Earthworm"),
    [ABILITY_EELEVATE] = _("Eelevate"),
    [ABILITY_FIRE_MANE] = _("Fire Mane"),
    [ABILITY_WEAPON_BOND] = _("Weapon Bond"),
    [ABILITY_ELDRITCH_STRIKE] = _("Eldritch Strike"),
    [ABILITY_SHARED_BULWARK] = _("Shared Bulwark"),
    [ABILITY_RADIANT_CRYSTAL] = _("Radiant Crystal"),
    [ABILITY_PRISMATIC_CORE] = _("Prismatic Core"),
    [ABILITY_RENEWING_SPINES] = _("Renewing Spines"),
    [ABILITY_ADAMANTINE_CLAWS] = _("Adamantine Claws"),
    [ABILITY_CRITICAL_MASS] = _("Critical Mass"),
    [ABILITY_PERFECT_MIMIC] = _("Perfect Mimic"),
    [ABILITY_COAL_IGNITION] = _("Coal Ignition"),
    [ABILITY_WAR_PRIEST] = _("War Priest"),
    [ABILITY_SNAKE_EYE] = _("Snake Eye"),
    [ABILITY_PHOTOSYNTHESIS] = _("Photosynthesis"),
    [ABILITY_MASTER_CHEF] = _("Master Chef"),
    [ABILITY_OMELETE_MAKER] = _("Omelete Maker"),
    [ABILITY_CROWDED_NEST] = _("Crowded Nest"),
    [ABILITY_PLAY_DEAD] = _("Play Dead"),
    [ABILITY_SLOW_METABOLISM] = _("Slow Metabolism"),
    [ABILITY_THICK_SKIN] = _("Thick Skin"),
    [ABILITY_PARROT_MIMICRY] = _("Parrot Mimicry"),
    [ABILITY_TRANSMUTATION] = _("Transmutation"),
    [ABILITY_FLEET_FOOTWORK] = _("Fleet Footwork"),
    [ABILITY_STORMS_FAVOR] = _("Storms Favor"),
    [ABILITY_GOOD_LUCK] = _("Good Luck"),
    [ABILITY_RELIABILITY] = _("Reliability"),
    [ABILITY_TRUSTWORTHY] = _("Trustworthy"),
    [ABILITY_FAST_LEARNING] = _("Fast Learning"),
    [ABILITY_FROSTBORN] = _("Frostborn"),
    [ABILITY_BREAKTHROUGH] = _("Breakthrough"),
    [ABILITY_LOST_EMOTIONS] = _("Lost Emotions"),
    [ABILITY_LOST_WILLPOWER] = _("Lost Willpower"),
    [ABILITY_RIFTWALK] = _("Riftwalk"),
    [ABILITY_SPACETIME_STRAIN] = _("Spacetime Strain"),
    [ABILITY_ANTIMATTER_VEIL] = _("Antimatter Veil"),
    [ABILITY_TUNNEL_RUNNER] = _("Tunnel Runner"),
    [ABILITY_HYPERACTIVE] = _("Hyperactive"),
    [ABILITY_SKY_DIVER] = _("Sky Diver"),
    [ABILITY_CANNON_MODE] = _("Cannon Mode"),
    [ABILITY_JET_MODE] = _("Jet Mode"),
    [ABILITY_HOARFROST_SKIN] = _("Hoarfrost Skin"),
    [ABILITY_ASTEROID_BELT] = _("Asteroid Belt"),
    [ABILITY_REFLECT_DAMAGE] = _("Reflect Damage"),
    [ABILITY_JACK_FROST] = _("Jack Frost"),
    [ABILITY_DUNEWARD] = _("Duneward"),
    [ABILITY_TURBULENCE] = _("Turbulence"),
    [ABILITY_VAMPIRE_ASCENDANT] = _("Vampire Ascendant"),
    [ABILITY_WATCHFUL_EYEBALL] = _("Watchful Eyeball"),
    [ABILITY_IRON_WILL] = _("Iron Will"),
    [ABILITY_OILY_LOCKS] = _("Oily Locks"),
    [ABILITY_CURLY_HAIR] = _("Curly Hair"),
    [ABILITY_MEGA_MANE] = _("Mega Mane"),
    [ABILITY_MOCOUS_COAT] = _("Mocous Coat"),
    [ABILITY_HEALING_AROMA] = _("Healing Aroma"),
    [ABILITY_MALIGNATE] = _("Malignate"),
    [ABILITY_GRAVITROPISM] = _("Gravitropism"),
    [ABILITY_PHOTOTROPISM] = _("Phototropism"),
    [ABILITY_LURELIGHT] = _("Lurelight"),
    [ABILITY_DEEP_DWELLER] = _("Deep Dweller"),
    [ABILITY_BENTHIC_ORGANISM] = _("Benthic Organism"),
    [ABILITY_FROM_THE_VOID] = _("From The Void"),
    [ABILITY_AURA_GUARD] = _("Aura Guard"),
    [ABILITY_GRIM_OMEN] = _("Grim Omen"),
    [ABILITY_CHRONOBREAK] = _("Chronobreak"),
    [ABILITY_OUTLANDER] = _("Outlander"),
    [ABILITY_MEDICINE_SCALE] = _("Medicine Scale"),
    [ABILITY_GOD_OF_CREATION] = _("God of Creation"),
    [ABILITY_ORIGINAL_ONE] = _("Original One"),
    [ABILITY_OMNISCIENT] = _("Omniscient"),
    [ABILITY_OVERDRIVE_MODE] = _("Overdrive Mode"),
    [ABILITY_BIOFROST] = _("Biofrost"),
    [ABILITY_METALLIZE] = _("Metallize"),
    [ABILITY_MINERALIZE] = _("Mineralize"),
    [ABILITY_MAKER_OF_OCEANS] = _("Maker of Oceans"),
    [ABILITY_MAKER_OF_LANDS] = _("Maker of Lands"),
    [ABILITY_SUPER_ANCIENT] = _("Super Ancient"),
    [ABILITY_DRAGON_LORD] = _("Dragon Lord"),
    [ABILITY_MINERAL_DIET] = _("Mineral Diet"),
    [ABILITY_SEGIN_STARMOBILE] = _("Segin Starmobile"),
    [ABILITY_SCHEDAR_STARMOBILE] = _("Schedar Starmobile"),
    [ABILITY_NAVI_STARMOBILE] = _("Navi Starmobile"),
    [ABILITY_RUCHBAH_STARMOBILE] = _("Ruchbah Starmobile"),
    [ABILITY_CAPH_STARMOBILE] = _("Caph Starmobile"),
    [ABILITY_NITRO_ENGINE] = _("Nitro Engine"),
    [ABILITY_FULL_THROTTLE] = _("Full Throttle"),
    [ABILITY_METEOR_SEEKER] = _("Meteor Seeker"),
    [ABILITY_PESTILENCE] = _("Pestilence"),
    [ABILITY_CONTAGION] = _("Contagion"),
    [ABILITY_PLAGUE_DOCTOR] = _("Plague Doctor"),
    [ABILITY_FOUL_DIGEST] = _("Foul Digest"),
    [ABILITY_MICOGENESIS] = _("Micogenesis"),
    [ABILITY_PRESSURIZED_GAS] = _("Pressurized Gas"),
    [ABILITY_CARBON_EMITTER] = _("Carbon Emitter"),
    [ABILITY_MOON_GUARD] = _("Moon Guard"),
    [ABILITY_TURTLE_UP] = _("Turtle Up"),
    [ABILITY_ARCANE_POWER] = _("Arcane Power"),
    [ABILITY_REPELLENT_FUR] = _("Repellent Fur"),
    [ABILITY_AIR_BUBBLE] = _("Air Bubble"),
    [ABILITY_MISTY_ESCAPE] = _("Misty Escape"),
    [ABILITY_TROPIC_BREEZE] = _("Tropic Breeze"),
    [ABILITY_FRESH_PICKED_FRUIT] = _("Fresh Picked Fruit"),
    [ABILITY_DEADLY_INFECTION] = _("Deadly Infection"),
    [ABILITY_FULL_MOON] = _("Full Moon"),
    [ABILITY_DEFLECTOR_LASH] = _("Deflector Lash"),
    [ABILITY_WINTER_POWER] = _("Winter Power"),
    [ABILITY_SUMMER_POWER] = _("Summer Power"),
    [ABILITY_AUTUMN_POWER] = _("Autumn Power"),
    [ABILITY_SPRING_POWER] = _("Spring Power"),
    [ABILITY_DARKEST_DAY] = _("Darkest Day"),
    [ABILITY_OMINOUS_AURA] = _("Ominous Aura"),
    [ABILITY_OUROBOROS] = _("Ouroboros"),
    [ABILITY_HEAD_REGROWTH] = _("Head Regrowth"),
    [ABILITY_GOLD_DIGGER] = _("Gold Digger"),
    [ABILITY_MAGNET_HOVER] = _("Magnet Hover"),
    [ABILITY_SWIFT_POWER] = _("Swift Power"),
    [ABILITY_NEUTRON_PULSAR] = _("Neutron Pulsar"),
    [ABILITY_BLINK] = _("Blink"),
    [ABILITY_MATTER_ANNIHILATION] = _("Matter Annihilate"),
    [ABILITY_DANCE_LESSONS] = _("Dance Lessons"),
    [ABILITY_CREATION_OF_ANTIMATTER] = _("Creation of Anti."),
    [ABILITY_CREATION_OF_TIME] = _("Creation of Time"),
    [ABILITY_CREATION_OF_SPACE] = _("Creation of Space"),
    [ABILITY_GREAT_ECHO] = _("Great Echo"),
    [ABILITY_ACIDIFIED_RAIN] = _("Acidified Rain"),
    [ABILITY_BLACK_QUASAR] = _("Black Quasar"),
    [ABILITY_POWER_BOUNCER] = _("Power Bouncer"),
    [ABILITY_VIRAL_VECTOR] = _("Viral Vector"),
    [ABILITY_MUTAGENESIS] = _("Mutagenesis"),
    [ABILITY_DNA_RECOMBINATION] = _("DNA Recombination"),
    [ABILITY_BLITZKRIEG] = _("Blitzkrieg"),
    [ABILITY_AGM_65_MAVERICK] = _("AGM-65 Maverick"),
    [ABILITY_TRACKING] = _("Tracking"),
    [ABILITY_SHELLDER_COMMAND] = _("Shellder Command"),
    [ABILITY_SLOWPOKE_TAIL] = _("Slowpoke Tail"),
    [ABILITY_GENETIC_NEXUS] = _("Genetic Nexus"),
    [ABILITY_POWER_GATE] = _("Power Gate"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_PLACEHOLDER_18] = sPlaceholder18Description,
    ...
    [ABILITY_IRONCLAD_KEEL] = sIroncladKeelDescription,
    ...
    [ABILITY_TAP_DANCER] = sTapDancerDescription,
    ...
    [ABILITY_PLACEHOLDER_15] = sPlaceholder_15Description,
    ...
    [ABILITY_DARK_SIDE] = sDarkSideDescription,
    ...
    [ABILITY_DRAGON_HOARD] = sDragonHoardDescription,
    [ABILITY_BUG_CATCHER] = sBugCatcherDescription,
    [ABILITY_NEUROTOXIC_VENOM] = sNeurotoxicVenomDescription,
    [ABILITY_HEMOTOXIC_VENOM] = sHemotoxicVenomDescription,
    [ABILITY_SOLENOGLYPHS] = sSolenoglyphsDescription,
    [ABILITY_PROSPECTING] = sProspectingDescription,
    [ABILITY_OCCULTISM] = sOccultismDescription,
    [ABILITY_SPELLWEAVER] = sSpellweaverDescription,
    [ABILITY_TURN_TO_OIL] = sTurnToOilDescription,
    [ABILITY_COLLOSUS] = sCollosusDescription,
    [ABILITY_CONTAMINATE] = sContaminateDescription,
    [ABILITY_SAWTOOTH_RUSH] = sSawtoothRushDescription,
    ...
    [ABILITY_CHILI_FEVER] = sChiliFeverDescription,
    [ABILITY_REMODELING_FRAME] = sRemodelingFrameDescription,
    [ABILITY_NURSERY] = sNurseryDescription,
    [ABILITY_AFTERIMAGE] = sAfterimageDescription,
    [ABILITY_AERO_VOICE] = sAeroVoiceDescription,
    [ABILITY_GRAVEKEEPER] = sGravekeeperDescription,
    [ABILITY_SALT_RITUAL] = sSaltRitualDescription,
    [ABILITY_VELOCITY_SHIFT] = sVelocityShiftDescription,
    [ABILITY_FAE_BANE] = sFaeBaneDescription,
    [ABILITY_BOMBARDMENT] = sBombardmentDescription,
    [ABILITY_HELLISH_RESISTANCE] = sHellishResistanceDescription,
    [ABILITY_FAE_TOUCHED] = sFaeTouchedDescription,
    [ABILITY_LAST_RITES] = sLastRitesDescription,
    [ABILITY_LATENT_PSYCHE] = sLatentPsycheDescription,
    [ABILITY_PSIONIC_DOMINANCE] = sPsionicDominanceDescription,
    [ABILITY_PSIONIC_BACKLASH] = sPsionicBacklashDescription,
    [ABILITY_MIND_FRACTURE] = sMindFractureDescription,
    [ABILITY_GORE_RUSH] = sGoreRushDescription,
    [ABILITY_UNERRING_IMPALE] = sUnerringImpaleDescription,
    [ABILITY_PERILOUS_STAKE] = sPerilousStakeDescription,
    [ABILITY_SKY_SOVEREIGN] = sSkySovereignDescription,
    [ABILITY_NECROTOXIC_VENOM] = sNecrotoxicVenomDescription,
    [ABILITY_STONE_SCATTER] = sStoneScatterDescription,
    [ABILITY_FREECAST] = sFreecastDescription,
    [ABILITY_PLACEHOLDER_11] = sTapDancerDescription,
    [ABILITY_SKULLBREAKER] = sSkullbreakerDescription,
    [ABILITY_VENOM_OVERDRIVE] = sVenomOverdriveDescription,
    [ABILITY_DUNE_TRAP] = sDuneTrapDescription,
    [ABILITY_SAND_GLIDER] = sSandGliderDescription,
    [ABILITY_PLACEHOLDER_14] = sLoverlyFragranceDescription,
    [ABILITY_DISGUSTING_POLLEN] = sDisgustingPollenDescription,
    [ABILITY_DIAMOND_REFLECT] = sDiamondReflectDescription,
    [ABILITY_CHAIN_REACTION] = sChainReactionDescription,
    [ABILITY_POWER_KEG] = sPowerKegDescription,
    [ABILITY_SULFUR_FEED] = sSulfurFeedDescription,
    [ABILITY_SMOKE_SIGNAL] = sSmokeSignalDescription,
    [ABILITY_SOOT_VEIL] = sSootVeilDescription,
    [ABILITY_REACTIVE_ARMOR] = sReactiveArmorDescription,
    [ABILITY_SIEGE_PAYLOAD] = sSiegePayloadDescription,
    [ABILITY_LIVING_MONOLITH] = sLivingMonolithDescription,
    [ABILITY_POWER_OBELISK] = sPowerObeliskDescription,
    [ABILITY_STONE_SENTINEL] = sStoneSentinelDescription,
    [ABILITY_RUNIC_STONE] = sRunicStoneDescription,
    [ABILITY_LOVELY_FRAGRANCE] = sLovelyFragranceDescription,
    [ABILITY_OVERCLOCK] = sOverclockDescription,
    [ABILITY_FLAVOR_ADAPTATION] = sFlavorAdaptationDescription,
    [ABILITY_AWAKENED_MIND] = sAwakenedMindDescription,
    [ABILITY_SILENT_FLIGHT] = sSilentFlightDescription,
    [ABILITY_TEMPEST_WAKE] = sTempestWakeDescription,
    [ABILITY_LEECH_SPORE] = sLeechSporeDescription,
    [ABILITY_MAGMA_CHAMBER] = sMagmaChamberDescription,
    [ABILITY_ABYSSAL_WELLSPRING] = sAbyssalWellspringDescription,
    [ABILITY_FEEDING_FRENZY] = sFeedingFrenzyDescription,
    [ABILITY_DREADFUL_SMELL] = sDreadfulSmellDescription,
    [ABILITY_IRON_CHIME] = sIronChimeDescription,
    [ABILITY_IMPROVISED_WEAPON_GRASS] = sImprovisedWeaponGrassDescription,
    [ABILITY_IMPROVISED_WEAPON_STEEL] = sImprovisedWeaponSteelDescription,
    [ABILITY_IMPROVISED_WEAPON_ROCK] = sImprovisedWeaponRockDescription,
    [ABILITY_BONE_CAGE] = sBoneCageDescription,
    [ABILITY_SOVEREIGN_CREST] = sSovereignCrestDescription,
    [ABILITY_OILY_CARAPACE] = sOilyCarapaceDescription,
    [ABILITY_POWER_OVERFLOW] = sPowerOverflowDescription,
    ...
    [ABILITY_STORM_WINGS] = sStormWingsDescription,
    [ABILITY_SKITTERIZE] = sSkitterizeDescription,
    [ABILITY_ADRENALINE_SURGE] = sAdrenalineSurgeDescription,
    [ABILITY_PHANTOM_STAR_FIST] = sPhantomStarFistDescription,
    [ABILITY_SUNFORGED_GOLD] = sSunforgedGoldDescription,
    [ABILITY_SILVER_ARMOR] = sSilverArmorDescription,
    [ABILITY_POLAR_GUARD] = sPolarGuardDescription,
    [ABILITY_TESLA_COIL] = sTeslaCoilDescription,
    [ABILITY_FLUX_BREAK] = sFluxBreakDescription,
    [ABILITY_COLOSSEUM_SURGE] = sColosseumSurgeDescription,
    [ABILITY_DRACONIC_SURGE] = sDraconicSurgeDescription,
    [ABILITY_EVERBURN_SPEAR] = sEverburnSpearDescription,
    [ABILITY_HYDRENCHYMA] = sHydrenchymaDescription,
    [ABILITY_NIGHT_SYNTHESIS] = sNightSynthesisDescription,
    [ABILITY_WAXY_GUARD] = sWaxyGuardDescription,
    [ABILITY_NEEDLE_SKIN] = sNeedleSkinDescription,
    [ABILITY_MASTER_PUGILIST] = sMasterPugilistDescription,
    [ABILITY_THE_WAY_OF_THE_KICK] = sTheWayOfTheKickDescription,
    [ABILITY_MARTIAL_PRODIGY] = sMartialProdigyDescription,
    [ABILITY_FUTURE_GAZE] = sFutureGazeDescription,
    [ABILITY_STRADIVARIUS] = sStradivariusDescription,
    [ABILITY_PRESSURE_BURST] = sPressureBurstDescription,
    [ABILITY_POWER_SPLASHER] = sPowerSplasherDescription,
    [ABILITY_JUICEMAKER] = sJuicemakerDescription,
    ...
    [ABILITY_DESERT_FLOWER] = sDesertFlowerDescription,
    [ABILITY_SCARECROW_VIGIL] = sScarecrowVigilDescription,
    [ABILITY_HEAVY_SLEEPER] = sHeavySleeperDescription,
    [ABILITY_DEEP_SLUMBER] = sDeepSlumberDescription,
    [ABILITY_LOG_LAUNCHER] = sLogLauncherDescription,
    [ABILITY_LUMBER_PILLOW] = sLumberPillowDescription,
    [ABILITY_ALL_JUST_A_DREAM] = sAllJustADreamDescription,
    [ABILITY_EELEVATE] = sEelevateDescription,
    [ABILITY_FIRE_MANE] = sFireManeDescription,
    [ABILITY_TRAINING_GROUND] = sTrainingGroundDescription,
    [ABILITY_GRAPPLE_GUARD] = sGrappleGuardDescription,
    [ABILITY_THREADLOCK] = sThreadlockDescription,
    [ABILITY_TRAP_TERRITORY] = sTrapTerritoryDescription,
    [ABILITY_SILKEN_AMBUSH] = sSilkenAmbushDescription,
    [ABILITY_ELECTRIFIED_WIRE] = sElectrifiedWireDescription,
    [ABILITY_ROGUE_TACTICS] = sRogueTacticsDescription,
    [ABILITY_DIRTY_FIGHTING] = sDirtyFightingDescription,
    [ABILITY_POISONOUS_NEST] = sPoisonousNestDescription,
    ...
    [ABILITY_BERSERK_FURY] = sBerserkFuryDescription,
    [ABILITY_INTOXICATE] = sIntoxicateDescription,
    [ABILITY_THIRD_EYE] = sThirdEyeDescription,
    [ABILITY_PSIONIZE] = sPsionizeDescription,
    [ABILITY_SCRY] = sScryDescription,
    [ABILITY_WISH_UPON_A_STAR] = sWishUponAStarDescription,
    [ABILITY_ORACLES_PROPHECY] = sOraclesProphecyDescription,
    [ABILITY_STARLIGHT_VEIL] = sStarlightVeilDescription,
    [ABILITY_MILLENIUM_COMET] = sMilleniumCometDescription,
    [ABILITY_SIXTH_SENSE] = sSixthSenseDescription,
    [ABILITY_HEALING_FACTOR] = sHealingFactorDescription,
    [ABILITY_WATERLOGGING] = sWaterloggingDescription,
    [ABILITY_BATTLE_AURA] = sBattleAuraDescription,
    [ABILITY_TERRAFORM] = sTerraformDescription,
    [ABILITY_FIRST_STRIKE] = sFirstStrikeDescription,
    [ABILITY_DOUBLE_STRIKE] = sDoubleStrikeDescription,
    [ABILITY_HASTE] = sHasteDescription,
    [ABILITY_LIFELINK] = sLifelinkDescription,
    [ABILITY_REACH] = sReachDescription,
    [ABILITY_TRAMPLE] = sTrampleDescription,
    [ABILITY_DEATHTOUCH] = sDeathtouchDescription,
    [ABILITY_CRYOSTASIS] = sCryostasisDescription,
    [ABILITY_GENERALIST] = sGeneralistDescription,
    [ABILITY_HEXPROOF] = sHexproofDescription,
    [ABILITY_HERD_LEADER] = sHerdLeaderDescription,
    [ABILITY_MENACE] = sMenaceDescription,
    [ABILITY_PLANESWALKER] = sPlaneswalkerDescription,
    [ABILITY_VIGILANCE] = sVigilanceDescription,
    [ABILITY_HYPNOTIC_GAZE] = sHypnoticGazeDescription,
    [ABILITY_INDOMITABLE] = sIndomitableDescription,
    [ABILITY_NIGHTSTALKER] = sNightstalkerDescription,
    [ABILITY_VENGEFUL_SPIRIT] = sVengefulSpiritDescription,
    [ABILITY_SPIRITUAL_OFFERINGS] = sSpiritualOfferingsDescription,
    [ABILITY_CHARGE_UP] = sChargeUpDescription,
    [ABILITY_BATTLE_TRANCE] = sBattleTranceDescription,
    [ABILITY_LOVE_SERENADE] = sLoveSerenadeDescription,
    [ABILITY_LOST_TECHNOLOGY] = sLostTechnologyDescription,
    [ABILITY_CLAY_VESSEL] = sClayVesselDescription,
    [ABILITY_ANIMATED_CONSTRUCT] = sAnimatedConstructDescription,
    [ABILITY_OCEANS_COVENANT] = sOceansCovenantDescription,
    [ABILITY_DARK_BRIBE] = sDarkBribeDescription,
    [ABILITY_REVENANT_CORAL] = sRevenantCoralDescription,
    [ABILITY_CORAL_BLEACHING] = sCoralBleachingDescription,
    [ABILITY_ZOOXANTHELLAE] = sZooxanthellaeDescription,
    [ABILITY_DINOFLAGELLATE] = sDinoflagellateDescription,
    [ABILITY_ALGAL_SHIELD] = sAlgalShieldDescription,
    [ABILITY_BARRIER_REEF] = sBarrierReefDescription,
    [ABILITY_MUTUALISM] = sMutualismDescription,
    [ABILITY_UNTAPPED_POTENCIAL] = sUntappedPotencialDescription,
    [ABILITY_LITTLE_CHAMPION] = sLittleChampionDescription,
    [ABILITY_UNSTABLE_CORE] = sUnstableCoreDescription,
    [ABILITY_BERRY_BULK] = sBerryBulkDescription,
    [ABILITY_DEBILITATE] = sDebilitateDescription,
    [ABILITY_POLAR_CURRENT] = sPolarCurrentDescription,
    [ABILITY_KILLER_WHALE] = sKillerWhaleDescription,
    [ABILITY_ECHOLOCATION] = sEcholocationDescription,
    [ABILITY_FIREBRAND] = sFirebrandDescription,
    [ABILITY_MASTER_FENCER] = sMasterFencerDescription,
    [ABILITY_EN_GARDE] = sEnGardeDescription,
    [ABILITY_RUTHLESS_PREDATOR] = sRuthlessPredatorDescription,
    [ABILITY_REIGN_OF_ANGER] = sReignOfAngerDescription,
    [ABILITY_REINDEER_RIDER] = sReindeerRiderDescription,
    [ABILITY_DEFLECTOR_HULL] = sDeflectorHullDescription,
    [ABILITY_LURKING_MENACE] = sLurkingMenaceDescription,
    [ABILITY_LOST_KNOWLEDGE] = sLostKnowledgeDescription,
    [ABILITY_CLEAR_MINDED] = sClearMindedDescription,
    [ABILITY_MADNESS_MIND] = sMadnessMindDescription,
    [ABILITY_SUBJUGATE] = sSubjugateDescription,
    [ABILITY_GENETIC_MODIFIED_S] = sGeneticModifiedSDescription,
    [ABILITY_GENETIC_MODIFIED_A] = sGeneticModifiedADescription,
    [ABILITY_GENETIC_MODIFIED_B] = sGeneticModifiedBDescription,
    [ABILITY_GENETIC_MODIFIED_C] = sGeneticModifiedCDescription,
    [ABILITY_GENETIC_MODIFIED_D] = sGeneticModifiedDDescription,
    [ABILITY_HOMUNCULUS] = sHomunculusDescription,
    [ABILITY_HAWK_EYE] = sHawkEyeDescription,
    [ABILITY_VULTURE_EYE] = sVultureEyeDescription,
    [ABILITY_FALCON_EYE] = sFalconEyeDescription,
    [ABILITY_OWL_EYE] = sOwlEyeDescription,
    [ABILITY_EAGLE_EYE] = sEagleEyeDescription,
    [ABILITY_BUG_COLONY] = sBugColonyDescription,
    [ABILITY_WARDING_BELLS] = sWardingBellsDescription,
    [ABILITY_BEE_QUEEN] = sBeeQueenDescription,
    [ABILITY_MASTERMIND] = sMastermindDescription,
    [ABILITY_MESMERIZE] = sMesmerizeDescription,
    [ABILITY_WAR_DRUMS] = sWarDrumsDescription,
    [ABILITY_TOXIC_DUST] = sToxicDustDescription,
    [ABILITY_BUBBLE_MASK] = sBubbleMaskDescription,
    [ABILITY_TIME_SKIP] = sTimeSkipDescription,
    [ABILITY_VIRAL_BOOST] = sViralBoostDescription,
    [ABILITY_FERTILIZER] = sFertilizerDescription,
    [ABILITY_MEGAMORPHOSIS] = sMegamorphosisDescription,
    [ABILITY_ARCHMORPHOSIS] = sArchmorphosisDescription,
    [ABILITY_PROBOSCIS] = sProboscisDescription,
    [ABILITY_MYCELIAL_NETWORK] = sMycelialNetworkDescription,
    [ABILITY_FLORESSENCE] = sFloressenceDescription,
    [ABILITY_POSEIDON_GUARD] = sPoseidonGuardDescription,
    [ABILITY_VERDANT_OVERGROW] = sVerdantOvergrowDescription,
    [ABILITY_INFERNO_BLAZE] = sInfernoBlazeDescription,
    [ABILITY_RAGING_TORRENT] = sRagingTorrentDescription,
    [ABILITY_FISH_HARPOON] = sFishHarpoonDescription,
    [ABILITY_GOREMASTER] = sGoremasterDescription,
    [ABILITY_WILD_STALLION] = sWildStallionDescription,
    [ABILITY_GALLOP_HERD] = sGallopHerdDescription,
    [ABILITY_GILL_FILTER] = sGillFilterDescription,
    [ABILITY_BRANCHIAL_SHIELD] = sBranchialShieldDescription,
    [ABILITY_RELENTLESS_FIST] = sRelentlessFistDescription,
    [ABILITY_BRAWLER_FIST] = sBrawlerFistDescription,
    [ABILITY_GENTLE_FIST] = sGentleFistDescription,
    [ABILITY_COMBO_FIST] = sComboFistDescription,
    [ABILITY_PHYTOPARASITE] = sPhytoparasiteDescription,
    [ABILITY_DANDELION_DRIFT] = sDandelionDriftDescription,
    [ABILITY_COTTON_CUSHION] = sCottonCushionDescription,
    [ABILITY_SEED_SCATTER] = sSeedScatterDescription,
    [ABILITY_CRAZY_VINES] = sCrazyVinesDescription,
    [ABILITY_YOKAI] = sYokaiDescription,
    [ABILITY_ONI] = sOniDescription,
    [ABILITY_MONKEY_KING] = sMonkeyKingDescription,
    [ABILITY_PRIMATE_TROOP] = sPrimateTroopDescription,
    [ABILITY_STRING_VEIL] = sStringVeilDescription,
    [ABILITY_ULTRA_SPACIAN] = sUltraSpacianDescription,
    [ABILITY_ROCKET_BOOSTERS] = sRocketBoostersDescription,
    [ABILITY_POWDER_DUST] = sPowderDustDescription,
    [ABILITY_ICEBREAKER] = sIcebreakerDescription,
    [ABILITY_DRAGONBORN] = sDragonbornDescription,
    [ABILITY_EARTHWORM] = sEarthwormDescription,
    [ABILITY_WEAPON_BOND] = sWeaponBondDescription,
    [ABILITY_ELDRITCH_STRIKE] = sEldritchStrikeDescription,
    [ABILITY_SHARED_BULWARK] = sSharedBulwarkDescription,
    [ABILITY_RADIANT_CRYSTAL] = sRadiantCrystalDescription,
    [ABILITY_PRISMATIC_CORE] = sPrismaticCoreDescription,
    [ABILITY_RENEWING_SPINES] = sRenewingSpinesDescription,
    [ABILITY_ADAMANTINE_CLAWS] = sAdamantineClawsDescription,
    [ABILITY_CRITICAL_MASS] = sCriticalMassDescription,
    [ABILITY_PERFECT_MIMIC] = sPerfectMimicDescription,
    [ABILITY_COAL_IGNITION] = sCoalIgnitionDescription,
    [ABILITY_WAR_PRIEST] = sWarPriestDescription,
    [ABILITY_SNAKE_EYE] = sSnakeEyeDescription,
    [ABILITY_PHOTOSYNTHESIS] = sPhotosynthesisDescription,
    [ABILITY_MASTER_CHEF] = sMasterChefDescription,
    [ABILITY_OMELETE_MAKER] = sOmeleteMakerDescription,
    [ABILITY_CROWDED_NEST] = sCrowdedNestDescription,
    [ABILITY_PLAY_DEAD] = sPlayDeadDescription,
    [ABILITY_SLOW_METABOLISM] = sSlowMetabolismDescription,
    [ABILITY_THICK_SKIN] = sThickSkinDescription,
    [ABILITY_PARROT_MIMICRY] = sParrotMimicryDescription,
    [ABILITY_TRANSMUTATION] = sTransmutationDescription,
    [ABILITY_FLEET_FOOTWORK] = sFleetFootworkDescription,
    [ABILITY_STORMS_FAVOR] = sStormsFavorDescription,
    [ABILITY_GOOD_LUCK] = sGoodLuckDescription,
    [ABILITY_RELIABILITY] = sReliabilityDescription,
    [ABILITY_TRUSTWORTHY] = sTrustworthyDescription,
    [ABILITY_FAST_LEARNING] = sFastLearningDescription,
    [ABILITY_FROSTBORN] = sFrostbornDescription,
    [ABILITY_BREAKTHROUGH] = sBreakthroughDescription,
    [ABILITY_LOST_EMOTIONS] = sLostEmotionsDescription,
    [ABILITY_LOST_WILLPOWER] = sLostWillpowerDescription,
    [ABILITY_RIFTWALK] = sRiftwalkDescription,
    [ABILITY_SPACETIME_STRAIN] = sSpacetimeStrainDescription,
    [ABILITY_ANTIMATTER_VEIL] = sAntimatterVeilDescription,
    [ABILITY_TUNNEL_RUNNER] = sTunnelRunnerDescription,
    [ABILITY_HYPERACTIVE] = sHyperactiveDescription,
    [ABILITY_SKY_DIVER] = sSkyDiverDescription,
    [ABILITY_CANNON_MODE] = sCannonModeDescription,
    [ABILITY_JET_MODE] = sJetModeDescription,
    [ABILITY_HOARFROST_SKIN] = sHoarfrostSkinDescription,
    [ABILITY_ASTEROID_BELT] = sAsteroidBeltDescription,
    [ABILITY_REFLECT_DAMAGE] = sReflectDamageDescription,
    [ABILITY_JACK_FROST] = sJackFrostDescription,
    [ABILITY_DUNEWARD] = sDunewardDescription,
    [ABILITY_TURBULENCE] = sTurbulenceDescription,
    [ABILITY_VAMPIRE_ASCENDANT] = sVampireAscendantDescription,
    [ABILITY_WATCHFUL_EYEBALL] = sWatchfulEyeballDescription,
    [ABILITY_IRON_WILL] = sIronWillDescription,
    [ABILITY_OILY_LOCKS] = sOilyLocksDescription,
    [ABILITY_CURLY_HAIR] = sCurlyHairDescription,
    [ABILITY_MEGA_MANE] = sMegaManeDescription,
    [ABILITY_MOCOUS_COAT] = sMocousCoatDescription,
    [ABILITY_HEALING_AROMA] = sHealingAromaDescription,
    [ABILITY_MALIGNATE] = sMalignateDescription,
    [ABILITY_GRAVITROPISM] = sGravitropismDescription,
    [ABILITY_PHOTOTROPISM] = sPhototropismDescription,
    [ABILITY_LURELIGHT] = sLurelightDescription,
    [ABILITY_DEEP_DWELLER] = sDeepDwellerDescription,
    [ABILITY_BENTHIC_ORGANISM] = sBenthicOrganismDescription,
    [ABILITY_FROM_THE_VOID] = sFromTheVoidDescription,
    [ABILITY_AURA_GUARD] = sAuraGuardDescription,
    [ABILITY_GRIM_OMEN] = sGrimOmenDescription,
    [ABILITY_CHRONOBREAK] = sChronobreakDescription,
    [ABILITY_OUTLANDER] = sOutlanderDescription,
    [ABILITY_MEDICINE_SCALE] = sMedicineScaleDescription,
    [ABILITY_GOD_OF_CREATION] = sGodOfCreationDescription,
    [ABILITY_ORIGINAL_ONE] = sOriginalOneDescription,
    [ABILITY_OMNISCIENT] = sOmniscientDescription,
    [ABILITY_OVERDRIVE_MODE] = sOverdriveModeDescription,
    [ABILITY_BIOFROST] = sBiofrostDescription,
    [ABILITY_METALLIZE] = sMetallizeDescription,
    [ABILITY_MINERALIZE] = sMineralizeDescription,
    [ABILITY_MAKER_OF_OCEANS] = sMakerOfOceansDescription,
    [ABILITY_MAKER_OF_LANDS] = sMakerOfLandsDescription,
    [ABILITY_SUPER_ANCIENT] = sSuperAncientDescription,
    [ABILITY_DRAGON_LORD] = sDragonLordDescription,
    [ABILITY_MINERAL_DIET] = sMineralDietDescription,
    [ABILITY_SEGIN_STARMOBILE] = sSeginStarmobileDescription,
    [ABILITY_SCHEDAR_STARMOBILE] = sSchedarStarmobileDescription,
    [ABILITY_NAVI_STARMOBILE] = sNaviStarmobileDescription,
    [ABILITY_RUCHBAH_STARMOBILE] = sRuchbahStarmobileDescription,
    [ABILITY_CAPH_STARMOBILE] = sCaphStarmobileDescription,
    [ABILITY_NITRO_ENGINE] = sNitroEngineDescription,
    [ABILITY_FULL_THROTTLE] = sFullThrottleDescription,
    [ABILITY_METEOR_SEEKER] = sMeteorSeekerDescription,
    [ABILITY_PESTILENCE] = sPestilenceDescription,
    [ABILITY_CONTAGION] = sContagionDescription,
    [ABILITY_PLAGUE_DOCTOR] = sPlagueDoctorDescription,
    [ABILITY_FOUL_DIGEST] = sFoulDigestDescription,
    [ABILITY_MICOGENESIS] = sMicogenesisDescription,
    [ABILITY_PRESSURIZED_GAS] = sPressurizedGasDescription,
    [ABILITY_CARBON_EMITTER] = sCarbonEmitterDescription,
    [ABILITY_MOON_GUARD] = sMoonGuardDescription,
    [ABILITY_TURTLE_UP] = sTurtleUpDescription,
    [ABILITY_ARCANE_POWER] = sArcanePowerDescription,
    [ABILITY_REPELLENT_FUR] = sRepellentFurDescription,
    [ABILITY_AIR_BUBBLE] = sAirBubbleDescription,
    [ABILITY_MISTY_ESCAPE] = sMistyEscapeDescription,
    [ABILITY_TROPIC_BREEZE] = sTropicBreezeDescription,
    [ABILITY_FRESH_PICKED_FRUIT] = sFreshPickedFruitDescription,
    [ABILITY_DEADLY_INFECTION] = sDeadlyInfectionDescription,
    [ABILITY_FULL_MOON] = sFullMoonDescription,
    [ABILITY_DEFLECTOR_LASH] = sDeflectorLashDescription,
    [ABILITY_WINTER_POWER] = sWinterPowerDescription,
    [ABILITY_SUMMER_POWER] = sSummerPowerDescription,
    [ABILITY_AUTUMN_POWER] = sAutumnPowerDescription,
    [ABILITY_SPRING_POWER] = sSpringPowerDescription,
    [ABILITY_DARKEST_DAY] = sDarkestDayDescription,
    [ABILITY_OMINOUS_AURA] = sOminousAuraDescription,
    [ABILITY_OUROBOROS] = sOuroborosDescription,
    [ABILITY_HEAD_REGROWTH] = sHeadRegrowthDescription,
    [ABILITY_GOLD_DIGGER] = sGoldDiggerDescription,
    [ABILITY_MAGNET_HOVER] = sMagnetHoverDescription,
    [ABILITY_SWIFT_POWER] = sSwiftPowerDescription,
    [ABILITY_NEUTRON_PULSAR] = sNeutronPulsarDescription,
    [ABILITY_BLINK] = sBlinkDescription,
    [ABILITY_MATTER_ANNIHILATION] = sMatterAnnihilationDescription,
    [ABILITY_DANCE_LESSONS] = sDanceLessonsDescription,
    [ABILITY_CREATION_OF_ANTIMATTER] = sCreationOfAntimatterDescription,
    [ABILITY_CREATION_OF_TIME] = sCreationOfTimeDescription,
    [ABILITY_CREATION_OF_SPACE] = sCreationOfSpaceDescription,
    [ABILITY_GREAT_ECHO] = sGreatEchoDescription,
    [ABILITY_ACIDIFIED_RAIN] = sAcidifiedRainDescription,
    [ABILITY_BLACK_QUASAR] = sBlackQuasarDescription,
    [ABILITY_POWER_BOUNCER] = sPowerBouncerDescription,
    [ABILITY_VIRAL_VECTOR] = sViralVectorDescription,
    [ABILITY_MUTAGENESIS] = sMutagenesisDescription,
    [ABILITY_DNA_RECOMBINATION] = sDnaRecombinationDescription,
    [ABILITY_BLITZKRIEG] = sBlitzkriegDescription,
    [ABILITY_AGM_65_MAVERICK] = sAgm65MaverickDescription,
    [ABILITY_TRACKING] = sTrackingDescription,
    [ABILITY_SHELLDER_COMMAND] = sShellderCommandDescription,
    [ABILITY_SLOWPOKE_TAIL] = sSlowpokeTailDescription,
    [ABILITY_GENETIC_NEXUS] = sGeneticNexusDescription,
    [ABILITY_POWER_GATE] = sPowerGateDescription,
...
static const u8 sDrizzleDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons rain for five\nturns. Rain: Boosts Water-typ-\ne moves by 50% and weakens the\npower of Fire-type moves by 5\n0%, Thunder and Hurricane igno-\nre Accuracy and Evasion checks\n.");
...
static const u8 sDampDescriptionExtended[] = _("Prevents all Pokémon currentl-\ny in battle from using explosi-\nve moves such as Self-Destruct\n, Explosion, Mind Blown, and M-\nisty Explosion and the Ability\nAftermath.");
static const u8 sLimberDescriptionExtended[] = _("Prevents the Pokémon from bei-\nng afflicted by paralysis and \nreduces the crash damage taken\nfrom moves by 50% when it mis-\nses.");
...
static const u8 sObliviousDescriptionExtended[] = _("Prevents the Pokémon from bei-\nng hit by emotional and kissin-\ng moves, afflicted by infatuat-\nion and Taunt, cannot be affec-\nted by Captivate and blocks In-\ntimidate and Frighten.");
...
static const u8 sOwnTempoDescriptionExtended[] = _("Prevents the Pokémon from bei-\nng afflicted by confusion, eve-\nn if it is self-inflicted, and\ntakes 50% less damage from Ps-\nychic-type moves. Also, blocks\nIntimidate and Frighten.");
static const u8 sSuctionCupsDescriptionExtended[] = _("When the Pokémon attacks with\na move that makes contact, tr-\naps the foe for two to three t-\nurns. Also, the Pokémon is imm-\nune from being forced to switc-\nh out or flee. If the Pokémon \nis in first place in the party\n(even if fainted), bites will\noccur more often while fishin-\ng.");
...
static const u8 sHugePowerDescriptionExtended[] = _("The Pokémon's Attack stat is \ndoubled.");
...
static const u8 sThickFatDescriptionExtended[] = _("The Pokémon takes 50% less da-\nmage from Fire- and Ice-type m-\noves and prevents the Pokémon \nfrom being burned, frozen or g-\net a frostbite. Also, the powe-\nr of Body Slam used by the Pok-\némon is increased by 50%.");
...
static const u8 sRunAwayDescriptionExtended[] = _("When a stat of the Pokémon is\nlowered by an opposing Pokémo-\nn, its Speed stat is increased\nby two stages. It will not ac-\ntivate if the Pokémon with thi-\ns Ability lowers its own stats\n, or if its stats are lowered \nby an ally. The Pokémon can al-\nways flee and use Teleport suc-\ncessfully, regardless of trapp-\ning moves and Abilities. ");
...
static const u8 sPlusDescriptionExtended[] = _("Increases the power of Electr-\nic-type moves of the Pokémon b-\ny 10% for each ally alive with\nthe Minus ability in your par-\nty, up to 30%. Whenever an all-\ny Pokémon with Minus ability a-\nttacks with a magnet move, the\nPokémon will immediately atta-\nck that move as well.");
static const u8 sMinusDescriptionExtended[] = _("Increases the power of Electr-\nic-type moves of the Pokémon b-\ny 10% for each ally alive with\nthe Plus ability in your part-\ny, up to 30%. Whenever an ally\nPokémon with Plus ability att-\nacks with a magnet move, the P-\nokémon will immediately attack\nthat move as well.");
static const u8 sForecastDescriptionExtended[] = _("Castform will change its form\ndepeding on the weather. Also\n, during weather conditions, a-\nll stats are increased by 20%,\nprevents the Pokémon from bei-\nng afflicted by status conditi-\nons or become drowsy due to Ya-\nwn, heals any status condition\nand restores its HP by 1/8 of\nits maximum HP at the end of \neach turn.");
...
static const u8 sDroughtDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons harsh sunligh-\nt for five turns. Harsh Sunlig-\nht: Boosts Fire-type moves by \n50% and weakens Water-type mov-\nes by 50%, Solar Beam and Sola-\nr Blade become one-turn moves,\nGrowth have its effect double-\nd, Synthesis restore more HP.");
...
static const u8 sSteadfastDescriptionExtended[] = _("Every time the HP of the Poké-\nmon drops below half, its Defe-\nnse and Special Defense stats \nare increased by one stage. Al-\nso, increases the Speed stat o-\nf the Pokémon by one stage whe-\nn flinched.");
...
static const u8 sSuperLuckDescriptionExtended[] = _("Increases the critical hit ra-\ntio by 1 stage. If the Pokémon\nleads the party (even if fain-\nted), the chances of finding a\nwild Pokémon holding an item \nincrease from 50%/5% to 60%/20\n%.");
static const u8 sAftermathDescriptionExtended[] = _("When a Pokémon with this Abil-\nity faints due to damage from \na move that makes contact, the\nattacking Pokémon takes damag-\ne equal to 1/4 of its own maxi-\nmum HP.");
...
static const u8 sToxicBoostDescriptionExtended[] = _("While the Pokémon is poisoned\n, if the Attack stat is higher\nthan the Special Attack stat,\nincreases the power of its ph-\nysical moves by 50%. Otherwise\n, increases the power of its s-\npecial moves by 50%.");
...
static const u8 sTelepathyDescriptionExtended[] = _("The Pokémon and its allies ar-\ne protected from damaging move-\ns used by each other. Also, in-\ncreases the power of Psychic-t-\nype moves by 20% used by the P-\nokémon.");
...
static const u8 sSandForceDescriptionExtended[] = _("During a sandstorm, increases\nthe power of Rock-, Ground-, \nand Steel-type moves used by t-\nhe Pokémon by 30%. The Pokémon\nwill take no damage from the \nsandstorm.");
...
static const u8 sTurboblazeDescriptionExtended[] = _("When the Pokémon uses a move,\nthe effects of all ignorable \nAbilities are ignored for the \nexecution of that move. Also, \nadds the Fire-type to the Poké-\nmon, in addition to the Pokémo-\nn's original type(s) and moves\nthat would be “supereffective-\n” against pure Fire-type Pokém-\non will be only normally effec-\ntive instead.");
static const u8 sTeravoltDescriptionExtended[] = _("When the Pokémon uses a move,\nthe effects of all ignorable \nAbilities are ignored for the \nexecution of that move. Also, \nadds the Electric-type to the \nPokémon, in addition to the Po-\nkémon's original type(s) and m-\noves that would be “supereffec-\ntive” against pure Electric-ty-\npe Pokémon will be only normal-\nly effective instead.");
...
static const u8 sToughClawsDescriptionExtended[] = _("The power of moves that make \ncontact used by the Pokémon ar-\ne increased by 30%.");
...
static const u8 sParentalBondDescriptionExtended[] = _("Damaging moves become two-str-\nike moves, with the second str-\nike dealing 25% damage (unless\nit is a set-damage move).");
...
static const u8 sDeltaStreamDescriptionExtended[] = _("Summons strong wind in battle\nas soon as the Pokémon enters\nthe battlefield. Strong winds-\n: Moves that would be “superef-\nfective” against pure Flying-t-\nype Pokémon to instead deal ne-\nutral damage to the Flying-typ-\ne from Pokémon instead.");
...
static const u8 sSlushRushDescriptionExtended[] = _("On a Frozen Terrain, the Spee-\nd stat of the Pokémon is doubl-\ned. The Pokémon is unaffected \nby Frozen Terrain's negative e-\nffects.");
...
static const u8 sDisguiseDescriptionExtended[] = _("The shroud that covers the Po-\nkémon can protect it from an a-\nttack once.");
...
static const u8 sNeuroforceDescriptionExtended[] = _("The Pokémon deals 25% more da-\nmage and takes 25% less damage\nfrom “supereffective” moves.");
...
static const u8 sSandSpitDescriptionExtended[] = _("Summons a sandstorm in battle\nfor five turns when the Pokém-\non is hit by a damaging move. \nSandstorm: Any Pokémon that is\nnot Rock-, Ground- or Steel-t-\nype will be damaged for 1/16 o-\nf its maximum HP, Special Defe-\nnse of Rock-type Pokémon is in-\ncreased by 50% and Shore Up re-\nstores more HP.");
...
static const u8 sPerishBodyDescriptionExtended[] = _("When the Pokémon is hit, both\nthe attacker and the Pokémon \nwill faint in three turns.");
...
static const u8 sNeutralizingGasDescriptionExtended[] = _("Neutralizing Gas suppresses t-\nhe effects of all abilities of\nother Pokémon currently in ba-\nttle. The Pokémon is unaffecte-\nd by Neutralizing Gas ability.");
...
static const u8 sUnseenFistDescriptionExtended[] = _("Moves that make contact used \nby the Pokémon hit targets thr-\nough protection moves, dealing\n25% of the original damage.");
...
static const u8 sPurifyingSaltDescriptionExtended[] = _("Prevents this Pokémon from be-\ning afflicted by status condit-\nions. Damage from Ghost-type m-\noves used against it is halved-\n. Rest fails if used by this P-\nokémon.");
...
static const u8 sOrichalcumPulseDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons harsh sunligh-\nt for five turns that boosts t-\nhe its Attack stat by 33%. Har-\nsh Sunlight: Boosts Fire-type \nmoves by 50% and weakens Water\n-type moves by 50%, Solar Beam\nand Solar Blade become one-tu-\nrn moves, Growth have its effe-\nct doubled, Synthesis restore \nmore HP.");
...
static const u8 sSupersweetSyrupDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nlowers the Evasion stat of all\nopposing Pokémon by one stage\n.");
...
static const u8 sRampageDescriptionExtended[] = _("The Pokémon doesn't need to r-\necharge on the next turn after\na move is used, but two addit-\nional PPs are deducted, for a \ntotal of three PPs deduction. \nWhen the Pokémon directly caus-\nes another Pokémon (including \nallies) to faint by using thes-\ne moves, restores three PPs fr-\nom that move.");
static const u8 sLetItRipDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Defense Curl. Defense Cur-\nl: increases the Defense stat \nby one stage. Also, doubles th-\ne power of Rollout, Ice Ball, \nRapid Spin, Steamroller and St-\neel Roller.");
...
static const u8 sPreciseFistDescriptionExtended[] = _("Punching moves have critical \nrate increased by 2. Special T-\nechnique: Dynamic Punch's Accu-\nracy is increased to 100%.");
...
static const u8 sMomentumDescriptionExtended[] = _("Damaging moves that make cont-\nact use Speed stat instead for\nthe damage calculation, but i-\nt receives recoil damage equal\nto 33% of damage dealt. The S-\npeed stat stage-modifiers, ite-\nms and other abilities are app-\nlied to the stat calculation.");
...
static const u8 sMultiHeadedDescriptionExtended[] = _("Single-targeting moves hit tw-\no, three or five times dependi-\nng on the number of heads, dea-\nling 25%, 33% or 40% more dama-\nge. It doesn't work with multi\nhit moves, and Flinch won't b-\ne applied.");
...
static const u8 sPsyBarrierDescriptionExtended[] = _("(NOT IMPLEMENTED)");
...
static const u8 sSoilRootDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Ingrain. Ingrain effect: \nAt the end of the turn, restor-\nes 1/16 of its maximum HP. Pre-\nvents others from forcing the \nPokémon to switch out or flee.\nThe Pokémon can uses moves as\nif it is under harsh sunlight\n.");
static const u8 sSandySurgeDescriptionExtended[] = _("When the Pokémon enters the b-\nattle, it creates the effect o-\nf the move Sandy Terrain on th-\ne battlefield for five turns. \nSandy Terrain: Increases the p-\nower of Ground-type moves by 3\n0% of Pokémon that are on the \nground and non-Ground- and Roc-\nk-type Pokémon have their Evas-\nion reduced by 40%. Halves the\npower of Surf, Waterfall and \nWhirlpool.");
...
static const u8 sJuggernautDescriptionExtended[] = _("Damaging moves that makes con-\ntact use 20% of Defense stat i-\nn addition to the default stat\nfor the damage calculation on-\nly. The Defense stat stage-mod-\nifiers, items and other abilit-\nies are applied to this percen-\ntage. Also, if the Pokémon is \nparalyzed, it cannot be fully \nparalyzed.");
...
static const u8 sPlaceholder18DescriptionExtended[] = _("There is a 50% chance of badl-\ny poisoning opposing Pokémon w-\nith biting moves.");
static const u8 sLeechFangsDescriptionExtended[] = _("50% of the damage dealt by bi-\nting move is converted as the \nPokémon's HP.");
static const u8 sScavengerDescriptionExtended[] = _("When the Pokémon directly cau-\nses another Pokémon (including\nallies) to faint by using a d-\namaging move, restores the Pok-\némon's HP by 25% of that targe-\nt's maximum HP.");
static const u8 sNocturnalDescriptionExtended[] = _("This Pokémon's Dark-type move-\ns receive STAB regardless of i-\nts typing. Also, the Speed sta-\nt of the Pokémon is doubled wh-\nile under gloom moonlight.");
...
static const u8 sIroncladKeelDescriptionExtended[] = _("Adds the Steel-type to the Po-\nkémon, in addition to the Poké-\nmon's original type(s) and mov-\nes that would be “supereffecti-\nve” against pure Steel-type Po-\nkémon will be only normally ef-\nfective instead.");
...
static const u8 sGripPincerDescriptionExtended[] = _("When the Pokémon attacks with\na move that makes contact, th-\nere is a 30% chance to trap th-\ne foe for two to three turns. \nIf the foe is trapped, contact\nmoves ignore any change to th-\ne Defense stat stages and bypa-\nss Accuracy check. If the Poké-\nmon is in first place in the p-\nlayer's party (even if fainted-\n), bites will occur more often\nwhile fishing.");
...
static const u8 sSpeedForceDescriptionExtended[] = _("Damaging moves that make cont-\nact use 20% of its Speed stat \nin addition to the default sta-\nt for the damage calculation. \nThe Speed stat stage-modifiers\n, items and other abilities ar-\ne applied to this percentage. \nAlso, if the Pokémon is paraly-\nzed, it cannot be fully paraly-\nzed.");
...
static const u8 sSpatialWarpDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nwarps through space, avoinding\nany entry hazard and attacks.\nAfter the Pokémon uses any mo-\nve, it will reappear.");
static const u8 sTemporalFlowDescriptionExtended[] = _("Halves the Speed stat of all \nopposing Pokémon.");
static const u8 sSeaGuardianDescriptionExtended[] = _("Summons rain in battle as soo-\nn as the Pokémon enters the ba-\nttlefield and increases the Po-\nkémon's highest offensive stat\nby 33% in rain. The rain last-\ns for five turns. Rain: Boosts\nWater-type moves by 50% and w-\neakens the power of Fire-type \nmoves by 50%, Thunder and Hurr-\nicane ignore Accuracy and Evas-\nion checks.");
...
static const u8 sPsychicBarrierDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nsummons a psyshield equal to 5\n0% of its maximum HP. Psyshiel-\nd: The Pokémon is not affected\nby many status moves used by \nother Pokémon.");
...
static const u8 sPetrifiedWoodDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a Grass-type mov-\ne, its Defense and Special Def-\nense stats are increased by on-\ne stage.");
...
static const u8 sWeathercastDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it creates a weather if \nit has Rain Dance, Sunny Day, \nHail, Sandstorm or Moony Night\nin the movepool (if any, prio-\nritizing the first move with P-\nPs in the movepool and costing\none PP from that move).");
...
static const u8 sSpiderLairDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nsets Sticky Web on both side o-\nf field. Sticky Web: lowers th-\ne Speed stat by one stage and \nmake them grounded upon switch-\ning in, except Bug-type Pokémo-\nn.");
...
static const u8 sChargeAttackDescriptionExtended[] = _("The Pokémon has its Speed sta-\nt doubled on the first turn th-\nat the Pokémon is out.");
...
static const u8 sInflatableDescriptionExtended[] = _("When the Pokémon is hit by a \nFire- or Flying-type or Wind m-\nove, its Defense and Special D-\nefense stats are increased by \none stage.");
static const u8 sDistortionWorldDescriptionExtended[] = _("When the Pokémon is in battle\n, all effects of weather, terr-\nain, space and time are negate-\nd (though the weather or terra-\nin itself does not disappear).\nAbilities: Spatial Warp, Temp-\noral Flow, Rewind, Spacetime S-\ntrain, Chronobreak, Riftwalk, \nTime Skip, Creation of Space a-\nnd Creation of Time.");
static const u8 sCoilUpDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \ncoils up. Coil: Increases the \nAttack, Defense and Accuracy s-\ntats by one stage and increasi-\nng the priority of the next bi-\nting move by one.");
...
static const u8 sSandPlowDescriptionExtended[] = _("When the Pokémon attacks with\na Ground-type damaging move, \nthere is a 30% chance to trap \ntheir target inside a harshly \nraging sandstorm for two to th-\nree turns.");
static const u8 sDesertSpiritDescriptionExtended[] = _("When the Pokémon attacks with\na sound-based move, there is \na 30% chance the target will b-\necome infatuated. This effect \nactivates regardless of the Po-\nkémon gender.");
static const u8 sGrowingToothDescriptionExtended[] = _("When the Pokémon attacks with\na biting move, increases its \nAttack stat by one stage.");
...
static const u8 sMajesticMothDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, inc-\nreases the highest stat of the\nPokémon by one stage.");
static const u8 sAuroraBorealisDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Aurora Veil. The aurora v-\neil lasts for five turns. Auro-\nra Veil: reduces the damage of\nphysical and special moves by\nhalf, reduced to 1/3 in doubl-\ne battles.");
...
static const u8 sAirBlowerDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Tailwind. The tailwind la-\nsts for four turns. Tailwind: \nDoubles the Speed stat of all \nPokémon in your side of the ba-\nttlefield.");
...
static const u8 sMuscleGaugeDescriptionExtended[] = _("Each time the Pokémon uses a \nmove, increases the stacks of \nMuscle Gauge by one. When the \nPokémon uses the first physica-\nl move in the movepool, it con-\nsumes all stacks of Muscle Gau-\nge to increase that move's pow-\ner by 10 per stack consumed. M-\naximum of 6 stacks.");
static const u8 sTwistedDimensionDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Trick Room. The effect la-\nsts for five turns. Trick Room-\n: Reverses the move order with-\nin each priority bracket so th-\nat Pokémon with a lower Speed \nstat attack first, while those\nwith a higher Speed stat will\nattack last.");
...
static const u8 sMaleficentDescriptionExtended[] = _("During a gloom moonlight, inc-\nreases the Pokémon's highest o-\nffensive stat by 50% but it lo-\nses HP equal to 1/16 of its ma-\nximum HP every turn.");
...
static const u8 sRewindDescriptionExtended[] = _("While the Pokémon is on the f-\nield, all effects that happen \nin the end of each turn are ap-\nplied twice.");
static const u8 sAntarcticBirdDescriptionExtended[] = _("The Pokémon's Water-, Ice- an-\nd Flying-type moves gain same-\ntype attack bonus regardless t-\nhe Pokémon's typing. The Pokém-\non is unaffected by Swamp Terr-\nain or Frozen Terrain's negati-\nve effects.");
...
static const u8 sGravitonRayDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Gravity. The Pokémon is u-\nnaffected by Gravity. Gravity:\nPokémon have their Accuracy s-\ntat multiplied by 5/3, all Pok-\némon on the field to become gr-\nounded and prevents Bounce, Fl-\ny, Flying Press, High Jump Kic-\nk, Jump Kick, Magnet Rise, Sky\nDrop, Splash and Telekinesis.");
static const u8 sForceOfNatureDescriptionExtended[] = _("When the Pokémon uses a damag-\ning move, the effect of all ig-\nnorable abilities and protecti-\non moves are ignored for the e-\nxecution of that move. The Pok-\némon cannot be unable to use a\nmove due paralysis, flinching\n, frozen, sleep, confusion or \nattraction, and bypass Accurac-\ny checks.");
...
static const u8 sDragonizeDescriptionExtended[] = _("All Normal-type moves used by\nthe Pokémon become Dragon-typ-\ne and receive a 20% power boos-\nt.");
...
static const u8 sColdBloodedDescriptionExtended[] = _("During harsh sunlight, increa-\nses the Pokémon's Attack and S-\npeed stats by 33%. During hail-\nstorm, halves the Pokémon's Sp-\need stat and takes damage equa-\nl to 1/16 of its maximum HP. T-\nhe Pokémon takes 25% more dama-\nge from Ice-type moves.");
...
static const u8 sThundercloudsDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nsummons thunderclouds. The thu-\nnderclouds lasts for five turn-\ns. Thunderclouds: Deals Electr-\nic-type damage with 30 power a-\nt the end of each turn to all \nopposing Pokémon.");
...
static const u8 sDefensiveManeuverDescriptionExtended[] = _("When the Pokémon is attacked \nby a damaging move, the faster\nthe Pokémon is compared to th-\ne attacker, the lower the dama-\nge received, up to 50%.");
...
static const u8 sHeavilyArmouredDescriptionExtended[] = _("All damaging moves against th-\ne Pokémon cannot miss or crit,\nbut the Pokémon takes 30% les-\ns damage from attacks. Additio-\nnally, any damage less than a \nquarter of Pokémon's maximum H-\nP is halved.");
...
static const u8 sPhotovoltaicFrillDescriptionExtended[] = _("When harsh sunlight takes eff-\nect, increases the Pokémon's S-\npeed stats by one stage and be-\ncomes charged, doubling the po-\nwer of the next Electric-type \nmove it uses.");
static const u8 sPlaceholder_15DescriptionExtended[] = _("When the Pokémon would drop i-\nts HP below 25% or become pois-\noned, it gains Substitute equa-\nl 25% HP and cure poison statu-\ns.");
...
static const u8 sTideWaiterDescriptionExtended[] = _("Increases the priority of dam-\naging move by +1 when opposing\nPokémon has a status conditio-\nn or its HP is below half. Oth-\nerwise, it decreases the prior-\nity of damaging move by -1. It\nworks only with single-target\ndamaging moves in double batt-\nles.");
...
static const u8 sDarkSideDescriptionExtended[] = _("Adds the Dark-type to the Pok-\némon, in addition to the Pokém-\non's original type(s) and move-\ns that would be “supereffectiv-\ne” against pure Dark-type Poké-\nmon will be only normally effe-\nctive instead.");
static const u8 sAbsorbElementsDescriptionExtended[] = _("When the Pokémon is attacked \nby a move with the same type o-\nf the Pokémon, the move will h-\nave no effect on that Pokémon \nand restores 1/4 of its maximu-\nm HP.");
static const u8 sDeepSeaStarDescriptionExtended[] = _("The Pokémon's Electric-type m-\noves lower target's Accuracy b-\ny one stage.");
static const u8 sArcticForceDescriptionExtended[] = _("During a hailstorm, increases\nthe power of Water- and Ice-t-\nype moves used by the Pokémon \nby 30%. The Pokémon will take \nno damage from the hailstorm.");
static const u8 sTenacityDescriptionExtended[] = _("If the Pokémon is attacked by\na damaging move that would ca-\nuse it to faint, there is a 30\n% chance to survive with 1 HP.");
...
static const u8 sDancingTentaclesDescriptionExtended[] = _("Foes binded by the Pokémon be-\ncome confused for the duration\n.");
...
static const u8 sBranchSwingDescriptionExtended[] = _("The Speed stat of the Pokémon\nis doubled and the Pokémon be-\ncomes ungrounded on grassy ter-\nrain. The Pokémon is still aff-\nected by grassy terrain regard-\nless.");
...
static const u8 sHighTideDescriptionExtended[] = _("When the Pokémon attacks with\na Water-type damaging move, t-\nhere is a 30% chance to trap t-\nhe foe inside a vortex for two\nto three turns.");
...
static const u8 sPlagueSpreadingDescriptionExtended[] = _("When the Pokémon attacks usin-\ng a move that makes contact, t-\nhe opposing Pokémon or a rando-\nm Pokémon in opponent's party \nwill become poisoned. ");
...
static const u8 sDragonHoardDescriptionExtended[] = _("When the Pokémon consumes its\ngem, it doubles the power of \nDragon Breath.");
static const u8 sBugCatcherDescriptionExtended[] = _("The Pokémon deals 20% more da-\nmage to Bug-type Pokémon. Also\n, increases the odds of catchi-\nng Bug-type Pokémon by 25%.");
static const u8 sNeurotoxicVenomDescriptionExtended[] = _("When a Pokémon is poisoned by\nthe Pokémon, it will also suf-\nfer paralysis effects.");
static const u8 sHemotoxicVenomDescriptionExtended[] = _("When a Pokémon is poisoned by\nthe Pokémon, it will also tak-\ne double damage from Poison st-\natus and take additional 25% d-\namage from contact moves.");
static const u8 sSolenoglyphsDescriptionExtended[] = _("The power of biting moves use-\nd by the Pokémon are increased\nby 20% and the chance of seco-\nndary effects is doubled. ");
static const u8 sProspectingDescriptionExtended[] = _("(Not Implemented)");
static const u8 sOccultismDescriptionExtended[] = _("(Not Implemented)");
static const u8 sSpellweaverDescriptionExtended[] = _("The Pokémon behave as though \nthe terrain were Psychic Terra-\nin, regardless of the actual t-\nerrain on the field. Psychic T-\nerrain: It boosts the power of\nPsychic-type moves used by af-\nfected Pokémon by 30%, become \nimmune to opponents' moves wit-\nh increased priority and boost-\ns the power of Expanding Force\nby 50% and hit both opposing \nPokémon.");
static const u8 sTurnToOilDescriptionExtended[] = _("While this Pokémon is on the \nfield, all Water-type moves us-\ned by any Pokémon become Groun-\nd-type.");
static const u8 sCollosusDescriptionExtended[] = _("The Pokémon takes less damage\nfrom moves that makes contact\n, the bigger the Pokémon is th-\nan the attacker. It cannot red-\nuce the incoming damage more t-\nhan 33%. It doesn't affect opp-\nosing Pokémon that is bigger t-\nhan the Pokémon.");
static const u8 sContaminateDescriptionExtended[] = _("Poison-type moves used by the\nPokémon will be “supereffecti-\nve” against pure Water-type Po-\nkémon.");
static const u8 sSawtoothRushDescriptionExtended[] = _("(Not Implemented)");
...
static const u8 sVolatileFumesDescriptionExtended[] = _("Boosts the power of Fire-type\nmoves used by the Pokémon by \n50%. Also, when the Pokémon is\nhit by a damaging move, the a-\nttacking Pokémon will become b-\nurned.");
static const u8 sUmbralDominionDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons gloom moonlig-\nht for five turns. Gloom Moonl-\night: Boosts Dark-type moves b-\ny 50%, doubles Speed stat if t-\nhe Pokémon has Nocturnal abili-\nty, Moonlight restores more HP\n, Morning Sun and Synthesis re-\nstores less HP, Crowstorm igno-\nre Accuracy checks, Midnight B-\neam has no charge.");
static const u8 sChrysalisVeilDescriptionExtended[] = _("Increases the Pokémon's base \nstats by their previous evolut-\nion's base stats.");
static const u8 sPollinationSurgeDescriptionExtended[] = _("When the Pokémon enters the b-\nattle, it creates the effect o-\nf the move Pollination Terrain\non the battlefield for five t-\nurns. Pollination Terrain: Boo-\nsts the power of Bug-type move-\ns by 30% of Pokémon that are o-\nn the ground and ignore negati-\nve stat stages from Bug-type P-\nokémon and ignore positive sta-\nt stages from non-Bug- and Gra-\nss-type Pokémon.");
static const u8 sChiliFeverDescriptionExtended[] = _("When a Pokémon is burned by t-\nhe Pokémon, it will also becom-\ne confused.");
static const u8 sRemodelingFrameDescriptionExtended[] = _("When the Pokémon is hit by a \ndamage-dealing move, the Pokém-\non's types will be changed to \nthe type of the move that it w-\nas hit by and restore 1/16 of \nits maximum HP.");
static const u8 sNurseryDescriptionExtended[] = _("At the end of each turn, the \nPokémon heals an adjacent ally\nby 1/16 of its maximum HP. ");
static const u8 sAfterimageDescriptionExtended[] = _("The Pokémon uses 20% of its S-\npeed stat against incoming phy-\nsical moves as a defensive sta-\nt in addition to the default s-\ntat during the damage calculat-\nion. The Speed stat stages, it-\nems and abilities still affect\nthis percentage.");
static const u8 sAeroVoiceDescriptionExtended[] = _("All sound-based moves become \nFlying-type moves and boosts t-\nhem by 20%.");
static const u8 sGravekeeperDescriptionExtended[] = _("While Cursed Terrain is activ-\ne, the Special Defense stat of\nthe Pokémon is increased by 5\n0%. Also, the Pokémon is unaff-\nected by healing block from Cu-\nrsed Terrain effect.");
static const u8 sSaltRitualDescriptionExtended[] = _("When the Pokémon uses Smellin-\ng Salts or Brine move, it also\napplies Salt Cure effects on \nthe target. Salt Cure: Inflict-\ns 1/16 of the target's maximum\nHP as damage per turn in addi-\ntion to the damage dealt when \nit is used. If a Steel and/or \nWater type is affected by Salt\nCure, the amount of damage pe-\nr turn is 1/8 of its maximum H-\nP.");
static const u8 sVelocityShiftDescriptionExtended[] = _("Damaging moves use Speed stat\ninstead of the default stat d-\nuring the damage calculation, \nbut they will lower the Pokémo-\nn's Speed stat stage by one if\nit is higher than default sta-\nt stage. The Speed stat stage-\nmodifiers, items and other abi-\nlities are applied to the stat\ncalculation.");
static const u8 sFaeBaneDescriptionExtended[] = _("The Dark-type Pokémon takes n-\neutral damage from Fairy-type \nmoves. Dark-type moves used by\nthe Pokémon deal neutral dama-\nge against Fairy-type Pokémon.");
static const u8 sBombardmentDescriptionExtended[] = _("When the Pokémon is targeted \nwhile in air, the Pokémon uses\nRock Throw with 50 Base Power\nagainst the attacker.");
static const u8 sHellishResistanceDescriptionExtended[] = _("While Burning Terrain is acti-\nve, the Special Defense stat o-\nf the Pokémon is increased by \n50%. Also, the Pokémon takes n-\no damage from Burning Terrain \neffect.");
static const u8 sFaeTouchedDescriptionExtended[] = _("Restores the Pokémon's HP by \n33% of its maximum HP and heal-\ns any status condition upon sw-\nitching out.");
static const u8 sLastRitesDescriptionExtended[] = _("When the Pokémon faints by a \ndamaging move from an opposing\nPokémon, that move will lose \nall of its PP. ");
static const u8 sLatentPsycheDescriptionExtended[] = _("Adds the Psychic-type to the \nPokémon, in addition to the Po-\nkémon's original type(s) and m-\noves that would be “supereffec-\ntive” against pure Psychic-typ-\ne Pokémon will be only normall-\ny effective instead.");
static const u8 sPsionicDominanceDescriptionExtended[] = _("The Pokémon is immune to Psyc-\nhic-type moves, and increases \nthe highest offensive stat by \none stage when attacked by one-\n. Also, forces all single-targ-\net Psychic-type moves to targe-\nt the Pokémon. If the Pokémon \nis in the first place in the p-\narty, there is a 50% chance th-\ne game will force an encounter\nwith an Psychic-type Pokémon.");
static const u8 sPsionicBacklashDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a special move, \nthe opposing Pokémon takes dam-\nage equal to 1/8 of its maximu-\nm HP. ");
static const u8 sMindFractureDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a special move, \nthere is a 30% chance that the\nopposing Pokémon will become \nconfused.");
static const u8 sGoreRushDescriptionExtended[] = _("(Not Implemented)");
static const u8 sUnerringImpaleDescriptionExtended[] = _("The Pokémon's moves bypass ac-\ncuracy check against Pokémon w-\nith full HP.");
static const u8 sPerilousStakeDescriptionExtended[] = _("All attacks used by or agains-\nt the Pokémon are always criti-\ncal hit.");
static const u8 sSkySovereignDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Tailwind. The tailwind la-\nsts for four turns. Tailwind: \nDoubles the Speed stat of all \nPokémon in your side of the ba-\nttlefield.");
static const u8 sNecrotoxicVenomDescriptionExtended[] = _("When a Pokémon is poisoned by\nthe Pokémon, it will also tak-\ne damage from healing effect i-\nnstead of regaining HP, but ta-\nkes half damage from Poison st-\natus.");
static const u8 sStoneScatterDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nsets Stealth Rock on the oppos-\ning side of field.");
static const u8 sFreecastDescriptionExtended[] = _("(Not Implemented)");
static const u8 sStampedeDescriptionExtended[] = _("(Not Implemented)");
static const u8 sSkullbreakerDescriptionExtended[] = _("Moves that make contact used \nby the Pokémon hit targets thr-\nough protection moves, dealing\n25% of the original damage.");
static const u8 sVenomOverdriveDescriptionExtended[] = _("Increases the power of Poison\n-type moves used by the Pokémo-\nn by 50%. If it hits a poisone-\nd target with a damaging move,\nthat target becomes badly poi-\nsoned, or its toxic counter in-\ncreases by 1 if it is already \nbadly poisoned.");
static const u8 sDuneTrapDescriptionExtended[] = _("(Not Implemented)");
static const u8 sSandGliderDescriptionExtended[] = _("The Speed stat of the Pokémon\nis doubled during sandstorm.");
static const u8 sLoverlyFragranceDescriptionExtended[] = _("(Not Implemented)");
static const u8 sDisgustingPollenDescriptionExtended[] = _("While the Pokémon is on the f-\nield, all other Pokémon's Spee-\nd stat is halved, except Grass\n- or Poison-type Pokémon.");
static const u8 sDiamondReflectDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Power Split. Power Split:\naverages the user's Attack an-\nd Special Attack stats with th-\nose of the target Pokémon. Pow-\ner Split will ignore both the \nuser and the target's stat cha-\nnges when calculating the aver-\nage.");
static const u8 sChainReactionDescriptionExtended[] = _("If the Pokémon is hit by a sp-\necial move instead of a physic-\nal move, it still triggers She-\nll Trap but at half power.");
static const u8 sPowerKegDescriptionExtended[] = _("If this Pokémon is hit by a p-\nhysical move, it becomes charg-\ned. The next use of Shell Trap\nconsumes the charge, activate-\ns regardless of being hit, and\nits power is increased by 50%\n.");
static const u8 sSulfurFeedDescriptionExtended[] = _("The Pokémon is immune to Pois-\non-type moves, and the power o-\nf the Pokémon's Fire-type move-\ns are increased by 50% when at-\ntacked by one.");
static const u8 sSmokeSignalDescriptionExtended[] = _("After the Pokémon uses Smokes-\ncreen or Smog, it switches out\n.");
static const u8 sSootVeilDescriptionExtended[] = _("Protects from sandstorm and h-\nailstorm damage, powder and sp-\nore moves, as well as Effect S-\npore, and takes 10% less damag-\ne from special moves.");
static const u8 sReactiveArmorDescriptionExtended[] = _("If an opposing Pokémon lowers\nthis Pokémon's stats, that Po-\nkémon loses 1/4 of its maximum\nHP. This effect does not acti-\nvate if this Pokémon lowers it-\ns own stats or if its stats ar-\ne lowered by an ally.");
static const u8 sSiegePayloadDescriptionExtended[] = _("If the Pokémon uses a damagin-\ng move that would cause it to \nfaint, it instead loses HP equ-\nal to half of its maximum HP.");
static const u8 sLivingMonolithDescriptionExtended[] = _("When this Pokémon uses moves \nwhose power depends on the use-\nr's weight relative to the tar-\nget, such as Heat Crash and He-\navy Slam, those moves always u-\nse their maximum base power (1\n50 - 8x more weight), regardle-\nss of the weight ratio between\nthe user and the target.");
static const u8 sPowerObeliskDescriptionExtended[] = _("The first time this Pokémon e-\nnters the field, its Special A-\nttack and Special Defense are \nmaximized. Each time it is hit\nby a damaging move, its Defen-\nse and Special Defense are low-\nered by one stage.");
static const u8 sStoneSentinelDescriptionExtended[] = _("When an allied Pokémon switch-\nes in, it takes half damage du-\nring its first turn on the fie-\nld.");
static const u8 sRunicStoneDescriptionExtended[] = _("When a stat of the Pokémon is\nlowered by an opponent, its S-\npecial Defense stat is increas-\ned by two stages. It will not \nactivate if the Pokémon with t-\nhis Ability lowers its own sta-\nts (such as with Close Combat)\nor if its stats are lowered b-\ny an ally.");
static const u8 sLovelyFragranceDescriptionExtended[] = _("While the Pokémon is on the f-\nield, all other Pokémon's dama-\nge is reduced by 25%, except G-\nrass-type Pokémon.");
static const u8 sOverclockDescriptionExtended[] = _("When the Pokémon is hit by a \nFire- or Electric-type move, i-\nts Speed stat is increased by \nsix stages.");
static const u8 sFlavorAdaptationDescriptionExtended[] = _("After consuming a berry, chan-\nge the Pokémon's type to that \nberry's type and doubles the d-\namage of the Pokémon's Poison-\ntype moves.");
static const u8 sAwakenedMindDescriptionExtended[] = _("Boosts Special Defense by 50%-\n. In addition, Psychic-type mo-\nves used by the Pokémon can hi-\nt Dark-types.");
static const u8 sSilentFlightDescriptionExtended[] = _("Flying-type moves used by thi-\ns Pokémon have +1 priority on \nthe first turn it is on the fi-\neld.");
static const u8 sTempestWakeDescriptionExtended[] = _("When this Pokémon enters the \nfield for the first time, it t-\nraps opposing Pokémon in a whi-\nrlpool, causing them to take d-\namage each turn and preventing\nthem from switching out.");
static const u8 sLeechSporeDescriptionExtended[] = _("When this Pokémon makes or is\nhit by a contact move, the op-\nposing Pokémon is seeded. A se-\neded Pokémon loses 1/8 of its \nmaximum HP each turn, and the \nuser restores that amount.");
static const u8 sMagmaChamberDescriptionExtended[] = _("(Not Implemented)");
static const u8 sAbyssalWellspringDescriptionExtended[] = _("(Not Implemented)");
static const u8 sFeedingFrenzyDescriptionExtended[] = _("Restores HP equal to 25% of t-\nhe damage dealt to the target.\nThis recovery is doubled if t-\nhe target has less than half o-\nf its maximum HP. The amount r-\nestored is affected by items s-\nuch as Big Root.");
static const u8 sDreadfulSmellDescriptionExtended[] = _("(Not Implemented)");
static const u8 sIronChimeDescriptionExtended[] = _("Reduces the damage received b-\ny allies by 25%.");
static const u8 sImprovisedWeaponGrassDescriptionExtended[] = _("Changes the type of Improvise-\nd Blow used by the Pokémon to \nGrass-type.");
static const u8 sImprovisedWeaponSteelDescriptionExtended[] = _("Changes the type of Improvise-\nd Blow used by the Pokémon to \nSteel-type.");
static const u8 sImprovisedWeaponRockDescriptionExtended[] = _("Changes the type of Improvise-\nd Blow used by the Pokémon to \nRock-type.");
static const u8 sBoneCageDescriptionExtended[] = _("When the Pokémon enters battl-\ne, it receives a 10% additive \nincrease to its defensive stat-\ns for each ally Pokémon that i-\ns fainted in its party.");
static const u8 sSovereignCrestDescriptionExtended[] = _("The Pokémon takes less damage\nfrom moves, the higher the Po-\nkémon's base Attack stat is th-\nan the attacker. It cannot red-\nuce the incoming damage more t-\nhan 33%. It doesn't affect opp-\nosing Pokémon that is stronger\nthan the Pokémon.");
static const u8 sOilyCarapaceDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a Ground-type mo-\nve, its Defense and Special De-\nfense stats are increased by o-\nne stage.");
static const u8 sPowerOverflowDescriptionExtended[] = _("Moves that depend on the curr-\nent HP always have its maximum\npower. Moves: Eruption, Water\nSpout, Dragon energy, Massive\nBloom.");
static const u8 sMegaSolDescriptionExtended[] = _("All moves used by the Pokémon\nbehave as though the weather \nwere harsh sunlight, regardles-\ns of the actual weather on the\nfield. Harsh Sunlight: Boosts\nFire-type moves by 50% and we-\nakens Water-type moves by 50%,\nSolar Beam and Solar Blade be-\ncome one-turn moves, Growth ha-\nve its effect doubled, Synthes-\nis restore more HP.");
static const u8 sPiercingDrillDescriptionExtended[] = _("Moves that make contact used \nby the Pokémon hit targets thr-\nough protection moves, dealing\n25% of the original damage.");
static const u8 sSpicySprayDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a move, the oppo-\nsing Pokémon will become burne-\nd.");
static const u8 sEelevateDescriptionExtended[] = _("The Pokémon is immune to dama-\nging Ground-type moves. Also, \nboosts the Pokémon's highest s-\ntat by one stage each time the\nPokémon knocks out another Po-\nkémon with a damage-dealing mo-\nve.");
static const u8 sFireManeDescriptionExtended[] = _("Increases the power of Fire-t-\nype moves used by the Pokémon \nby 50%.");
static const u8 sStormWingsDescriptionExtended[] = _("(Not Implemented)");
static const u8 sSkitterizeDescriptionExtended[] = _("All Normal-type moves used by\nthe Pokémon become Bug-type a-\nnd receive a 20% power boost.");
static const u8 sAdrenalineSurgeDescriptionExtended[] = _("When the Pokémon directly cau-\nses another Pokémon (including\nallies) to faint by using a d-\namaging move, its Speed stat i-\ns increased by one stage.");
static const u8 sPhantomStarFistDescriptionExtended[] = _("Punching moves used by the Po-\nkémon hit targets through prot-\nection moves, dealing 25% of t-\nhe original damage. Special Te-\nchnique: Shadow Punch will lif-\nt the effects of Protect like \nmoves from the target for the \nremainder of the turn, and rem-\nove Reflect, Light Screen, Aur-\nora Veil, Fire Wall and Stone \nWall from their side of the fi-\neld.");
...
static const u8 sEverburnSpearDescriptionExtended[] = _("If the Pokémon uses a contact\nmove, it will not activate an-\ny effects caused by contact, a-\nlso the opposing Pokémon will \nbecome burned. ");
static const u8 sHydrenchymaDescriptionExtended[] = _("Adds the Water-type to the Po-\nkémon, in addition to the Poké-\nmon's original type(s) and mov-\nes that would be “supereffecti-\nve” against pure Water-type Po-\nkémon will be only normally ef-\nfective instead.");
static const u8 sNightSynthesisDescriptionExtended[] = _("The Pokémon also behave as th-\nough the weather were harsh su-\nnlight while under gloom moonl-\night. Harsh Sunlight: Boosts F-\nire-type moves by 50% and weak-\nens Water-type moves by 50%, S-\nolar Beam and Solar Blade beco-\nme one-turn moves, Growth have\nits effect doubled, Synthesis\nrestore more HP.");
static const u8 sWaxyGuardDescriptionExtended[] = _("This Pokémon's Defense is dou-\nbled. When hit by a Fire-type \nmove, it takes no damage, but \nthis Ability is disabled for t-\nhe remainder of the battle.");
static const u8 sNeedleSkinDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a move that make-\ns contact, the opposing Pokémo-\nn takes damage equal to 1/8 of\nits maximum HP. ");
static const u8 sMasterPugilistDescriptionExtended[] = _("Punching moves used by the Po-\nkémon will gain same-type atta-\nck bonus regarless its type.");
static const u8 sTheWayOfTheKickDescriptionExtended[] = _("Boosts the Pokémon's Attack b-\ny 50%, but limits the Pokémon \nto using only one move. “I fea-\nr not the man who has practice-\nd 10.000 kicks once, but I fea-\nr the man who has practiced on-\ne kick 10.000 times”.");
static const u8 sMartialProdigyDescriptionExtended[] = _("The power of punching and kic-\nking moves used by the Pokémon\nare increased by 10%.");
...
static const u8 sSweetGaugeDescriptionExtended[] = _("All healing effects on the Po-\nkémon are increased by 50%.");
static const u8 sBoozeRemedyDescriptionExtended[] = _("If the Pokémon is poisoned or\nbadly poisoned, its HP is res-\ntored by 1/8 of its maximum HP\nat the end of each turn inste-\nad of taking damage. Black Slu-\ndge heals the Pokémon even if \nit isn't Poison-type. The Poké-\nmon doesn't take poison damage\noutside of battle.");
static const u8 sDesertFlowerDescriptionExtended[] = _("The Pokémon also behave as th-\nough the weather were raining \nwhile under harsh sunlight or \non sandy terrain. Rain: Boosts\nWater-type moves by 50% and w-\neakens the power of Fire-type \nmoves by 50%, Thunder and Hurr-\nicane ignore Accuracy and Evas-\nion checks.");
static const u8 sScarecrowVigilDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it lowers the Attack and\nSpecial Attack stats of all o-\npposing Pokémon by one stage. \nIf the Pokémon is in the first\nplace in the party (even if f-\nainted), there is a 50% chance\nit will prevent a random wild\nencounter that would have occ-\nurred if the wild Pokémon woul-\nd be at least 5 levels lower.");
static const u8 sHeavySleeperDescriptionExtended[] = _("While the Pokémon is asleep, \nits Defense and Special Defens-\ne stats are increased by 50%.");
static const u8 sDeepSlumberDescriptionExtended[] = _("If the Pokémon is asleep, res-\ntores the Pokémon's HP by 1/4 \nof its maximum HP.");
static const u8 sLogLauncherDescriptionExtended[] = _("Physical moves used by the Po-\nkémon do not trigger contact-b-\nased effects, but their effect-\ns are completely ignored.");
static const u8 sLumberPillowDescriptionExtended[] = _("When the Pokémon attacks with\na physical move, there is a 3\n0% chance the target will beco-\nme asleep.");
static const u8 sAllJustADreamDescriptionExtended[] = _("If the Pokémon would faint fr-\nom a damaging move, it restore-\ns its HP to full instead.");
static const u8 sTrainingGroundDescriptionExtended[] = _("The Pokémon removes all entry\nhazards in battle as soon as \nthe Pokémon enters the battlef-\nield, clearing those entry haz-\nards from your side of field a-\nnd increasing Attack stat stag-\ne by one for each of entry haz-\nards removed.");
static const u8 sGrappleGuardDescriptionExtended[] = _("Moves that make contact infli-\nct the target with Grappled an-\nd lower its Speed by 1 stage. \nGrappled: Neither Pokémon can \nswitch out. The user takes 33%\nless damage from the grappled\ntarget, and its next throwing\nmove against that target deal-\ns double damage, then removes \nthe status. (not implemented)");
static const u8 sThreadlockDescriptionExtended[] = _("When the Pokémon is hit by an\nattack, raises its Defense an-\nd Special Defense stats stages\nby the number of the attacker-\n's lowered Speed stat stages d-\nuring damage calculation only,\nup to +6.");
static const u8 sTrapTerritoryDescriptionExtended[] = _("The Speed stat of the Pokémon\nis doubled while there are an-\ny entry hazard on your side of\nfield. The Pokémon is unaffec-\nted by the effects of entry ha-\nzards.");
static const u8 sSilkenAmbushDescriptionExtended[] = _("When the Pokémon attacks, rai-\nses its Attack and Special Att-\nack stats stages by the number\nof the target's lowered Speed\nstat stages during damage cal-\nculation only, up to +6.");
static const u8 sElectrifiedWireDescriptionExtended[] = _("While the Pokémon is on the f-\nield, opposing Pokémon take da-\nmage when switching in. The da-\nmage is based on Electric-type\neffectiveness against the tar-\nget, starting at 1/8 of its ma-\nximum HP at normal effectivene-\nss.");
static const u8 sRogueTacticsDescriptionExtended[] = _("Thief gains priority +1 if us-\ned against an opposing Pokémon\nthat is holding an item. Mud-\nSlap's base power becomes 100.\nSmackdown always makes the op-\nposing Pokémon fall into the g-\nround, taking an additional 1/-\n8 of their maximum HP.");
static const u8 sDirtyFightingDescriptionExtended[] = _("Increases the power of Dark-t-\nype moves used by the Pokémon \nby 50%. Also, when the Pokémon\nattacks with a move that make-\ns contact, there is a 30% chan-\nce that the opposing Pokémon w-\nill become poisoned. ");
static const u8 sPoisonousNestDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Sticky Web on both side o-\nf field and Toxic Spikes on th-\ne opposing side of field. Stic-\nky Web: lowers the Speed stat \nby one stage and make them gro-\nunded upon switching in, excep-\nt Bug-type Pokémon. Toxic Spik-\nes: the Pokémon becomes poison-\ned.");
...
static const u8 sThirdEyeDescriptionExtended[] = _("Boosts the power of the Pokém-\non's Psychic-type moves by 50%\n.");
static const u8 sPsionizeDescriptionExtended[] = _("All Normal-type moves used by\nthe Pokémon become Psychic-ty-\npe and receive a 20% power boo-\nst.");
static const u8 sScryDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Future Sight against oppo-\nsing side of field.");
static const u8 sWishUponAStarDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Wish. Also, prevents Fall-\ning Stars from targeting the P-\nokémon's side of field.");
static const u8 sOraclesProphecyDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Doom Desire against oppos-\ning side of field.");
static const u8 sStarlightVeilDescriptionExtended[] = _("The Pokémon is unaffected by \nother Pokémon's status moves. \nIt does not block status moves\nthat target the user, the fie-\nld, or all Pokémon. It does, h-\nowever, block potentially bene-\nfical status moves from ally P-\nokémon, such as Helping Hand, \nLife Dew, and Howl.");
static const u8 sMilleniumCometDescriptionExtended[] = _("The Pokémon is immune to Fire\n-type moves, cannot be burned \nand is unaffected by Burning T-\nerrain.");
static const u8 sSixthSenseDescriptionExtended[] = _("Increases the priority of Psy-\nchic-type moves by one when at\nmaximum HP.");
static const u8 sHealingFactorDescriptionExtended[] = _("The Pokémon restores 1/16 of \nits maximum HP at the end of e-\nach turn.");
static const u8 sWaterloggingDescriptionExtended[] = _("When the Pokémon uses a Water\n-type move, the target becomes\npure Water-type.");
static const u8 sBattleAuraDescriptionExtended[] = _("Increases the Attack, Defense\nand Speed stats of the Pokémo-\nn equal to 10% of their Specia-\nl Attack stat. The Special Att-\nack stat stages, items and abi-\nlities still affect this perce-\nntage.");
static const u8 sTerraformDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it creates a terrain if \nit has Grassy, Misty, Electric\n, Psychic, Frozen, Cursed, Rav-\nine, Burning, Sandy, Swamp, Ve-\nnomous, Pollination, Colosseum\nor Draconic Terrain in the mo-\nvepool (if any, prioritizing t-\nhe first move with PPs in the \nmovepool and costing one PP fr-\nom that move). (not implemente-\nd)");
static const u8 sFirstStrikeDescriptionExtended[] = _("Increases the priority of Fig-\nhting-type moves by one when t-\nhe Pokémon is at maximum HP.");
static const u8 sDoubleStrikeDescriptionExtended[] = _("Fighting-type moves hit twice\nwhen the Pokémon is at maximu-\nm HP.");
static const u8 sHasteDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it uses a typeless move \nwith 20 Base Power against the\nopposing Pokémon. It is physi-\ncal or special move depending \non the highest offensive stat.\n(not implemented)");
static const u8 sLifelinkDescriptionExtended[] = _("Restores HP equal to 1/8 of t-\nhe damage dealt to the target.\nThe amount restored is affect-\ned by items such as Big Root.");
static const u8 sReachDescriptionExtended[] = _("Grass-, Fighting or Bug-type \nPokémon takes neutral damage f-\nrom Flying-type moves.");
static const u8 sTrampleDescriptionExtended[] = _("Any exceeded damage dealt by \nthe Pokémon against an opposin-\ng Pokémon is dealt to the next\nPokémon upon switch in.");
static const u8 sDeathtouchDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a move that make-\ns contact, the opposing Pokémo-\nn takes damage equal to 1/8 of\nits maximum HP. ");
static const u8 sCryostasisDescriptionExtended[] = _("When a Pokémon with this Abil-\nity faints due to damage from \na move that makes contact, the\nattacking Pokémon becomes fro-\nzen.");
static const u8 sGeneralistDescriptionExtended[] = _("All non-STAB moves used by th-\ne Pokémon have their power inc-\nreased by 25%.");
static const u8 sHexproofDescriptionExtended[] = _("The Pokémon is unaffected by \nthe additional effects of dama-\nging moves and takes 25% less \ndamage from moves that don't m-\nake contact.");
static const u8 sHerdLeaderDescriptionExtended[] = _("(Not Implemented)");
static const u8 sMenaceDescriptionExtended[] = _("The Pokémon's moves that hit \nmore than one Pokémon on the f-\nield don't get the 25% of pena-\nlty in Double Battles.");
static const u8 sPlaneswalkerDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nvanishes, avoinding any entry \nhazard and attacks. After the \nPokémon uses any move, it will\nreappear.");
static const u8 sVigilanceDescriptionExtended[] = _("If the Pokémon executes its m-\nove before all other Pokémon, \nthe damage taken by the Pokémo-\nn is reduced by 30%. Also, the\nPokémon may execute its move \neven while asleep.");
static const u8 sHypnoticGazeDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nconfuses the opposing Pokémon.\n(not implemented)");
static const u8 sIndomitableDescriptionExtended[] = _("The Pokémon is immune to stat\nstages reduction, including s-\nelf-inflicted stat stages redu-\nction.");
static const u8 sNightstalkerDescriptionExtended[] = _("Increases the priority of Dar-\nk-type moves by one when the P-\nokémon is at maximum HP.");
static const u8 sVengefulSpiritDescriptionExtended[] = _("Doubles the power of moves us-\ned by the Pokémon if a Pokémon\nfrom the user's party has fai-\nnted in the previous turn. (no-\nt implemented)");
static const u8 sSpiritualOfferingsDescriptionExtended[] = _("The Pokémon is immune to Ghos-\nt-type moves, and its HP is re-\nstored by 25% of its maximum H-\nP when attacked by one.");
static const u8 sChargeUpDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \ncharges up. Charge: Increases \nthe Special Defense and Speed \nstats by one stage and doubles\nthe power of the next Electri-\nc-type move.");
static const u8 sBattleTranceDescriptionExtended[] = _("Increases the Attack stat by \n50% of the Pokémon while confu-\nsed. The move can still fail d-\nue confusion but the Pokémon t-\nakes no damage. (not implement-\ned)");
static const u8 sLoveSerenadeDescriptionExtended[] = _("When the Pokémon faints, the \nnext Pokémon has its HP fully \nrestored and it is cured of an-\ny status conditions upon being\nsent out.");
static const u8 sLostTechnologyDescriptionExtended[] = _("Suppresses the effect of all \nitems held by the Pokémon on t-\nhe field for five turns in bat-\ntle as soon as the Pokémon ent-\ners the battlefield. (not impl-\nemented)");
static const u8 sClayVesselDescriptionExtended[] = _("The Pokémon's HP is restored \nby 1/8 of its maximum HP at th-\ne end of each turn during a sa-\nndstorm.");
static const u8 sAnimatedConstructDescriptionExtended[] = _("The Pokémon is unaffected by \nother Pokémon's status moves. \nIt does not block status moves\nthat target the user, the fie-\nld, or all Pokémon. It does, h-\nowever, block potentially bene-\nfical status moves from ally P-\nokémon, such as Helping Hand, \nLife Dew, and Howl.");
static const u8 sOceansCovenantDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Aqua Ring. Aqua Ring: At \nthe end of the turn, it restor-\nes 1/16 of its maximum HP and \nheals burn. Also, it halves th-\ne damage taken from Electric-t-\nype moves.");
static const u8 sDarkBribeDescriptionExtended[] = _("During a gloom moonlight, the\nPokémon's HP is restored by 1\n/8 of its maximum HP at the en-\nd of each turn.");
static const u8 sRevenantCoralDescriptionExtended[] = _("This Pokémon's Water- and Roc-\nk-type moves receive STAB rega-\nrdless of its typing.");
static const u8 sCoralBleachingDescriptionExtended[] = _("When the Pokémon is hit by a \nFire-type move, its Special De-\nfense rises by two stages. No \nimmunity is granted to Fire-ty-\npe moves, however.");
static const u8 sZooxanthellaeDescriptionExtended[] = _("Adds the Grass-type to the Po-\nkémon, in addition to the Poké-\nmon's original type(s) and mov-\nes that would be “supereffecti-\nve” against pure Grass-type Po-\nkémon will be only normally ef-\nfective instead.");
static const u8 sDinoflagellateDescriptionExtended[] = _("When the Pokémon enters the b-\nattle, it creates the effect o-\nf the move Venomous Terrain on\nthe battlefield for five turn-\ns. Also, adds the Poison-type \nto the Pokémon, in addition to\nthe Pokémon's original type(s-\n) and moves that would be “sup-\nereffective” against pure Pois-\non-type Pokémon will be only n-\normally effective instead.");
static const u8 sAlgalShieldDescriptionExtended[] = _("The Pokémon is immune to Gras-\ns-type moves, and increases th-\ne Special Defense stat by one \nstage when attacked by one. Al-\nso, forces all single-target G-\nrass-type moves to target the \nPokémon. (not implemented)");
static const u8 sBarrierReefDescriptionExtended[] = _("All Water-type Pokémon on the\nfield takes 25% less damage. \nThis effect doesn't stack.");
static const u8 sMutualismDescriptionExtended[] = _("Corsola lives in a mutualisti-\nc relationship with a Skrelp. \nThe Skrelp assists Corsola wit-\nh Water Gun, Acid, or Dragon P-\nulse. If Corsola faints, the S-\nkrelp takes its place in battl-\ne.");
static const u8 sUntappedPotencialDescriptionExtended[] = _("Increases the priority of Pun-\nching and Kicking moves by one\nwhen the Pokémon is at maximu-\nm HP.");
static const u8 sLittleChampionDescriptionExtended[] = _("All Punching and Kicking move-\ns have their accuracy increase-\nd by 30%.");
static const u8 sUnstableCoreDescriptionExtended[] = _("When the Pokémon faints, it u-\nses Self-Destruct that hits al-\nl other Pokémon on the field.");
static const u8 sBerryBulkDescriptionExtended[] = _("Increases the Defense and Spe-\ncial Defense stats by one stag-\ne when it consumes a Berry.");
static const u8 sDebilitateDescriptionExtended[] = _("When the Pokémon inflicts a s-\ntatus condition to an opposing\nPokémon, lowers that Pokémon'-\ns Attack, Special Attack and S-\npeed stats by one stage.");
static const u8 sPolarCurrentDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons hailstorm for\nfive turns that boosts the it-\ns highest offensive stat by 33\n%. Hail: Any Pokémon that is n-\not Ice-type will be damaged fo-\nr 1/16 of its maximum HP, Defe-\nnse of Ice-type Pokémon is inc-\nreased by 50%, Blizzard ignore-\ns Accuracy and Evasion checks \nand allows Aurora Veil usage.");
static const u8 sKillerWhaleDescriptionExtended[] = _("Sound-based moves used by the\nPokémon will deal “supereffec-\ntive” damage against Water-typ-\ne.");
static const u8 sEcholocationDescriptionExtended[] = _("Increases the Accuracy of mov-\nes used by the Pokémon by 30%.\nIf the Pokémon is in the firs-\nt place in the part (even if f-\nainted), the chance of encount-\nering a wild Pokémon holding a-\nn item increases from 50%/5% t-\no 60%/20%.");
static const u8 sFirebrandDescriptionExtended[] = _("When the Pokémon attacks with\nFire-type move, the opposing \nPokémon takes damage equal to \n1/16 of its maximum HP and wil-\nl always deal “supereffective”\ndamage against Fire-type Poke-\nmon. The Pokémon can burn Fire\n-type Pokémon. ");
static const u8 sMasterFencerDescriptionExtended[] = _("Air Cutter has increased prio-\nrity +1. Fury Cutter always ha-\ns its maximum stacks. Cut's ba-\nse power is doubled and ignore-\ns target's abilities. Leaf Bla-\nde restores 50% of the damage \ndealt. Night Slash hits even i-\nf target switches out.");
static const u8 sEnGardeDescriptionExtended[] = _(" If the Pokémon executes its \nmove after all other Pokémon h-\nave made their move, the damag-\ne taken is reduced by 50 %.");
static const u8 sRuthlessPredatorDescriptionExtended[] = _("Moves that inflicts more dama-\nge against foes with less than\nhalf HP or has a status condi-\ntion always meet their conditi-\non. Moves: Assurance, Brine, V-\nenomshock, Hex, Barb Barrage, \nInfernal Parade, Wake-Up Slap,\nSmelling Salts.");
static const u8 sReignOfAngerDescriptionExtended[] = _("(Not Implemented)");
static const u8 sReindeerRiderDescriptionExtended[] = _("When a Delibird with Reindeer\nRider is on the same side of \nthe field as a Wyrdeer, it wil-\nl mount that Pokémon's saddle \nand the Wyrdeer will have its \nAttack, Defense, Special Attac-\nk, Special Defense, and Speed \nstats raised by two stages eac-\nh. While Delibird is on Wyrdee-\nr's back, the latter will be u-\nnable to switch out and cannot\nbe forced out.");
static const u8 sDeflectorHullDescriptionExtended[] = _("The Pokémon uses 50% of its D-\nefense stat against special mo-\nves in addition to the default\nstat during the damage calcul-\nation. The Defense stat stages\n, items and abilities still af-\nfect this percentage.");
static const u8 sLurkingMenaceDescriptionExtended[] = _("Increases the priority of dam-\naging move by +1 when opposing\nPokémon has a status conditio-\nn or its HP is below half. Oth-\nerwise, it decreases the prior-\nity of damaging move by -1. It\nworks only with single-target\ndamaging moves in double batt-\nles.");
static const u8 sLostKnowledgeDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nreduces the PPs of two random \nmoves from opposing Pokémon to\n0.");
static const u8 sClearMindedDescriptionExtended[] = _("The Pokémon is immune to Psyc-\nhic-type moves, and its HP is \nrestored by 25% of its maximum\nHP when attacked by one.");
static const u8 sMadnessMindDescriptionExtended[] = _("(Not Implemented)");
static const u8 sSubjugateDescriptionExtended[] = _("When the Pokémon lowers the s-\ntat stage of an opposing Pokém-\non, increases the Pokémon's st-\nat stage by the same amount.");
static const u8 sGeneticModifiedSDescriptionExtended[] = _("Increases all stats of the Po-\nkémon by 50%. Also, restores 1\n/4 of its maximum HP at the en-\nd of each turn.");
static const u8 sGeneticModifiedADescriptionExtended[] = _("Increases all stats of the Po-\nkémon by 40%. Also, restores 1\n/8 of its maximum HP at the en-\nd of each turn.");
static const u8 sGeneticModifiedBDescriptionExtended[] = _("Increases all stats of the Po-\nkémon by 30%. Also, restores 1\n/8 of its maximum HP at the en-\nd of each turn.");
static const u8 sGeneticModifiedCDescriptionExtended[] = _("Increases all stats of the Po-\nkémon by 20%. Also, restores 1\n/16 of its maximum HP at the e-\nnd of each turn.");
static const u8 sGeneticModifiedDDescriptionExtended[] = _("Increases all stats of the Po-\nkémon by 10%. Also, restores 1\n/16 of its maximum HP at the e-\nnd of each turn.");
static const u8 sHomunculusDescriptionExtended[] = _("Increases all stats of the Po-\nkémon by 30%. Also, restores 1\n/8 of its maximum HP at the en-\nd of each turn. “This is an ar-\ntificial Pokémon created in la-\nboratory”");
static const u8 sHawkEyeDescriptionExtended[] = _("Increases the Accuracy of mov-\nes used by the Pokémon by 30%.\nIf the Pokémon is in the firs-\nt place in the part (even if f-\nainted), the chance of encount-\nering a wild Pokémon holding a-\nn item increases from 50%/5% t-\no 60%/20%.");
static const u8 sVultureEyeDescriptionExtended[] = _("Increases the Pokémon's damag-\ne by 50% when opposing Pokémon\nhas a status condition or its\nHP is below half.");
static const u8 sFalconEyeDescriptionExtended[] = _("Doubles the damage done by an-\ny moves that the Pokémon uses \nwhich are “not very effective”\n.");
static const u8 sOwlEyeDescriptionExtended[] = _("Blocks moves that target more\nthan one Pokémon on the field-\n. This ability is not activate-\nd if the Pokémon is the only t-\narget.");
static const u8 sEagleEyeDescriptionExtended[] = _("Increases the critical hit ra-\ntio by 1 stage. If the Pokémon\nleads the party (even if fain-\nted), the chances of finding a\nwild Pokémon holding an item \nincrease from 50%/5% to 60%/20\n%.");
static const u8 sBugColonyDescriptionExtended[] = _("Increases the Pokémon's Defen-\nse and Special Defense stats b-\ny 20% for each Bug-type Pokémo-\nn in your party, excluding its-\nelf.");
static const u8 sWardingBellsDescriptionExtended[] = _("The Pokémon and its ally are \nunaffected by other Pokémon's \nstatus moves. It does not bloc-\nk status moves that target the\nuser, the field, or all Pokém-\non. It does, however, block po-\ntentially benefical status mov-\nes from ally Pokémon, such as \nHelping Hand, Life Dew, and Ho-\nwl.");
static const u8 sBeeQueenDescriptionExtended[] = _("Increases the damage of Attac-\nk Order and the healing of Hea-\nl Order by 50%. Also, Defend O-\nrder increases all stats by on-\ne stage instead.");
static const u8 sMastermindDescriptionExtended[] = _("Doubles the power of Psychic-\ntype moves used by the Pokémon\n.");
static const u8 sMesmerizeDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a move that make-\ns contact, there is a 30% chan-\nce that the opposing Pokémon w-\nill become asleep.");
static const u8 sWarDrumsDescriptionExtended[] = _("Sound-based moves used by the\nPokémon deal physical damage \nregardless.");
static const u8 sToxicDustDescriptionExtended[] = _("When the Pokémon would be att-\nacked by a move that makes con-\ntact, the Pokémon preemptively\nreleases a poison powder on t-\nhe attacking Pokémon that chan-\nges that Pokémon's type to pur-\ne Poison-type.");
static const u8 sBubbleMaskDescriptionExtended[] = _("(Not Implemented)");
static const u8 sTimeSkipDescriptionExtended[] = _("While the Pokémon is on the f-\nield, all effects that happen \nin the end of each turn are no-\nt applied. This ability negate-\ns the effect of Rewind ability\n.");
static const u8 sViralBoostDescriptionExtended[] = _("(Not Implemented) The Pokémon\nrestores 1/8 of its maximum H-\nP at the end of each turn.");
static const u8 sFertilizerDescriptionExtended[] = _("While Grassy Terrain is activ-\ne, all Grass-type Pokémon's mo-\nves on the field also behave a-\ns though the weather were hars-\nh sunlight.");
static const u8 sMegamorphosisDescriptionExtended[] = _("(Not Implemented)");
static const u8 sArchmorphosisDescriptionExtended[] = _("Swaps the Pokémon's base HP a-\nnd base Speed, then increases \nboth stats by 20. Swaps the Po-\nkémon's base Attack and base S-\npecial Attack, then increases \nboth stats by 15. Swaps the Po-\nkémon's base Defense and base \nSpecial Defense, then increase-\ns both stats by 15.");
static const u8 sProboscisDescriptionExtended[] = _("Increases the healing of drai-\nning moves used by the Pokémon\nby 50%.");
static const u8 sMycelialNetworkDescriptionExtended[] = _("Increases the power of draini-\nng moves used by the Pokémon b-\ny 50%.");
static const u8 sFloressenceDescriptionExtended[] = _("Increases the priority of Gra-\nss-type moves by one when at m-\naximum HP.");
static const u8 sPoseidonGuardDescriptionExtended[] = _("The Pokémon takes less 25% da-\nmage from “supereffective” mov-\nes.");
static const u8 sVerdantOvergrowDescriptionExtended[] = _("Frenzy Plant used by the Poké-\nmon doesn't need recharge.");
static const u8 sInfernoBlazeDescriptionExtended[] = _("Blast Burn used by the Pokémo-\nn doesn't need recharge.");
static const u8 sRagingTorrentDescriptionExtended[] = _("Hydro Cannon used by the Poké-\nmon doesn't need recharge.");
static const u8 sFishHarpoonDescriptionExtended[] = _("Horn moves used by the Pokémo-\nn deal “supereffective” agains-\nt Water-type Pokémon.");
static const u8 sGoremasterDescriptionExtended[] = _("Boosts the strength of horn m-\noves  and High Horsepower used\nby the Pokémon by 50%.");
static const u8 sWildStallionDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nbecomes the herd leader. As th-\ne leader, for each equine-like\nPokémon in the Trainer's part-\ny, increase the Pokémon's stat-\ns by 5%. These stats increase \nfurther by 5% if the Pokémon i-\ns the only male or female in t-\nhe herd. There can be only one\nleader in the party. Otherwis-\ne, works like Gallop Herd abil");
static const u8 sGallopHerdDescriptionExtended[] = _("The Pokémon's stats are incre-\nased by 2% for each equine-lik-\ne Pokémon in the Trainer's par-\nty. These stats increase furth-\ner by 2% if there is a herd le-\nader in the party.");
static const u8 sGillFilterDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a Water-type mov-\ne, its Defense and Special Def-\nense stats are increased by on-\ne stage.");
static const u8 sBranchialShieldDescriptionExtended[] = _("Boosts the Pokémon's Defense \nstat by 50% on Swampy Terrain.\n");
static const u8 sRelentlessFistDescriptionExtended[] = _("Each time the Pokémon hits wi-\nth the same punching move cons-\necutively, that move's damage \nincreases by 25%, up to 100%. \nSpecial Technique: Swarm Punch\n, Arm Thrust and Comet Punch a-\nlways hit 5 times.");
static const u8 sBrawlerFistDescriptionExtended[] = _("Punching moves deal up to 33%\nmore damage against lighter t-\nargets. This effect does not a-\npply to heavier targets. Speci-\nal Technique: Mega Punch deals\n50% more damage.");
static const u8 sGentleFistDescriptionExtended[] = _("When the Pokémon attacks with\npunching moves, the opposing \nPokémon takes damage equal to \n1/16 of its maximum HP, also t-\nhere is a 30% chance that the \nopposing Pokémon will become p-\naralized. Special Technique: D-\nrain Punch restores 50% more H-\nP.");
static const u8 sComboFistDescriptionExtended[] = _("Punching moves hit twice, but\neach hit deals only 60% of th-\ne damage. Special Technique: D-\nragon Combo consumes no HP whe-\nn used.");
static const u8 sPhytoparasiteDescriptionExtended[] = _("Powder and spore moves and Le-\nech Seed bypass the Grass-type\nimmunity.");
static const u8 sDandelionDriftDescriptionExtended[] = _("(Not Implemented)");
static const u8 sCottonCushionDescriptionExtended[] = _("The Pokémon takes less 25% da-\nmage from “supereffective” mov-\nes.");
static const u8 sSeedScatterDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Leech Seed. A seeded Poké-\nmon loses 1/8 of its maximum H-\nP each turn, and the user rest-\nores that amount.");
static const u8 sCrazyVinesDescriptionExtended[] = _("When the Pokémon attacks or i-\ns attacked by a Grass-type mov-\ne, its Defense and Special Def-\nense stats are increased by on-\ne stage.");
static const u8 sYokaiDescriptionExtended[] = _("Adds the Ghost-type to the Po-\nkémon, in addition to the Poké-\nmon's original type(s) and mov-\nes that would be “supereffecti-\nve” against pure Ghost-type Po-\nkémon will be only normally ef-\nfective instead.");
static const u8 sOniDescriptionExtended[] = _("Adds the Dark-type to the Pok-\némon, in addition to the Pokém-\non's original type(s) and move-\ns that would be “supereffectiv-\ne” against pure Dark-type Poké-\nmon will be only normally effe-\nctive instead.");
static const u8 sMonkeyKingDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nbecomes the primate leader. As\nthe leader, for each primate-\nlike Pokémon in the Trainer's \nparty, increase the Pokémon's \nstats by 5%. These stats incre-\nase further by 5% if the Pokém-\non is the only male or female \nin the troop. There can be onl-\ny one leader in the party. Oth-\nerwise, works like Primate Tro");
static const u8 sPrimateTroopDescriptionExtended[] = _("The Pokémon's stats are incre-\nased by 2% for each primate-li-\nke Pokémon in the Trainer's pa-\nrty. These stats increase furt-\nher by 2% if there is a troop \nleader in the party.");
static const u8 sStringVeilDescriptionExtended[] = _("(Not Implemented)");
static const u8 sUltraSpacianDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield whil-\ne in the Ultra Space, increase-\ns its highest stat by one stag-\ne. If the Pokémon is a Necrozm-\na, increases all stats stages \ninstead.");
static const u8 sRocketBoostersDescriptionExtended[] = _("Boosts the power of Fire-type\nmoves used by the Pokémon by \n50%. Also, after using a Fire-\ntype move, the next move that \nmakes contact gains priority +-\n1.");
static const u8 sPowderDustDescriptionExtended[] = _("When the Pokémon would be att-\nacked by a move that makes con-\ntact, the Pokémon preemptively\nreleases a powder on the atta-\ncking Pokémon. If that attacki-\nng Pokémon attempts to use a F-\nire-type move, they take damag-\ne equal to 25% of their maximu-\nm HP and cannot execute the mo-\nve.");
static const u8 sIcebreakerDescriptionExtended[] = _("When the Pokémon attacks with\nIce-type move, the opposing P-\nokémon takes damage equal to 1\n/16 of its maximum HP and will\nalways deal “supereffective” \ndamage against Ice-type Pokemo-\nn. The Pokémon can inflict fro-\nstbite on Ice-type Pokémon. ");
static const u8 sDragonbornDescriptionExtended[] = _("Adds the Dragon-type to the P-\nokémon, in addition to the Pok-\némon's original type(s) and mo-\nves that would be “supereffect-\nive” against pure Dragon-type \nPokémon will be only normally \neffective instead.");
static const u8 sEarthwormDescriptionExtended[] = _("Adds the Ground-type to the P-\nokémon, in addition to the Pok-\némon's original type(s) and mo-\nves that would be “supereffect-\nive” against pure Ground-type \nPokémon will be only normally \neffective instead.");
static const u8 sWeaponBondDescriptionExtended[] = _("The Pokémon's held items cann-\not be stolen by Covet, Thief, \nPickpocket, or Magician; eaten\nby Bug Bite or Pluck; destroy-\ned by Incinerate; or removed b-\ny Knock Off. If the Pokémon is\nin first place in the player'-\ns party (even if fainted), bit-\nes will occur more often while\nfishing.");
static const u8 sEldritchStrikeDescriptionExtended[] = _("(Not Implemented)");
static const u8 sSharedBulwarkDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Guard Split. Guard Split:\naverages the user's Defense a-\nnd Special Defense stats with \nthose of the target Pokémon. G-\nuard Split will ignore both th-\ne user and the target's stat c-\nhanges when calculating the av-\nerage.");
static const u8 sRadiantCrystalDescriptionExtended[] = _("During harsh sunlight, the Po-\nkémon's Special Defense stat i-\ns increased by 50%.");
static const u8 sPrismaticCoreDescriptionExtended[] = _("The Pokémon uses its Special \nDefense stat during damage cal-\nculation of special moves inst-\nead of its Special Attack. The\nSpecial Defense stat stages-m-\nodifiers, items and other abil-\nities are applied to the stat \ncalculation.");
static const u8 sRenewingSpinesDescriptionExtended[] = _("When the Pokémon is attacked \nby a move that makes contact, \nthe Pokémon restores 1/8 of it-\ns maximum HP.");
static const u8 sAdamantineClawsDescriptionExtended[] = _("When the Pokémon attacks with\na move that makes contact, th-\ne effects of all ignorable abi-\nlities (i.e. abilities that co-\nuld potentially negatively aff-\nect the success, damage, or ef-\nfects of a move if possessed b-\ny the target of a move or its \nallies) are ignored for the ex-\necution of that move and its p-\nower is increased by 30%.");
static const u8 sCriticalMassDescriptionExtended[] = _("While the Pokémon is below 25\n% of its maximum HP, the damag-\ne of self-destruct moves are d-\noubled.");
static const u8 sPerfectMimicDescriptionExtended[] = _("A copied move by the Pokémon'-\ns Mimic has its power increase-\nd by 50% and bypass accuracy c-\nheck.");
static const u8 sCoalIgnitionDescriptionExtended[] = _("When the Pokémon is hit by a \nFire-type move, its Special De-\nfense rises by two stages. No \nimmunity is granted to Fire-ty-\npe moves, however.");
static const u8 sWarPriestDescriptionExtended[] = _("Switches the Pokémon's base A-\nttack and Defense stats with b-\nase Special Attack and base Sp-\necial Defense, respectively.");
static const u8 sSnakeEyeDescriptionExtended[] = _("Increases the Accuracy of mov-\nes used by the Pokémon by 10% \nand increases the critical hit\nratio by 1 stage.");
static const u8 sPhotosynthesisDescriptionExtended[] = _("The Pokémon's HP is restored \nby 1/8 of its maximum HP at th-\ne end of each turn during hars-\nhy sunlight.");
static const u8 sMasterChefDescriptionExtended[] = _("Increases the power and heali-\nng of food-based moves by 50%.");
static const u8 sOmeleteMakerDescriptionExtended[] = _("The Pokémon is immune to food\n-based moves, and its HP is re-\nstored by 25% of its maximum H-\nP when attacked by one.");
static const u8 sCrowdedNestDescriptionExtended[] = _("(NOT IMPLEMENTED)");
static const u8 sPlayDeadDescriptionExtended[] = _("The Pokémon takes half damage\nfrom all types except Bug-, G-\nhost- and Dark-type moves, whi-\nch deal double damage.");
static const u8 sSlowMetabolismDescriptionExtended[] = _("There is a 30% chance to cure\nany status condition in the e-\nnd of each turn.");
static const u8 sThickSkinDescriptionExtended[] = _("Protects the Pokémon from bit-\ning moves.");
static const u8 sParrotMimicryDescriptionExtended[] = _("When the Pokémon enters the b-\nattlefield, it uses Copycat. C-\nopycat: The Pokémon use the la-\nst move that was used in the b-\nattle against the Pokémon.");
static const u8 sTransmutationDescriptionExtended[] = _("(NOT IMPLEMENTED)");
static const u8 sFleetFootworkDescriptionExtended[] = _("The Pokémon uses 20% of its S-\npeed stat against incoming spe-\ncial moves as a defensive stat\nin addition to the default st-\nat during the damage calculati-\non. The Speed stat stages, ite-\nms and abilities still affect \nthis percentage.");
static const u8 sStormsFavorDescriptionExtended[] = _("When the Pokémon uses Hurrica-\nne during any weather, it chan-\nges its type depending on the \nweather and bypass the Accurac-\ny check.");
static const u8 sGoodLuckDescriptionExtended[] = _("The Pokémon always land criti-\ncal hit, always apply their mo-\nve's secondary effects (except\nfor Flinch and Freeze status \nconditions), and the damage ca-\nlculation RNG is always the be-\nst (100%). This Pokémon is una-\nffected by Bad Luck ability.");
static const u8 sReliabilityDescriptionExtended[] = _("(NOT IMPLEMENTED)");
static const u8 sTrustworthyDescriptionExtended[] = _("Moves that depend on the frie-\nndship always have 120 base po-\nwer. Moves: Return, Pika Papow\n, Veevee Volley and Frustratio-\nn.");
static const u8 sFastLearningDescriptionExtended[] = _("The Pokémon gains 150% the ex-\nperience it would otherwise ga-\nin. ");
static const u8 sFrostbornDescriptionExtended[] = _("Adds the Ice-type to the Poké-\nmon, in addition to the Pokémo-\nn's original type(s) and moves\nthat would be “supereffective-\n” against pure Ice-type Pokémo-\nn will be only normally effect-\nive instead.");
static const u8 sBreakthroughDescriptionExtended[] = _("Doubles the power of moves ag-\nainst Pokémon under the effect-\ns of Reflect, Light Screen, Au-\nrora Veil, Fire Wall, Stone Wa-\nll, Safeguard, Mist and substi-\ntute.");
static const u8 sLostEmotionsDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nremoves all items from opposin-\ng Pokémon.");
static const u8 sLostWillpowerDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nsuppresses the effects of all \nabilities of opposing Pokémon.\nThis effect remains even afte-\nr that Pokémon switches out.");
static const u8 sRiftwalkDescriptionExtended[] = _("If the Pokémon would faint fr-\nom a damaging move, it prevent-\ns all damage from that move an-\nd from moves used by other Pok-\némon for the rest of the turn.");
static const u8 sSpacetimeStrainDescriptionExtended[] = _("All Pokémon on the field spen-\nds one additional PP when usin-\ng a move and takes damage equa-\nl to 1/16 of their maximum HP \nat the end of each turn. The P-\nokémon is unaffected by Spacet-\nime Strain effects.");
static const u8 sAntimatterVeilDescriptionExtended[] = _("All Pokémon on the field take-\ns damage equal to 1/16 of thei-\nr maximum HP at the end of eac-\nh turn. The Pokémon is unaffec-\nted by Antimatter Veil effects\n.");
static const u8 sTunnelRunnerDescriptionExtended[] = _("The Pokémon has its Speed sta-\nt doubled when at maximum HP.");
static const u8 sHyperactiveDescriptionExtended[] = _("When the Pokémon attacks with\na field move, its Speed stat \nis increased by two stages. Mo-\nves: Cut, Fly, Surf, Strength,\nDig, Whirlpool, Waterfall, Ro-\nck Smash, Headbutt, Dive, Secr-\net Power, Rock Climb, Chatter.");
static const u8 sSkyDiverDescriptionExtended[] = _("The Pokémon has its Speed sta-\nt doubled when at maximum HP.");
static const u8 sCannonModeDescriptionExtended[] = _("The Pokémon's base Special At-\ntack stat becomes equal to its\nbase Attack stat, but is unab-\nle to use punching moves.");
static const u8 sJetModeDescriptionExtended[] = _("The Pokémon's base Speed stat\nbecomes equal to its base Att-\nack stat, but is unable to use\npunching, beam, pump, cannon,\nzooka, shot, gun, aura and pu-\nlse moves.");
static const u8 sHoarfrostSkinDescriptionExtended[] = _("During a hailstorm, the Speci-\nal Defense stat of the Pokémon\nis increased by 50%. The Poké-\nmon takes no damage from hail.");
static const u8 sAsteroidBeltDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Stone Wall. The stone wal-\nl lasts for two turns. Stone W-\nall: reduces the damage of phy-\nsical and special moves by hal-\nf, reduced to 1/3 in double ba-\nttles.");
static const u8 sReflectDamageDescriptionExtended[] = _("When the Pokémon is attacked \nby a move, the opposing Pokémo-\nn takes damage equal to 30% of\ndamage dealt.");
static const u8 sJackFrostDescriptionExtended[] = _("Boosts the power of the Pokém-\non's Ice-type moves by 50%.");
static const u8 sDunewardDescriptionExtended[] = _("While Sandy Terrain is active\n, the Special Defense stat of \nthe Pokémon is increased by 50\n%.");
static const u8 sTurbulenceDescriptionExtended[] = _("When opposing Pokémon attempt-\ns to use a wind move, they tak-\ne damage equal to 25% of their\nmaximum HP and cannot execute\nthe move.");
static const u8 sVampireAscendantDescriptionExtended[] = _("When the Pokémon attacks, the\nopposing Pokémon takes damage\nequal to 1/8 of its maximum H-\nP, also the Pokémon restores H-\nP by the same amount. ");
static const u8 sWatchfulEyeballDescriptionExtended[] = _("The Pokémon takes 50% less da-\nmage from moves, except critic-\nal hit.");
static const u8 sIronWillDescriptionExtended[] = _("The Pokémon takes 50% less da-\nmage from moves, except “super-\neffective” damage.");
static const u8 sOilyLocksDescriptionExtended[] = _("The Pokémon is immune to Wate-\nr-type moves, and increases th-\ne Defense stat by one stage wh-\nen attacked by one.");
static const u8 sCurlyHairDescriptionExtended[] = _("When the Pokémon attacks with\na move that makes contact, th-\nere is a 30% chance to trap th-\ne foe for two to three turns. \nIf the foe is trapped, contact\nmoves ignore any change to th-\ne Defense stat stages and bypa-\nss Accuracy check. If the Poké-\nmon is in first place in the p-\nlayer's party (even if fainted-\n), bites will occur more often\nwhile fishing.");
static const u8 sMegaManeDescriptionExtended[] = _("The Pokémon takes half damage\nfrom moves that make contact.\nIt also takes double damage f-\nrom wind moves. Wind moves tha-\nt make contact will deal regul-\nar damage.");
static const u8 sMocousCoatDescriptionExtended[] = _("The Pokémon takes half damage\nfrom moves that make contact.\nIt also takes double damage f-\nrom Water-type moves. Water-ty-\npe moves that make contact wil-\nl deal regular damage.");
static const u8 sHealingAromaDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Aromatherapy. Aromatherap-\ny: Cures the all Pokémon in th-\ne trainer's party of all statu-\ns conditions (sleep, poison, p-\naralysis, freeze, and burn).");
static const u8 sMalignateDescriptionExtended[] = _("All Normal-type moves used by\nthe Pokémon become Dark-type \nand receive a 20% power boost.");
static const u8 sGravitropismDescriptionExtended[] = _("(NOT IMPLEMENTED)");
static const u8 sPhototropismDescriptionExtended[] = _("The Pokémon takes 30% less da-\nmage during a harsh sunlight.");
static const u8 sLurelightDescriptionExtended[] = _("Increases the Accuracy of mov-\nes used by the Pokémon and its\nallies in battle by 10%.");
static const u8 sDeepDwellerDescriptionExtended[] = _("The Pokémon takes 50% less da-\nmage from moves with 100 or hi-\ngher base power.");
static const u8 sBenthicOrganismDescriptionExtended[] = _("Adds the Ground-type to the P-\nokémon, in addition to the Pok-\némon's original type(s) and mo-\nves that would be “supereffect-\nive” against pure Ground-type \nPokémon will be only normally \neffective instead.");
static const u8 sFromTheVoidDescriptionExtended[] = _("If the Pokémon would faint fr-\nom a damaging move, it prevent-\ns all damage from that move an-\nd from moves used by other Pok-\némon for the rest of the turn.");
static const u8 sAuraGuardDescriptionExtended[] = _("The Pokémon takes half damage\nfrom moves that make contact.");
static const u8 sGrimOmenDescriptionExtended[] = _("When the Pokémon attacks, the\nchance of a move having an ad-\nditional effect is doubled.");
static const u8 sChronobreakDescriptionExtended[] = _("When the Pokémon would faint \ndue to a damaging move, restor-\nes the Pokémon's HP and status\ncondition equal to that the P-\nokémon had between the last tw-\no turns (whichever is better).");
static const u8 sOutlanderDescriptionExtended[] = _("This Pokémon's Water- and Gro-\nund-type moves receive STAB re-\ngardless of its typing. Also, \nthe Pokémon negates weather an-\nd terrain's effects that would\nincrease damage or accuracy a-\ngainst it or decrease damage o-\nr accuracy of its moves.");
static const u8 sMedicineScaleDescriptionExtended[] = _("There is a 30% chance to cure\nany status condition in the e-\nnd of each turn.");
static const u8 sGodOfCreationDescriptionExtended[] = _("The Pokémon deals 50% more da-\nmage and takes 50% less damage\nfrom non-Legendary Pokémon. T-\nhis effect is reduced to 25% a-\ngainst Legendary Pokémon. The \nPokémon is unaffected by Space-\ntime Strain and Antimatter Vei-\nl.");
static const u8 sOriginalOneDescriptionExtended[] = _("The Pokémon is unaffected by \nother Pokémon's status moves a-\nnd their moves' secondary effe-\ncts.");
static const u8 sOmniscientDescriptionExtended[] = _("When the Pokémon attacks, ign-\nores all type immunities and a-\nbilities of the target for the\nexecution of that move.");
static const u8 sOverdriveModeDescriptionExtended[] = _("While the Pokémon's HP is bel-\now half of its maximum HP, the\npower of Fire-, Electric- and\nIce-type moves is increased b-\ny 50%.");
static const u8 sBiofrostDescriptionExtended[] = _("When the Pokémon uses a move,\nthe effects of all ignorable \nAbilities are ignored for the \nexecution of that move. Also, \nadds the Ice-type to the Pokém-\non, in addition to the Pokémon-\n's original type(s) and moves \nthat would be “supereffective”\nagainst pure Ice-type Pokémon\nwill be only normally effecti-\nve instead.");
static const u8 sMetallizeDescriptionExtended[] = _("All Normal-type moves used by\nthe Pokémon become Steel-type\nand receive a 20% power boost\n.");
static const u8 sMineralizeDescriptionExtended[] = _("All Normal-type moves used by\nthe Pokémon become Rock-type \nand receive a 20% power boost.");
static const u8 sMakerOfOceansDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons swamp terrain-\n. The swamp terrain last as lo-\nng as the Pokémon is in the fi-\neld, and cannot be replaced by\nanother terrain. Swamp Terrai-\nn: Increases the power of Wate-\nr-type and mud moves by 30% of\nPokémon that are on the groun-\nd, reduces the Speed stat of a-\nll non-Water-type Pokémon that\nare on the ground by 25%.");
static const u8 sMakerOfLandsDescriptionExtended[] = _("When the Pokémon enters the f-\nield, it summons sandy terrain-\n. The sandy terrain last as lo-\nng as the Pokémon is in the fi-\neld, and cannot be replaced by\nanother terrain. Sandy Terrai-\nn: Increases the power of Grou-\nnd-type moves by 30% of Pokémo-\nn that are on the ground and n-\non-Ground- and Rock-type Pokém-\non have their Evasion reduced \nby 40%.");
static const u8 sSuperAncientDescriptionExtended[] = _("The Pokémon is immune to stat\nstages reduction, including s-\nelf-inflicted stat stages redu-\nction.");
static const u8 sDragonLordDescriptionExtended[] = _("The power of Dragon-type move-\ns used by the Pokémon and its \nallies is increased by 50%. Al-\nso, the Pokémon takes 25% less\ndamage from other Dragon-type\nPokémon.");
static const u8 sMineralDietDescriptionExtended[] = _("When the Pokémon is hit by a \nRock-type move, its HP is rest-\nored by 25% of its maximum HP,\nand the move will have no eff-\nect on that Pokémon.");
static const u8 sSeginStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats and adds the Dark-type \nto the Pokémon, in addition to\nthe Pokémon's original type(s-\n) and moves that would be “sup-\nereffective” against pure Dark\n-type Pokémon will be only nor-\nmally effective instead. Allow\nto use Wicked Torque and work-\ns like Intimidate ability.");
static const u8 sSchedarStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats and adds the Fire-type \nto the Pokémon, in addition to\nthe Pokémon's original type(s-\n) and moves that would be “sup-\nereffective” against pure Fire\n-type Pokémon will be only nor-\nmally effective instead. Allow\nto use Blazing Torque and wor-\nks like Speed Boost ability.");
static const u8 sNaviStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats and increases the power\nof Poison-type moves by 50%. \nAllow to use Noxious Torque an-\nd works like Toxic Debris abil-\nity.");
static const u8 sRuchbahStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats and adds the Fairy-type\nto the Pokémon, in addition t-\no the Pokémon's original type(-\ns) and moves that would be “su-\npereffective” against pure Fai-\nry-type Pokémon will be only n-\normally effective instead. All-\now to use Magical Torque and w-\norks like Misty Surge ability.");
static const u8 sCaphStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats and adds the Fighting-t-\nype to the Pokémon, in additio-\nn to the Pokémon's original ty-\npe(s) and moves that would be \n“supereffective” against pure \nFighting-type Pokémon will be \nonly normally effective instea-\nd. Allow to use Combat Torque \nand works like Stamina ability\n.");
static const u8 sNitroEngineDescriptionExtended[] = _("Increases the power of torque\nmoves used by the Pokémon by \n50% and doubles the chance of \nhaving their additional effect\n.");
static const u8 sFullThrottleDescriptionExtended[] = _("When the Pokémon enters the f-\nield, its Speed stat is maximi-\nzed. At the end of each turn, \nit takes damage equal to 1/2 o-\nf its maximum HP.");
static const u8 sMeteorSeekerDescriptionExtended[] = _("Draco Meteor cannot miss and \nlowers Special Attack stat by \none stage instead of two stage-\ns. If there is a Piplup on the\nfield, it will target the Pip-\nlup regardless.");
static const u8 sPestilenceDescriptionExtended[] = _("As long as the Pokémon is on \nthe field, all other Pokémon t-\nakes double damage from poison\n.");
static const u8 sContagionDescriptionExtended[] = _("When the Pokémon attacks with\nToxic, Stun Spore, Poison Pow-\nder, Sleep Powder, Spore or Le-\nech Seed, that move will targe-\nt both opposing Pokémon instea-\nd.");
static const u8 sPlagueDoctorDescriptionExtended[] = _("When the Pokémon attacks with\nToxic, Stun Spore, Poison Pow-\nder, Sleep Powder, Spore or Le-\nech Seed, the effects of all i-\ngnorable abilitie are ignored \nfor the execution of that move-\n. Also, the Pokémon takes 25% \nless damage from Pokémon with \na status condition.");
static const u8 sFoulDigestDescriptionExtended[] = _("Whenever an opposing Pokémon \neats a Berry, it takes damage \nequal to 1/4 of their maximum \nHP.");
static const u8 sMicogenesisDescriptionExtended[] = _("When the Pokémon attacks with\na spore or powder move, it al-\nso seeds that target. A seeded\nPokémon loses 1/8 of its maxi-\nmum HP each turn, and the user\nrestores that amount.");
static const u8 sPressurizedGasDescriptionExtended[] = _("Haze, Mustard Gas, Smog, Clea-\nr Smog, Smokescreen, Strange S-\nteam and Corrosive Gas become \nspecial move with 100 base pow-\ner and will target both opposi-\nng Pokémon.");
static const u8 sCarbonEmitterDescriptionExtended[] = _("(not implemented) Whenever th-\ne Speed stat of the Pokémon is\nincreased, all non-Poison- an-\nd Steel-type takes damage equa-\nl to 1/16 of their maximum HP.");
static const u8 sMoonGuardDescriptionExtended[] = _("The Pokémon takes 30% less da-\nmage during a gloom moonlight.");
static const u8 sTurtleUpDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Withdraw. Withdraw: Incre-\nases the Pokémon's Defense and\nSpecial Defense stats by two \nstages, and lowers the Attack,\nSpecial Attack and Speed stat-\ns by one stage.");
static const u8 sArcanePowerDescriptionExtended[] = _("The Pokémon's Special Attack \nstat is doubled.");
static const u8 sRepellentFurDescriptionExtended[] = _("The Pokémon is immune to Wate-\nr-type moves, and increases th-\ne Speed stat by one stage when\nattacked by one.");
static const u8 sAirBubbleDescriptionExtended[] = _("The ally Pokémon takes 50% le-\nss damage from Water-type move-\ns and is unaffected by swamp t-\nerrain's negative effects.");
static const u8 sMistyEscapeDescriptionExtended[] = _("When the Pokémon is hit by a \nFire-type move or when harsh s-\nunlight takes effect, it becom-\nes Water- and Flying-type Poké-\nmon.");
static const u8 sTropicBreezeDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nuses Tailwind. The tailwind la-\nsts for four turns. Tailwind: \nDoubles the Speed stat of all \nPokémon in your side of the ba-\nttlefield.");
static const u8 sFreshPickedFruitDescriptionExtended[] = _("Whenever the Pokémon eats a B-\nerry, it restores HP equal to \n1/2 of its maximum HP.");
static const u8 sDeadlyInfectionDescriptionExtended[] = _("When the Pokémon attacks with\nToxic, Stun Spore, Poison Pow-\nder, Sleep Powder, Spore and L-\neech Seed, the target of that \nmove will also take damage equ-\nal to 1/4 of their maximum HP.\n");
static const u8 sFullMoonDescriptionExtended[] = _("All moves used by the Pokémon\nbehave as though the weather \nwere gloom moonlight, regardle-\nss of the actual weather on th-\ne field. Gloom Moonlight: Boos-\nts Dark-type moves by 50%, Moo-\nnlight restores more HP, Morni-\nng Sun and Synthesis restores \nless HP, Crowstorm ignore Accu-\nracy checks, Midnight Beam has\nno charge.");
static const u8 sDeflectorLashDescriptionExtended[] = _("The Pokémon uses 50% of its A-\nttack stat against special mov-\nes in addition to the default \nstat during the damage calcula-\ntion. The Attack stat stages, \nitems and abilities still affe-\nct this percentage.");
static const u8 sWinterPowerDescriptionExtended[] = _("Adds the Ice-type to the Poké-\nmon, in addition to the Pokémo-\nn's original type(s) and moves\nthat would be “supereffective-\n” against pure Ice-type Pokémo-\nn will be only normally effect-\nive instead.");
static const u8 sSummerPowerDescriptionExtended[] = _("Adds the Fire-type to the Pok-\némon, in addition to the Pokém-\non's original type(s) and move-\ns that would be “supereffectiv-\ne” against pure Fire-type Poké-\nmon will be only normally effe-\nctive instead.");
static const u8 sAutumnPowerDescriptionExtended[] = _("Adds the Ghost-type to the Po-\nkémon, in addition to the Poké-\nmon's original type(s) and mov-\nes that would be “supereffecti-\nve” against pure Ghost-type Po-\nkémon will be only normally ef-\nfective instead.");
static const u8 sSpringPowerDescriptionExtended[] = _("Adds the Fairy-type to the Po-\nkémon, in addition to the Poké-\nmon's original type(s) and mov-\nes that would be “supereffecti-\nve” against pure Fairy-type Po-\nkémon will be only normally ef-\nfective instead.");
static const u8 sDarkestDayDescriptionExtended[] = _("(not implemented)");
static const u8 sOminousAuraDescriptionExtended[] = _("Others Pokémon becomes enrage-\nd, having 33% chance to attack\nwith random move from the mov-\nepool instead. This effect is \nalways triggered after Eternal-\nbeam is used.");
static const u8 sOuroborosDescriptionExtended[] = _("When the Pokémon cause to fai-\nnt three Pokémon from opposing\nteam, you win the battle.");
static const u8 sHeadRegrowthDescriptionExtended[] = _("When the Pokémon is attacked,\nthe Pokémon restores 1/8 of i-\nts maximum HP.");
static const u8 sGoldDiggerDescriptionExtended[] = _("Doubles the amount of prize m-\noney received after battle if \nthe Pokémon takes part in the \nbattle. This effect doesn't st-\nack with Amulet Coin or Luck I-\nncense.");
static const u8 sMagnetHoverDescriptionExtended[] = _("The Speed stat of the Pokémon\nis doubled and the Pokémon be-\ncomes ungrounded on electric t-\nerrain. The Pokémon is still a-\nffected by electric terrain re-\ngardless.");
static const u8 sSwiftPowerDescriptionExtended[] = _("The Pokémon's Speed stat is d-\noubled.");
static const u8 sNeutronPulsarDescriptionExtended[] = _("When the Pokémon attacks, typ-\ne immunities become “supereffe-\nctive” against the target for \nthe execution of that move.");
static const u8 sBlinkDescriptionExtended[] = _("When the Pokémon is attacked,\nthere is a 30% chance to tele-\nport avoiding that move.");
static const u8 sMatterAnnihilationDescriptionExtended[] = _("When the Pokémon attacks, ign-\nores all type immunities and a-\nbilities of the target for the\nexecution of that move.");
static const u8 sDanceLessonsDescriptionExtended[] = _("The Pokémon uses 50% of its S-\npeed stat against incoming mov-\nes as a defensive stat in addi-\ntion to the default stat durin-\ng the damage calculation. The \nSpeed stat stages, items and a-\nbilities still affect this per-\ncentage.");
static const u8 sCreationOfAntimatterDescriptionExtended[] = _("The Pokémon cannot be affecte-\nd by moves that make contact. \nAlso, Shadow Force hits foes t-\nhrough protection moves, deali-\nng 25% of the original damage \nand lifts that effect from the\ntarget for the remainder of t-\nhe turn.");
static const u8 sCreationOfTimeDescriptionExtended[] = _("The Pokémon and its allies ca-\nnnot be affected by moves that\nhave increased priority. Also\n, Roar of Time prevents all ot-\nher Pokémon from moving during\nthe Pokémon's recharge turn.");
static const u8 sCreationOfSpaceDescriptionExtended[] = _("The Pokémon and its allies ca-\nnnot be affected by moves that\ntarget multiple Pokémon. Also\n, Spacial Rend has a 30% chanc-\ne to trap the target in anothe-\nr dimension.");
static const u8 sGreatEchoDescriptionExtended[] = _("(not implemented) Causes soun-\nd-based moves used by the Poké-\nmon to become two-strike moves\n, with the second strike havin-\ng its damage halved. It does n-\not affect multi-strike moves.");
static const u8 sAcidifiedRainDescriptionExtended[] = _("(not implemented) While the P-\nokémon is on the field, all no-\nn-Poison-type Pokémon takes da-\nmage equal to 1/16 of their ma-\nximum HP at the end of each tu-\nrn, increased to 1/8 against W-\nater- or Steel-type Pokémon. A-\nlso, increases the power of Po-\nison-type moves by 50% during \nrain.");
static const u8 sBlackQuasarDescriptionExtended[] = _("When the Pokémon attacks, ign-\nores all type immunities of th-\ne target for the execution of \nthat move.");
static const u8 sPowerBouncerDescriptionExtended[] = _("The move Bounce used by the P-\nokémon is immediately executed\n, has 120 base power and targe-\nts all opposing Pokémon.");
static const u8 sViralVectorDescriptionExtended[] = _("When the Pokémon attacks, it \ntransfers any status condition\nto the target, including conf-\nusion.");
static const u8 sMutagenesisDescriptionExtended[] = _("(not implemented)");
static const u8 sDnaRecombinationDescriptionExtended[] = _("Each time the Pokémon is hit \nby a move, reduces the damage \nby 50% of any incoming move wi-\nth the same type for the rest \nof the battle.");
static const u8 sBlitzkriegDescriptionExtended[] = _("Damaging moves that don't mak-\ne contact use 20% of its Speed\nstat in addition to the defau-\nlt stat for the damage calcula-\ntion. The Speed stat stage-mod-\nifiers, items and other abilit-\nies are applied to this percen-\ntage. Also, if the Pokémon is \nparalyzed, it cannot be fully \nparalyzed.");
static const u8 sAgm65MaverickDescriptionExtended[] = _("Increases the power of moves \nagainst grounded Pokémon by 30\n%.");
static const u8 sTrackingDescriptionExtended[] = _("Increases the Accuracy of mov-\nes used by the Pokémon by 30%.\nIf the Pokémon is in the firs-\nt place in the part (even if f-\nainted), the chance of encount-\nering a wild Pokémon holding a-\nn item increases from 50%/5% t-\no 60%/20%.");
static const u8 sShellderCommandDescriptionExtended[] = _("(not implemented)");
static const u8 sSlowpokeTailDescriptionExtended[] = _("Prevents Water-type Pokémon f-\nrom fleeing or switching out. \nIf the Pokémon is in the first\nplace in the party (even if f-\nainted), then there is a 50% c-\nhance the game will force an e-\nncounter with a Water-type Pok-\némon.");
static const u8 sGeneticNexusDescriptionExtended[] = _("Increases all stats of the Po-\nkémon by 25%. Also, restores 1\n/16 of its maximum HP at the e-\nnd of each turn.");
static const u8 sPowerGateDescriptionExtended[] = _("While Psyshield is active on \nthe Pokémon, increases the pow-\ner of moves by 30% and target \nboth opposing Pokémon.");
...
const u8 *const gAbilityDescriptionExtendedPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_PLACEHOLDER_18] = sPlaceholder18DescriptionExtended,
    ...
    [ABILITY_IRONCLAD_KEEL] = sIroncladKeelDescriptionExtended,
    ...
    [ABILITY_ANTARCTIC_BIRD] = sAntarcticBirdDescriptionExtended,
    ...
    [ABILITY_DRAGONIZE] = sDragonizeDescriptionExtended,
    ...
    [ABILITY_TAP_DANCER] = sTapDancerDescriptionExtended,
    ...
    [ABILITY_PLACEHOLDER_15] = sPlaceholder_15DescriptionExtended,
    ...
    [ABILITY_DARK_SIDE] = sDarkSideDescriptionExtended,
    ...
    [ABILITY_DRAGON_HOARD] = sDragonHoardDescriptionExtended,
    [ABILITY_BUG_CATCHER] = sBugCatcherDescriptionExtended,
    [ABILITY_NEUROTOXIC_VENOM] = sNeurotoxicVenomDescriptionExtended,
    [ABILITY_HEMOTOXIC_VENOM] = sHemotoxicVenomDescriptionExtended,
    [ABILITY_SOLENOGLYPHS] = sSolenoglyphsDescriptionExtended,
    [ABILITY_PROSPECTING] = sProspectingDescriptionExtended,
    [ABILITY_OCCULTISM] = sOccultismDescriptionExtended,
    [ABILITY_SPELLWEAVER] = sSpellweaverDescriptionExtended,
    [ABILITY_TURN_TO_OIL] = sTurnToOilDescriptionExtended,
    [ABILITY_COLLOSUS] = sCollosusDescriptionExtended,
    [ABILITY_CONTAMINATE] = sContaminateDescriptionExtended,
    [ABILITY_SAWTOOTH_RUSH] = sSawtoothRushDescriptionExtended,
    ...
    [ABILITY_CHILI_FEVER] = sChiliFeverDescriptionExtended,
    [ABILITY_REMODELING_FRAME] = sRemodelingFrameDescriptionExtended,
    [ABILITY_NURSERY] = sNurseryDescriptionExtended,
    [ABILITY_AFTERIMAGE] = sAfterimageDescriptionExtended,
    [ABILITY_AERO_VOICE] = sAeroVoiceDescriptionExtended,
    [ABILITY_GRAVEKEEPER] = sGravekeeperDescriptionExtended,
    [ABILITY_SALT_RITUAL] = sSaltRitualDescriptionExtended,
    [ABILITY_VELOCITY_SHIFT] = sVelocityShiftDescriptionExtended,
    [ABILITY_FAE_BANE] = sFaeBaneDescriptionExtended,
    [ABILITY_BOMBARDMENT] = sBombardmentDescriptionExtended,
    [ABILITY_HELLISH_RESISTANCE] = sHellishResistanceDescriptionExtended,
    [ABILITY_FAE_TOUCHED] = sFaeTouchedDescriptionExtended,
    [ABILITY_LAST_RITES] = sLastRitesDescriptionExtended,
    [ABILITY_LATENT_PSYCHE] = sLatentPsycheDescriptionExtended,
    [ABILITY_PSIONIC_DOMINANCE] = sPsionicDominanceDescriptionExtended,
    [ABILITY_PSIONIC_BACKLASH] = sPsionicBacklashDescriptionExtended,
    [ABILITY_MIND_FRACTURE] = sMindFractureDescriptionExtended,
    [ABILITY_GORE_RUSH] = sGoreRushDescriptionExtended,
    [ABILITY_UNERRING_IMPALE] = sUnerringImpaleDescriptionExtended,
    [ABILITY_PERILOUS_STAKE] = sPerilousStakeDescriptionExtended,
    [ABILITY_SKY_SOVEREIGN] = sSkySovereignDescriptionExtended,
    [ABILITY_NECROTOXIC_VENOM] = sNecrotoxicVenomDescriptionExtended,
    [ABILITY_STONE_SCATTER] = sStoneScatterDescriptionExtended,
    [ABILITY_FREECAST] = sFreecastDescriptionExtended,
    [ABILITY_PLACEHOLDER_11] = sTapDancerDescriptionExtended,
    [ABILITY_SKULLBREAKER] = sSkullbreakerDescriptionExtended,
    [ABILITY_VENOM_OVERDRIVE] = sVenomOverdriveDescriptionExtended,
    [ABILITY_DUNE_TRAP] = sDuneTrapDescriptionExtended,
    [ABILITY_SAND_GLIDER] = sSandGliderDescriptionExtended,
    [ABILITY_PLACEHOLDER_14] = sLoverlyFragranceDescriptionExtended,
    [ABILITY_DISGUSTING_POLLEN] = sDisgustingPollenDescriptionExtended,
    [ABILITY_DIAMOND_REFLECT] = sDiamondReflectDescriptionExtended,
    [ABILITY_CHAIN_REACTION] = sChainReactionDescriptionExtended,
    [ABILITY_POWER_KEG] = sPowerKegDescriptionExtended,
    [ABILITY_SULFUR_FEED] = sSulfurFeedDescriptionExtended,
    [ABILITY_SMOKE_SIGNAL] = sSmokeSignalDescriptionExtended,
    [ABILITY_SOOT_VEIL] = sSootVeilDescriptionExtended,
    [ABILITY_REACTIVE_ARMOR] = sReactiveArmorDescriptionExtended,
    [ABILITY_SIEGE_PAYLOAD] = sSiegePayloadDescriptionExtended,
    [ABILITY_LIVING_MONOLITH] = sLivingMonolithDescriptionExtended,
    [ABILITY_POWER_OBELISK] = sPowerObeliskDescriptionExtended,
    [ABILITY_STONE_SENTINEL] = sStoneSentinelDescriptionExtended,
    [ABILITY_RUNIC_STONE] = sRunicStoneDescriptionExtended,
    [ABILITY_LOVELY_FRAGRANCE] = sLovelyFragranceDescriptionExtended,
    [ABILITY_OVERCLOCK] = sOverclockDescriptionExtended,
    [ABILITY_FLAVOR_ADAPTATION] = sFlavorAdaptationDescriptionExtended,
    [ABILITY_AWAKENED_MIND] = sAwakenedMindDescriptionExtended,
    [ABILITY_SILENT_FLIGHT] = sSilentFlightDescriptionExtended,
    [ABILITY_TEMPEST_WAKE] = sTempestWakeDescriptionExtended,
    [ABILITY_LEECH_SPORE] = sLeechSporeDescriptionExtended,
    [ABILITY_MAGMA_CHAMBER] = sMagmaChamberDescriptionExtended,
    [ABILITY_ABYSSAL_WELLSPRING] = sAbyssalWellspringDescriptionExtended,
    [ABILITY_FEEDING_FRENZY] = sFeedingFrenzyDescriptionExtended,
    [ABILITY_DREADFUL_SMELL] = sDreadfulSmellDescriptionExtended,
    [ABILITY_IRON_CHIME] = sIronChimeDescriptionExtended,
    [ABILITY_IMPROVISED_WEAPON_GRASS] = sImprovisedWeaponGrassDescriptionExtended,
    [ABILITY_IMPROVISED_WEAPON_STEEL] = sImprovisedWeaponSteelDescriptionExtended,
    [ABILITY_IMPROVISED_WEAPON_ROCK] = sImprovisedWeaponRockDescriptionExtended,
    [ABILITY_BONE_CAGE] = sBoneCageDescriptionExtended,
    [ABILITY_SOVEREIGN_CREST] = sSovereignCrestDescriptionExtended,
    [ABILITY_OILY_CARAPACE] = sOilyCarapaceDescriptionExtended,
    [ABILITY_POWER_OVERFLOW] = sPowerOverflowDescriptionExtended,
    [ABILITY_MEGA_SOL] = sMegaSolDescriptionExtended,
    [ABILITY_PIERCING_DRILL] = sPiercingDrillDescriptionExtended,
    [ABILITY_SPICY_SPRAY] = sSpicySprayDescriptionExtended,
    [ABILITY_STORM_WINGS] = sStormWingsDescriptionExtended,
    [ABILITY_SKITTERIZE] = sSkitterizeDescriptionExtended,
    [ABILITY_ADRENALINE_SURGE] = sAdrenalineSurgeDescriptionExtended,
    [ABILITY_PHANTOM_STAR_FIST] = sPhantomStarFistDescriptionExtended,
    [ABILITY_SUNFORGED_GOLD] = sSunforgedGoldDescriptionExtended,
    [ABILITY_SILVER_ARMOR] = sSilverArmorDescriptionExtended,
    [ABILITY_POLAR_GUARD] = sPolarGuardDescriptionExtended,
    [ABILITY_TESLA_COIL] = sTeslaCoilDescriptionExtended,
    [ABILITY_FLUX_BREAK] = sFluxBreakDescriptionExtended,
    [ABILITY_COLOSSEUM_SURGE] = sColosseumSurgeDescriptionExtended,
    [ABILITY_DRACONIC_SURGE] = sDraconicSurgeDescriptionExtended,
    [ABILITY_EVERBURN_SPEAR] = sEverburnSpearDescriptionExtended,
    [ABILITY_HYDRENCHYMA] = sHydrenchymaDescriptionExtended,
    [ABILITY_NIGHT_SYNTHESIS] = sNightSynthesisDescriptionExtended,
    [ABILITY_WAXY_GUARD] = sWaxyGuardDescriptionExtended,
    [ABILITY_NEEDLE_SKIN] = sNeedleSkinDescriptionExtended,
    [ABILITY_MASTER_PUGILIST] = sMasterPugilistDescriptionExtended,
    [ABILITY_THE_WAY_OF_THE_KICK] = sTheWayOfTheKickDescriptionExtended,
    [ABILITY_MARTIAL_PRODIGY] = sMartialProdigyDescriptionExtended,
    [ABILITY_FUTURE_GAZE] = sFutureGazeDescriptionExtended,
    [ABILITY_STRADIVARIUS] = sStradivariusDescriptionExtended,
    [ABILITY_PRESSURE_BURST] = sPressureBurstDescriptionExtended,
    [ABILITY_POWER_SPLASHER] = sPowerSplasherDescriptionExtended,
    [ABILITY_JUICEMAKER] = sJuicemakerDescriptionExtended,
    ...
    [ABILITY_DESERT_FLOWER] = sDesertFlowerDescriptionExtended,
    [ABILITY_SCARECROW_VIGIL] = sScarecrowVigilDescriptionExtended,
    [ABILITY_HEAVY_SLEEPER] = sHeavySleeperDescriptionExtended,
    [ABILITY_DEEP_SLUMBER] = sDeepSlumberDescriptionExtended,
    [ABILITY_LOG_LAUNCHER] = sLogLauncherDescriptionExtended,
    [ABILITY_LUMBER_PILLOW] = sLumberPillowDescriptionExtended,
    [ABILITY_ALL_JUST_A_DREAM] = sAllJustADreamDescriptionExtended,
    [ABILITY_TRAINING_GROUND] = sTrainingGroundDescriptionExtended,
    [ABILITY_GRAPPLE_GUARD] = sGrappleGuardDescriptionExtended,
    [ABILITY_THREADLOCK] = sThreadlockDescriptionExtended,
    [ABILITY_TRAP_TERRITORY] = sTrapTerritoryDescriptionExtended,
    [ABILITY_SILKEN_AMBUSH] = sSilkenAmbushDescriptionExtended,
    [ABILITY_ELECTRIFIED_WIRE] = sElectrifiedWireDescriptionExtended,
    [ABILITY_ROGUE_TACTICS] = sRogueTacticsDescriptionExtended,
    [ABILITY_DIRTY_FIGHTING] = sDirtyFightingDescriptionExtended,
    [ABILITY_POISONOUS_NEST] = sPoisonousNestDescriptionExtended,
    ...
    [ABILITY_BERSERK_FURY] = sBerserkFuryDescriptionExtended,
    [ABILITY_INTOXICATE] = sIntoxicateDescriptionExtended,
    [ABILITY_THIRD_EYE] = sThirdEyeDescriptionExtended,
    [ABILITY_PSIONIZE] = sPsionizeDescriptionExtended,
    [ABILITY_SCRY] = sScryDescriptionExtended,
    [ABILITY_WISH_UPON_A_STAR] = sWishUponAStarDescriptionExtended,
    [ABILITY_ORACLES_PROPHECY] = sOraclesProphecyDescriptionExtended,
    [ABILITY_STARLIGHT_VEIL] = sStarlightVeilDescriptionExtended,
    [ABILITY_MILLENIUM_COMET] = sMilleniumCometDescriptionExtended,
    [ABILITY_SIXTH_SENSE] = sSixthSenseDescriptionExtended,
    [ABILITY_HEALING_FACTOR] = sHealingFactorDescriptionExtended,
    [ABILITY_WATERLOGGING] = sWaterloggingDescriptionExtended,
    [ABILITY_BATTLE_AURA] = sBattleAuraDescriptionExtended,
    [ABILITY_TERRAFORM] = sTerraformDescriptionExtended,
    [ABILITY_FIRST_STRIKE] = sFirstStrikeDescriptionExtended,
    [ABILITY_DOUBLE_STRIKE] = sDoubleStrikeDescriptionExtended,
    [ABILITY_HASTE] = sHasteDescriptionExtended,
    [ABILITY_LIFELINK] = sLifelinkDescriptionExtended,
    [ABILITY_REACH] = sReachDescriptionExtended,
    [ABILITY_TRAMPLE] = sTrampleDescriptionExtended,
    [ABILITY_DEATHTOUCH] = sDeathtouchDescriptionExtended,
    [ABILITY_CRYOSTASIS] = sCryostasisDescriptionExtended,
    [ABILITY_GENERALIST] = sGeneralistDescriptionExtended,
    [ABILITY_HEXPROOF] = sHexproofDescriptionExtended,
    [ABILITY_HERD_LEADER] = sHerdLeaderDescriptionExtended,
    [ABILITY_MENACE] = sMenaceDescriptionExtended,
    [ABILITY_PLANESWALKER] = sPlaneswalkerDescriptionExtended,
    [ABILITY_VIGILANCE] = sVigilanceDescriptionExtended,
    [ABILITY_HYPNOTIC_GAZE] = sHypnoticGazeDescriptionExtended,
    [ABILITY_INDOMITABLE] = sIndomitableDescriptionExtended,
    [ABILITY_NIGHTSTALKER] = sNightstalkerDescriptionExtended,
    [ABILITY_VENGEFUL_SPIRIT] = sVengefulSpiritDescriptionExtended,
    [ABILITY_SPIRITUAL_OFFERINGS] = sSpiritualOfferingsDescriptionExtended,
    [ABILITY_CHARGE_UP] = sChargeUpDescriptionExtended,
    [ABILITY_BATTLE_TRANCE] = sBattleTranceDescriptionExtended,
    [ABILITY_LOVE_SERENADE] = sLoveSerenadeDescriptionExtended,
    [ABILITY_LOST_TECHNOLOGY] = sLostTechnologyDescriptionExtended,
    [ABILITY_CLAY_VESSEL] = sClayVesselDescriptionExtended,
    [ABILITY_ANIMATED_CONSTRUCT] = sAnimatedConstructDescriptionExtended,
    [ABILITY_OCEANS_COVENANT] = sOceansCovenantDescriptionExtended,
    [ABILITY_DARK_BRIBE] = sDarkBribeDescriptionExtended,
    [ABILITY_REVENANT_CORAL] = sRevenantCoralDescriptionExtended,
    [ABILITY_CORAL_BLEACHING] = sCoralBleachingDescriptionExtended,
    [ABILITY_ZOOXANTHELLAE] = sZooxanthellaeDescriptionExtended,
    [ABILITY_DINOFLAGELLATE] = sDinoflagellateDescriptionExtended,
    [ABILITY_ALGAL_SHIELD] = sAlgalShieldDescriptionExtended,
    [ABILITY_BARRIER_REEF] = sBarrierReefDescriptionExtended,
    [ABILITY_MUTUALISM] = sMutualismDescriptionExtended,
    [ABILITY_UNTAPPED_POTENCIAL] = sUntappedPotencialDescriptionExtended,
    [ABILITY_LITTLE_CHAMPION] = sLittleChampionDescriptionExtended,
    [ABILITY_UNSTABLE_CORE] = sUnstableCoreDescriptionExtended,
    [ABILITY_BERRY_BULK] = sBerryBulkDescriptionExtended,
    [ABILITY_DEBILITATE] = sDebilitateDescriptionExtended,
    [ABILITY_POLAR_CURRENT] = sPolarCurrentDescriptionExtended,
    [ABILITY_KILLER_WHALE] = sKillerWhaleDescriptionExtended,
    [ABILITY_ECHOLOCATION] = sEcholocationDescriptionExtended,
    [ABILITY_FIREBRAND] = sFirebrandDescriptionExtended,
    [ABILITY_MASTER_FENCER] = sMasterFencerDescriptionExtended,
    [ABILITY_EN_GARDE] = sEnGardeDescriptionExtended,
    [ABILITY_RUTHLESS_PREDATOR] = sRuthlessPredatorDescriptionExtended,
    [ABILITY_REIGN_OF_ANGER] = sReignOfAngerDescriptionExtended,
    [ABILITY_REINDEER_RIDER] = sReindeerRiderDescriptionExtended,
    [ABILITY_DEFLECTOR_HULL] = sDeflectorHullDescriptionExtended,
    [ABILITY_LURKING_MENACE] = sLurkingMenaceDescriptionExtended,
    [ABILITY_LOST_KNOWLEDGE] = sLostKnowledgeDescriptionExtended,
    [ABILITY_CLEAR_MINDED] = sClearMindedDescriptionExtended,
    [ABILITY_MADNESS_MIND] = sMadnessMindDescriptionExtended,
    [ABILITY_SUBJUGATE] = sSubjugateDescriptionExtended,
    [ABILITY_GENETIC_MODIFIED_S] = sGeneticModifiedSDescriptionExtended,
    [ABILITY_GENETIC_MODIFIED_A] = sGeneticModifiedADescriptionExtended,
    [ABILITY_GENETIC_MODIFIED_B] = sGeneticModifiedBDescriptionExtended,
    [ABILITY_GENETIC_MODIFIED_C] = sGeneticModifiedCDescriptionExtended,
    [ABILITY_GENETIC_MODIFIED_D] = sGeneticModifiedDDescriptionExtended,
    [ABILITY_HOMUNCULUS] = sHomunculusDescriptionExtended,
    [ABILITY_HAWK_EYE] = sHawkEyeDescriptionExtended,
    [ABILITY_VULTURE_EYE] = sVultureEyeDescriptionExtended,
    [ABILITY_FALCON_EYE] = sFalconEyeDescriptionExtended,
    [ABILITY_OWL_EYE] = sOwlEyeDescriptionExtended,
    [ABILITY_EAGLE_EYE] = sEagleEyeDescriptionExtended,
    [ABILITY_BUG_COLONY] = sBugColonyDescriptionExtended,
    [ABILITY_WARDING_BELLS] = sWardingBellsDescriptionExtended,
    [ABILITY_BEE_QUEEN] = sBeeQueenDescriptionExtended,
    [ABILITY_MASTERMIND] = sMastermindDescriptionExtended,
    [ABILITY_MESMERIZE] = sMesmerizeDescriptionExtended,
    [ABILITY_WAR_DRUMS] = sWarDrumsDescriptionExtended,
    [ABILITY_TOXIC_DUST] = sToxicDustDescriptionExtended,
    [ABILITY_BUBBLE_MASK] = sBubbleMaskDescriptionExtended,
    [ABILITY_TIME_SKIP] = sTimeSkipDescriptionExtended,
    [ABILITY_VIRAL_BOOST] = sViralBoostDescriptionExtended,
    [ABILITY_FERTILIZER] = sFertilizerDescriptionExtended,
    [ABILITY_MEGAMORPHOSIS] = sMegamorphosisDescriptionExtended,
    [ABILITY_ARCHMORPHOSIS] = sArchmorphosisDescriptionExtended,
    [ABILITY_PROBOSCIS] = sProboscisDescriptionExtended,
    [ABILITY_MYCELIAL_NETWORK] = sMycelialNetworkDescriptionExtended,
    [ABILITY_FLORESSENCE] = sFloressenceDescriptionExtended,
    [ABILITY_POSEIDON_GUARD] = sPoseidonGuardDescriptionExtended,
    [ABILITY_VERDANT_OVERGROW] = sVerdantOvergrowDescriptionExtended,
    [ABILITY_INFERNO_BLAZE] = sInfernoBlazeDescriptionExtended,
    [ABILITY_RAGING_TORRENT] = sRagingTorrentDescriptionExtended,
    [ABILITY_FISH_HARPOON] = sFishHarpoonDescriptionExtended,
    [ABILITY_GOREMASTER] = sGoremasterDescriptionExtended,
    [ABILITY_WILD_STALLION] = sWildStallionDescriptionExtended,
    [ABILITY_GALLOP_HERD] = sGallopHerdDescriptionExtended,
    [ABILITY_GILL_FILTER] = sGillFilterDescriptionExtended,
    [ABILITY_BRANCHIAL_SHIELD] = sBranchialShieldDescriptionExtended,
    [ABILITY_RELENTLESS_FIST] = sRelentlessFistDescriptionExtended,
    [ABILITY_BRAWLER_FIST] = sBrawlerFistDescriptionExtended,
    [ABILITY_GENTLE_FIST] = sGentleFistDescriptionExtended,
    [ABILITY_COMBO_FIST] = sComboFistDescriptionExtended,
    [ABILITY_PHYTOPARASITE] = sPhytoparasiteDescriptionExtended,
    [ABILITY_DANDELION_DRIFT] = sDandelionDriftDescriptionExtended,
    [ABILITY_COTTON_CUSHION] = sCottonCushionDescriptionExtended,
    [ABILITY_SEED_SCATTER] = sSeedScatterDescriptionExtended,
    [ABILITY_CRAZY_VINES] = sCrazyVinesDescriptionExtended,
    [ABILITY_YOKAI] = sYokaiDescriptionExtended,
    [ABILITY_ONI] = sOniDescriptionExtended,
    [ABILITY_MONKEY_KING] = sMonkeyKingDescriptionExtended,
    [ABILITY_PRIMATE_TROOP] = sPrimateTroopDescriptionExtended,
    [ABILITY_STRING_VEIL] = sStringVeilDescriptionExtended,
    [ABILITY_ULTRA_SPACIAN] = sUltraSpacianDescriptionExtended,
    [ABILITY_ROCKET_BOOSTERS] = sRocketBoostersDescriptionExtended,
    [ABILITY_POWDER_DUST] = sPowderDustDescriptionExtended,
    [ABILITY_ICEBREAKER] = sIcebreakerDescriptionExtended,
    [ABILITY_DRAGONBORN] = sDragonbornDescriptionExtended,
    [ABILITY_EARTHWORM] = sEarthwormDescriptionExtended,
    [ABILITY_EELEVATE] = sEelevateDescriptionExtended,
    [ABILITY_FIRE_MANE] = sFireManeDescriptionExtended,
    [ABILITY_WEAPON_BOND] = sWeaponBondDescriptionExtended,
    [ABILITY_ELDRITCH_STRIKE] = sEldritchStrikeDescriptionExtended,
    [ABILITY_SHARED_BULWARK] = sSharedBulwarkDescriptionExtended,
    [ABILITY_RADIANT_CRYSTAL] = sRadiantCrystalDescriptionExtended,
    [ABILITY_PRISMATIC_CORE] = sPrismaticCoreDescriptionExtended,
    [ABILITY_RENEWING_SPINES] = sRenewingSpinesDescriptionExtended,
    [ABILITY_ADAMANTINE_CLAWS] = sAdamantineClawsDescriptionExtended,
    [ABILITY_CRITICAL_MASS] = sCriticalMassDescriptionExtended,
    [ABILITY_PERFECT_MIMIC] = sPerfectMimicDescriptionExtended,
    [ABILITY_COAL_IGNITION] = sCoalIgnitionDescriptionExtended,
    [ABILITY_WAR_PRIEST] = sWarPriestDescriptionExtended,
    [ABILITY_SNAKE_EYE] = sSnakeEyeDescriptionExtended,
    [ABILITY_PHOTOSYNTHESIS] = sPhotosynthesisDescriptionExtended,
    [ABILITY_MASTER_CHEF] = sMasterChefDescriptionExtended,
    [ABILITY_OMELETE_MAKER] = sOmeleteMakerDescriptionExtended,
    [ABILITY_CROWDED_NEST] = sCrowdedNestDescriptionExtended,
    [ABILITY_PLAY_DEAD] = sPlayDeadDescriptionExtended,
    [ABILITY_SLOW_METABOLISM] = sSlowMetabolismDescriptionExtended,
    [ABILITY_THICK_SKIN] = sThickSkinDescriptionExtended,
    [ABILITY_PARROT_MIMICRY] = sParrotMimicryDescriptionExtended,
    [ABILITY_TRANSMUTATION] = sTransmutationDescriptionExtended,
    [ABILITY_FLEET_FOOTWORK] = sFleetFootworkDescriptionExtended,
    [ABILITY_STORMS_FAVOR] = sStormsFavorDescriptionExtended,
    [ABILITY_GOOD_LUCK] = sGoodLuckDescriptionExtended,
    [ABILITY_RELIABILITY] = sReliabilityDescriptionExtended,
    [ABILITY_TRUSTWORTHY] = sTrustworthyDescriptionExtended,
    [ABILITY_FAST_LEARNING] = sFastLearningDescriptionExtended,
    [ABILITY_FROSTBORN] = sFrostbornDescriptionExtended,
    [ABILITY_BREAKTHROUGH] = sBreakthroughDescriptionExtended,
    [ABILITY_LOST_EMOTIONS] = sLostEmotionsDescriptionExtended,
    [ABILITY_LOST_WILLPOWER] = sLostWillpowerDescriptionExtended,
    [ABILITY_RIFTWALK] = sRiftwalkDescriptionExtended,
    [ABILITY_SPACETIME_STRAIN] = sSpacetimeStrainDescriptionExtended,
    [ABILITY_ANTIMATTER_VEIL] = sAntimatterVeilDescriptionExtended,
    [ABILITY_TUNNEL_RUNNER] = sTunnelRunnerDescriptionExtended,
    [ABILITY_HYPERACTIVE] = sHyperactiveDescriptionExtended,
    [ABILITY_SKY_DIVER] = sSkyDiverDescriptionExtended,
    [ABILITY_CANNON_MODE] = sCannonModeDescriptionExtended,
    [ABILITY_JET_MODE] = sJetModeDescriptionExtended,
    [ABILITY_HOARFROST_SKIN] = sHoarfrostSkinDescriptionExtended,
    [ABILITY_ASTEROID_BELT] = sAsteroidBeltDescriptionExtended,
    [ABILITY_REFLECT_DAMAGE] = sReflectDamageDescriptionExtended,
    [ABILITY_JACK_FROST] = sJackFrostDescriptionExtended,
    [ABILITY_DUNEWARD] = sDunewardDescriptionExtended,
    [ABILITY_TURBULENCE] = sTurbulenceDescriptionExtended,
    [ABILITY_VAMPIRE_ASCENDANT] = sVampireAscendantDescriptionExtended,
    [ABILITY_WATCHFUL_EYEBALL] = sWatchfulEyeballDescriptionExtended,
    [ABILITY_IRON_WILL] = sIronWillDescriptionExtended,
    [ABILITY_OILY_LOCKS] = sOilyLocksDescriptionExtended,
    [ABILITY_CURLY_HAIR] = sCurlyHairDescriptionExtended,
    [ABILITY_MEGA_MANE] = sMegaManeDescriptionExtended,
    [ABILITY_MOCOUS_COAT] = sMocousCoatDescriptionExtended,
    [ABILITY_HEALING_AROMA] = sHealingAromaDescriptionExtended,
    [ABILITY_MALIGNATE] = sMalignateDescriptionExtended,
    [ABILITY_GRAVITROPISM] = sGravitropismDescriptionExtended,
    [ABILITY_PHOTOTROPISM] = sPhototropismDescriptionExtended,
    [ABILITY_LURELIGHT] = sLurelightDescriptionExtended,
    [ABILITY_DEEP_DWELLER] = sDeepDwellerDescriptionExtended,
    [ABILITY_BENTHIC_ORGANISM] = sBenthicOrganismDescriptionExtended,
    [ABILITY_FROM_THE_VOID] = sFromTheVoidDescriptionExtended,
    [ABILITY_AURA_GUARD] = sAuraGuardDescriptionExtended,
    [ABILITY_GRIM_OMEN] = sGrimOmenDescriptionExtended,
    [ABILITY_CHRONOBREAK] = sChronobreakDescriptionExtended,
    [ABILITY_OUTLANDER] = sOutlanderDescriptionExtended,
    [ABILITY_MEDICINE_SCALE] = sMedicineScaleDescriptionExtended,
    [ABILITY_GOD_OF_CREATION] = sGodOfCreationDescriptionExtended,
    [ABILITY_ORIGINAL_ONE] = sOriginalOneDescriptionExtended,
    [ABILITY_OMNISCIENT] = sOmniscientDescriptionExtended,
    [ABILITY_OVERDRIVE_MODE] = sOverdriveModeDescriptionExtended,
    [ABILITY_BIOFROST] = sBiofrostDescriptionExtended,
    [ABILITY_METALLIZE] = sMetallizeDescriptionExtended,
    [ABILITY_MINERALIZE] = sMineralizeDescriptionExtended,
    [ABILITY_MAKER_OF_OCEANS] = sMakerOfOceansDescriptionExtended,
    [ABILITY_MAKER_OF_LANDS] = sMakerOfLandsDescriptionExtended,
    [ABILITY_SUPER_ANCIENT] = sSuperAncientDescriptionExtended,
    [ABILITY_DRAGON_LORD] = sDragonLordDescriptionExtended,
    [ABILITY_MINERAL_DIET] = sMineralDietDescriptionExtended,
    [ABILITY_SEGIN_STARMOBILE] = sSeginStarmobileDescriptionExtended,
    [ABILITY_SCHEDAR_STARMOBILE] = sSchedarStarmobileDescriptionExtended,
    [ABILITY_NAVI_STARMOBILE] = sNaviStarmobileDescriptionExtended,
    [ABILITY_RUCHBAH_STARMOBILE] = sRuchbahStarmobileDescriptionExtended,
    [ABILITY_CAPH_STARMOBILE] = sCaphStarmobileDescriptionExtended,
    [ABILITY_NITRO_ENGINE] = sNitroEngineDescriptionExtended,
    [ABILITY_FULL_THROTTLE] = sFullThrottleDescriptionExtended,
    [ABILITY_METEOR_SEEKER] = sMeteorSeekerDescriptionExtended,
    [ABILITY_PESTILENCE] = sPestilenceDescriptionExtended,
    [ABILITY_CONTAGION] = sContagionDescriptionExtended,
    [ABILITY_PLAGUE_DOCTOR] = sPlagueDoctorDescriptionExtended,
    [ABILITY_FOUL_DIGEST] = sFoulDigestDescriptionExtended,
    [ABILITY_MICOGENESIS] = sMicogenesisDescriptionExtended,
    [ABILITY_PRESSURIZED_GAS] = sPressurizedGasDescriptionExtended,
    [ABILITY_CARBON_EMITTER] = sCarbonEmitterDescriptionExtended,
    [ABILITY_MOON_GUARD] = sMoonGuardDescriptionExtended,
    [ABILITY_TURTLE_UP] = sTurtleUpDescriptionExtended,
    [ABILITY_ARCANE_POWER] = sArcanePowerDescriptionExtended,
    [ABILITY_REPELLENT_FUR] = sRepellentFurDescriptionExtended,
    [ABILITY_AIR_BUBBLE] = sAirBubbleDescriptionExtended,
    [ABILITY_MISTY_ESCAPE] = sMistyEscapeDescriptionExtended,
    [ABILITY_TROPIC_BREEZE] = sTropicBreezeDescriptionExtended,
    [ABILITY_FRESH_PICKED_FRUIT] = sFreshPickedFruitDescriptionExtended,
    [ABILITY_DEADLY_INFECTION] = sDeadlyInfectionDescriptionExtended,
    [ABILITY_FULL_MOON] = sFullMoonDescriptionExtended,
    [ABILITY_DEFLECTOR_LASH] = sDeflectorLashDescriptionExtended,
    [ABILITY_WINTER_POWER] = sWinterPowerDescriptionExtended,
    [ABILITY_SUMMER_POWER] = sSummerPowerDescriptionExtended,
    [ABILITY_AUTUMN_POWER] = sAutumnPowerDescriptionExtended,
    [ABILITY_SPRING_POWER] = sSpringPowerDescriptionExtended,
    [ABILITY_DARKEST_DAY] = sDarkestDayDescriptionExtended,
    [ABILITY_OMINOUS_AURA] = sOminousAuraDescriptionExtended,
    [ABILITY_OUROBOROS] = sOuroborosDescriptionExtended,
    [ABILITY_HEAD_REGROWTH] = sHeadRegrowthDescriptionExtended,
    [ABILITY_GOLD_DIGGER] = sGoldDiggerDescriptionExtended,
    [ABILITY_MAGNET_HOVER] = sMagnetHoverDescriptionExtended,
    [ABILITY_SWIFT_POWER] = sSwiftPowerDescriptionExtended,
    [ABILITY_NEUTRON_PULSAR] = sNeutronPulsarDescriptionExtended,
    [ABILITY_BLINK] = sBlinkDescriptionExtended,
    [ABILITY_MATTER_ANNIHILATION] = sMatterAnnihilationDescriptionExtended,
    [ABILITY_DANCE_LESSONS] = sDanceLessonsDescriptionExtended,
    [ABILITY_CREATION_OF_ANTIMATTER] = sCreationOfAntimatterDescriptionExtended,
    [ABILITY_CREATION_OF_TIME] = sCreationOfTimeDescriptionExtended,
    [ABILITY_CREATION_OF_SPACE] = sCreationOfSpaceDescriptionExtended,
    [ABILITY_GREAT_ECHO] = sGreatEchoDescriptionExtended,
    [ABILITY_ACIDIFIED_RAIN] = sAcidifiedRainDescriptionExtended,
    [ABILITY_BLACK_QUASAR] = sBlackQuasarDescriptionExtended,
    [ABILITY_POWER_BOUNCER] = sPowerBouncerDescriptionExtended,
    [ABILITY_VIRAL_VECTOR] = sViralVectorDescriptionExtended,
    [ABILITY_MUTAGENESIS] = sMutagenesisDescriptionExtended,
    [ABILITY_DNA_RECOMBINATION] = sDnaRecombinationDescriptionExtended,
    [ABILITY_BLITZKRIEG] = sBlitzkriegDescriptionExtended,
    [ABILITY_AGM_65_MAVERICK] = sAgm65MaverickDescriptionExtended,
    [ABILITY_TRACKING] = sTrackingDescriptionExtended,
    [ABILITY_SHELLDER_COMMAND] = sShellderCommandDescriptionExtended,
    [ABILITY_SLOWPOKE_TAIL] = sSlowpokeTailDescriptionExtended,
    [ABILITY_GENETIC_NEXUS] = sGeneticNexusDescriptionExtended,
    [ABILITY_POWER_GATE] = sPowerGateDescriptionExtended,
