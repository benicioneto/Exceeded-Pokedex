...
static const u8 sDampDescriptionExtended[] = _("If the Pokémon has full HP an-\nd is attacked by a move that w-\nould otherwise cause fainting,\nthe Pokémon survives with 1 H-\nP. Also, the Pokémon can be pr-\notected against self-inflicted\nconfusion damage.");
...
static const u8 sTenacityDescriptionExtended[] = _("Once per battle, if the Pokém-\non is attacked by a damaging m-\nove that would cause it to fai-\nnt, there is a 30% chance to s-\nurvive with 1 HP.");
...
static const u8 sDancingTentaclesDescriptionExtended[] = _("When the Pokémon attacks with\na move that makes contact, tr-\naps the foe for two to three t-\nurns. Foes binded by the Pokém-\non become confused for the dur-\nation.");
...
static const u8 sSpellweaverDescriptionExtended[] = _("(Not Implemented)");
static const u8 sTurnToOilDescriptionExtended[] = _("(Not Implemented)");
...
static const u8 sContaminateDescriptionExtended[] = _("(Not Implemented)");
