...
static const u8 sElementistDescriptionExtended[] = _("When using Water-, Electric- \nor Fire-type special moves, th-\ney deal 20% more damage, and i-\nf it is a Water-type move, res-\ntore HP equal to 1/16 of the P-\nokémon's maximum HP, or if it \nis a Electric-type move, there\nis a 10% chance of flinching,\nor if it is a Fire-type move,\ndeal additional damage equal \nto 1/8 of target's missing HP.");
