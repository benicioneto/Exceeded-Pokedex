...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_RED_HOT_CHILI_PEPPERS] = _("Red Hot Peppers"),
...
static const u8 sShieldDustDescriptionExtended[] = _("Reduces the damage from moves\nthat make contact by 25% and \nbecomes unaffected by the addi-\ntional effects of damaging mov-\nes.");
...
static const u8 sInnerFocusDescriptionExtended[] = _("Prevents the Pokémon from fli-\nnching and blocks Intimidate a-\nnd Frighten. Focus Blast's Acc-\nuracy is increased to 90%. Foc-\nus Punch doesn't lose focus if\nhit up to 1 time, but halves \nthe power of move when hit.");
...
static const u8 sWaterVeilDescriptionExtended[] = _("Prevents the Pokémon from bei-\nng burned, also uses Aqua Ring\nin battle as soon as the Poké-\nmon enters the battlefield. Aq-\nua Ring effect: At the end of \nthe turn, it restores 1/16 of \nits maximum HP and heals burn.\nHalves the damage from Electr-\nic-type moves.");
...
static const u8 sRunAwayDescriptionExtended[] = _("When a stat of the Pokémon is\nlowered by an opponent, its S-\npeed is increased by two stage-\ns. It will not activate if the\nPokémon with this Ability low-\ners its own stats (such as wit-\nh Close Combat) or if its stat-\ns are lowered by an ally. The \nPokémon can always flee and us-\ne Teleport successfully, regar-\ndless of trapping moves and Ab-\nilities. ");
...
static const u8 sArenaTrapDescriptionExtended[] = _("Prevents all grounded opposin-\ng Pokémon from fleeing or swit-\nching out as long as the user \nremains in battle. Ghost-type \nPokémon are immune to Arena Tr-\nap. If the Pokémon is in the f-\nirst place in the party (even \nif fainted), the wild Pokémon \nencounter rate increases by 10\n0%.");
...
static const u8 sUnburdenDescriptionExtended[] = _("Increases the Pokémon's speed\nby 50% when its held item is \nlost (doubles the speed for Ba-\nttle Item). If a Power Item or\nMacho Brace is lost, the Poké-\nmon will use 25% of its Speed \nstat for physical moves in add-\nition to the default stat duri-\nng the damage calculation. The-\nse effects stacks additively, \nand remains for the rest of th-\ne battle, even if switch out.");
static const u8 sHeatproofDescriptionExtended[] = _("Halves the damage done by Fir-\ne-type moves and the burn stat-\nus ailment.");
...
static const u8 sFriskDescriptionExtended[] = _("Reveals the opponent's Battle\nItem, Consumable and Accessor-\ny and render them unusable for\ntwo turns upon entering battl-\ne");
...
static const u8 sFlowerGiftDescriptionExtended[] = _("During harsh sunlight, the Po-\nkémon changes from Overcast fo-\nrm to Sunshine form, increases\nthe all stats of the Pokémon \nby 30% and its allies stats by\n5%.");
...
static const u8 sPickpocketDescriptionExtended[] = _("When the Pokémon is hit by a \nmove that makes contact, it wi-\nll steal one of the held item \nof the attacking Pokémon. It w-\nill avoid items that cannot be\nstolen, or empty item slots. \nIf the Pokémon tries to steal \nwhile holding an item on the s-\name slot, the stolen item may \nbe add to the bag instead, or \nbe removed for the rest of the\nbattle.");
...
static const u8 sMagicianDescriptionExtended[] = _("When the Pokémon hits another\nPokémon with a damaging move,\nit will steal one of the held\nitem of the Pokémon that it h-\nit. It will avoid items that c-\nannot be stolen, or empty item\nslots. If the Pokémon tries t-\no steal while holding an item \non the same slot, the stolen i-\ntem may be add to the bag inst-\nead, or be removed for the res-\nt of the battle.");
...
static const u8 sCommanderDescriptionExtended[] = _("(Not Implemented) When a Tats-\nugiri with Commander is on the\nsame side of the field as a D-\nondozo, it will enter the Dond-\nozo's mouth and the Dondozo wi-\nll have its Attack, Defense, S-\npecial Attack, Special Defense\n, and Speed stats raised by tw-\no stages each. While Tatsugiri\nis inside Dondozo's mouth, th-\ne latter will be unable to swi-\ntch out and cannot be forced o");
...
static const u8 sRampageDescriptionExtended[] = _("The Pokémon doesn't need to r-\necharge on the next turn after\na move is used, but one addit-\nional PP are deducted, for a t-\notal of two PPs deduction. Whe-\nn the Pokémon directly causes \nanother Pokémon (including all-\nies) to faint by using these m-\noves, restores two PPs from th-\nat move.");
...
static const u8 sBlademasterDescriptionExtended[] = _("There is a 20% chance that th-\ne Pokémon will parry incoming \nsingle target move, increased \nto 60% chance if it is slicing\nmove. When the Pokémon is att-\nacked by a move that makes con-\ntact, there is a 30% chance to\ncounter the attack with a swi-\nft slash that deals Normal-typ-\ne damage with 25 power.");
...
static const u8 sElementistDescriptionExtended[] = _("When using Water-, Electric- \nor Fire-type damaging moves, t-\nhey deal 20% more damage, and \nif it is a Water-type move, re-\nstore HP equal to 1/16 of the \nPokémon's maximum HP, or if it\nis a Electric-type move, ther-\ne is a 20% chance of flinching\n, or if it is a Fire-type move\n, deal additional damage equal\nto 1/8 of target's missing HP\n.");
static const u8 sGuardianDeityDescriptionExtended[] = _("When the Pokémon enters the b-\nattlefield and is holding Boos-\nter Energy, or the Pokémon has\na type corresponding to the a-\nctive terrain, its highest sta-\nt is increased by 30%, or 50% \nif Speed is the highest stat.");
...
static const u8 sGaleOfDarknessDescriptionExtended[] = _("The Pokémon cannot take super-\neffective damage from special \nmoves.");
...
static const u8 sConnectedBrainsDescriptionExtended[] = _("Boosts Psychic-type moves use-\nd by the Pokémon by 50%.");
...
static const u8 sDwarvenResilienceDescriptionExtended[] = _("Halves the chance of being af-\nfected by any effects of other\nPokémon's damaging moves.");
static const u8 sRedHotChiliPeppersDescriptionExtended[] = _("If the Pokémon uses a damage \nmove, it deals randomly Fire- \nor Grass-type damage with powe-\nr equal to half of the move us-\ned. Grass-type moves always de-\nal Fire-type bonus damage and \nvice versa.");
