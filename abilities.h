...
static const u8 sIcebreakerDescriptionExtended[] = _("When the Pokémon attacks with\nIce-type move, the opposing P-\nokémon takes damage equal to 1\n/8 of its maximum HP and will \nalways deal “supereffective” d-\namage against Ice-type Pokemon-\n. The Pokémon can inflict fros-\ntbite on Ice-type Pokémon. ");
