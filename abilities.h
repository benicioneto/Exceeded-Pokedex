...
static const u8 sSolenoglyphs2Description[] = _("Ups biting dmg & effect.");
...
static const u8 sDeflectorHullDescription[] = _("Def boosts Sp. Def.");
...
static const u8 sMycelialNetworkDescription[] = _("Ups dranning moves powder.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_SOLENOGLYPHS] = _("placeholder"),
    ...
    [ABILITY_SOLENOGLYPHS_2] = _("Solenoglyphs"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SOLENOGLYPHS_2] = sSolenoglyphs2Description,
...
static const u8 sSpatialWarpDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nwarps through space, avoinding\nany entry hazard and attacks.\nAfter the Pokémon uses any mo-\nve, it will reappear. Spacial \nRend also has a 20% chance to \ntrap the target in that dimens-\nion. The Pokémon and its allie-\ns cannot be affected by moves \nthat target multiple Pokémon.");
static const u8 sTemporalFlowDescriptionExtended[] = _("Lowers the priority of all op-\nposing Pokémon by 1. Roar of T-\nime prevents all other Pokémon\nfrom moving during the Pokémo-\nn's recharge turn.");
...
static const u8 sPsychicBarrierDescriptionExtended[] = _("The first time that the Pokém-\non enters the battlefield, it \nsummons a psyshield equal to 2\n5% of its maximum HP. Psyshiel-\nd: Increases the Pokémon's Def-\nense stat by 50% and it is not\naffected by many status moves\nused by other Pokémon. During\nthe end of the battle or when\nswitches out, restores its HP\nequal the remaining HP of the\nbarrier.");
...
static const u8 sTeslaCoilDescriptionExtended[] = _("(Not Implemented)");
...
static const u8 sDraconicSurgeDescriptionExtended[] = _("When the Pokémon enters the b-\nattle, it creates the effect o-\nf the move Draconic Terrain on\nthe battlefield for five turn-\ns. Draconic Terrain: The power\nof Fairy-type moves from Poké-\nmon that are on the ground is \nhalved and Dragon-type moves c-\nan hit Fairy-type Pokémon that\nare on the ground.");
...
static const u8 sSeginStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats. Also, adds the Dark-ty-\npe to the Pokémon, in addition\nto the Pokémon's original typ-\ne(s) and moves that would be “-\nsupereffective” against pure D-\nark-type Pokémon will be only \nnormally effective instead. Al-\nlow to use Wicked Torque and w-\norks like Intimidate ability.");
static const u8 sSchedarStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats. Also, adds the Fire-ty-\npe to the Pokémon, in addition\nto the Pokémon's original typ-\ne(s) and moves that would be “-\nsupereffective” against pure F-\nire-type Pokémon will be only \nnormally effective instead. Al-\nlow to use Blazing Torque and \nworks like Speed Boost ability\n.");
static const u8 sNaviStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats. Also, increases the po-\nwer of Poison-type moves by 50\n%. Allow to use Noxious Torque\nand works like Toxic Debris a-\nbility.");
static const u8 sRuchbahStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats. Also, adds the Fairy-t-\nype to the Pokémon, in additio-\nn to the Pokémon's original ty-\npe(s) and moves that would be \n“supereffective” against pure \nFairy-type Pokémon will be onl-\ny normally effective instead. \nAllow to use Magical Torque an-\nd works like Misty Surge abili-\nty.");
static const u8 sCaphStarmobileDescriptionExtended[] = _("Doubles the Pokémon's base HP\nstats. Also, adds the Fightin-\ng-type to the Pokémon, in addi-\ntion to the Pokémon's original\ntype(s) and moves that would \nbe “supereffective” against pu-\nre Fighting-type Pokémon will \nbe only normally effective ins-\ntead. Allow to use Combat Torq-\nue and works like Stamina abil-\nity.");
...
static const u8 sPestilenceDescriptionExtended[] = _("Whenever the Pokémon inflicts\na status condition, the targe-\nt also takes damage equal to 1\n/4 of their maximum HP. As lon-\ng as the Pokémon is on the fie-\nld, all other Pokémon takes do-\nuble damage from status condit-\nions.");
static const u8 sContagionDescriptionExtended[] = _("Toxic, Stun Spore, Poison Pow-\nder, Sleep Powder, Spore and L-\neech Seed will target both opp-\nosing Pokémon instead.");
...
static const u8 sPressurizedGasDescriptionExtended[] = _("All gas moves become special \nmove with 100 base power and w-\nill target both opposing Pokém-\non. Moves: Haze, Mustard Gas, \nSmog, Clear Smog, Smokescreen,\nStrange Steam, Corrosive Gas.");
static const u8 sCarbonEmitterDescriptionExtended[] = _("Whenever the Speed stat of th-\ne Pokémon is increased, all no-\nn-Poison- and Steel-type takes\ndamage equal to 1/16 of their\nmaximum HP.");
...
const u8 *const gAbilityDescriptionExtendedPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SOLENOGLYPHS_2] = sSolenoglyphs2DescriptionExtended,
