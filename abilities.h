...
static const u8 sAmphibiousDescription[] = _("Ups Water-, Poison- & Ground-type moves.");
...
static const u8 sCellDivisionDescription[] = _("Heals each turn.");
...
static const u8 sRagnarokDescription[] = _("Boosts Atk at low HP.");
...
static const u8 sIronFistDescriptionExtended[] = _("Boosts the power of punching \nmoves by 20%. Special Techniqu-\ne: Sky Uppercut will ignore al-\nl ignorable abilities and deal\nadditional 50% of the damage \ntaken in that turn.");
...
static const u8 sRecklessDescriptionExtended[] = _("Increases the power of moves \nthat have recharge, recoil or \ncrash damage by 20%, but the r-\necoil damage remains the same \nas if damage wasn't boosted. W-\nhen the Pokémon directly cause-\ns another Pokémon (including a-\nllies) to faint by using a dam-\naging move, the Pokémon rechar-\nges immediately.");
...
static const u8 sHeavyMetalDescriptionExtended[] = _("The Pokémon takes 25% less da-\nmage from “supereffective” phy-\nsical moves and doubles its we-\night.");
static const u8 sLightMetalDescriptionExtended[] = _("The Pokémon's Speed stat is i-\nncreased by 20% and halves its\nweight.");
...
static const u8 sLeadCoatDescriptionExtended[] = _("The Pokémon cannot take “supe-\nreffective” damage from physic-\nal moves and triples its weigh-\nt.");
...
static const u8 sWeaknessExploitDescriptionExtended[] = _("Increases the priority of sin-\ngle-target damaging move by 1 \nwhen opposing Pokémon has a st-\natus condition or its HP is be-\nlow half.");
...
static const u8 sSoulEaterDescriptionExtended[] = _("The Pokémon gets stronger by \ncollecting wisps inside its Od-\nd Keystone. Whenever another P-\nokémon faints while Spiritomb \nis in the battlefield, its HP \nis restored by 25% of its maxi-\nmum HP and boosts its offensiv-\ne and defensive stats by 10% f-\nor the rest of the battle.");
...
static const u8 sPerfectionistDescriptionExtended[] = _("Increases critical hit rate b-\ny 1 and priority by 1 of moves\nwith base power of 20 or less\n.");
static const u8 sCellDivisionDescriptionExtended[] = _("The Pokémon restores HP by 1/-\n16 of its maximum HP and there\nis a 30% chance to heal any s-\ntatus condition in the end of \neach turn.");
...
static const u8 sCatsLuckDescriptionExtended[] = _("Increases a random stat of th-\ne Pokémon by one stage after l-\nanding a critical hit.");
static const u8 sBerserkerRageDescriptionExtended[] = _("The lower the Pokémon's HP is\n, the higher the Speed stat an-\nd restore more HP upon inflict-\ning damage on others, up to 10\n0% of Speed stat and 60% of th-\ne damage dealt at 95% missing \nHP.");
static const u8 sRagnarokDescriptionExtended[] = _("Every time the HP of the Poké-\nmon drops below half, its Atta-\nck is raised by one stage and \ncure any status condition.");
