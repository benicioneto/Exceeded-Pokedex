...
static const u8 sPhantomStarFirstDescription[] = _("Punch evades protection.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_PHANTOM_STAR_FIRST] = _("Phantom Star First"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_PHANTOM_STAR_FIRST] = sPhantomStarFirstDescription,
...
static const u8 sNocturnalDescriptionExtended[] = _("At night or during a gloom mo-\nonlight, it adds the Dark-type\nto the Pokémon, in addition t-\no the Pokémon's original type(-\ns). Also, the Speed stat of th-\ne Pokémon is doubled during a \ngloom moonlight.");
...
static const u8 sSpicySprayDescriptionExtended[] = _("When the Pokémon is attacked \nby a move, the opposing Pokémo-\nn will become burned.");
...
static const u8 sPhantomStarFirstDescriptionExtended[] = _("Punching moves used by the Po-\nkémon hit targets through prot-\nection moves, dealing 25% of t-\nhe original damage. Special Te-\nchnique: Shadow Punch will hit\nthe target even if it is prot-\nected, lifting the effects of \nProtect like moves for the rem-\nainder of the turn, and removi-\nng Reflect, Light Screen and A-\nurora Veil from the target's s-\nide of the field.");
static const u8 sSunforgedGoldDescriptionExtended[] = _("Fire-type moves that would be\n“supereffective” against pure\nSteel-type Pokémon will be no-\nt very effective against the S-\nteel-type of the Pokémon.");
static const u8 sSilverArmorDescriptionExtended[] = _("Ghost- and Dark-type moves th-\nat would be “normally effectiv-\ne” against pure Steel-type Pok-\némon will be not very effectiv-\ne against the Steel-type of th-\ne Pokémon.");
...
const u8 *const gAbilityDescriptionExtendedPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_PHANTOM_STAR_FIRST] = sPhantomStarFirstDescriptionExtended,
