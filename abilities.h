...
static const u8 sSpellweaverDescriptionExtended[] = _("All moves used by the Pokémon\nbehave as though the terrain \nwere Psychic Terrain, regardle-\nss of the actual terrain on th-\ne field.");
...
static const u8 sNightSynthesisDescriptionExtended[] = _("All moves used by the Pokémon\nbehave as though the weather \nwere harsh sunlight while unde-\nr gloom moonlight. Harsh Sunli-\nght: Boosts Fire-type moves by\n50% and weakens Water-type mo-\nves by 50%, Solar Beam and Sol-\nar Blade become one-turn moves\n, Growth have its effect doubl-\ned, Synthesis restore more HP.");
