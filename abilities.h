...
static const u8 sUnburdenDescriptionExtended[] = _("Increases the Speed stat of t-\nhe Pokémon by 50% when its hel-\nd item is lost (doubled if it \nwas a Battle Item). If a power\nitem or Macho Brace is lost, \nthe Pokémon will use 25% of it-\ns Speed stat for physical move-\ns in addition to the default s-\ntat during the damage calculat-\nion. These effects stacks addi-\ntively, and remains for the re-\nst of the battle.");
...
static const u8 sGooeyDescriptionExtended[] = _("When the Pokémon is attacked \nby a move that makes contact, \nthe Speed stat of the attackin-\ng Pokémon is decreased by one \nstage.");
