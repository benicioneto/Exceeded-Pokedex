...
static const u8 sBombardmentDescription[] = _(".");
...
static const u8 sDisgustingPollenDescription[] = _(".");
static const u8 sDiamondReflectDescription[] = _(".");
...
static const u8 sLovelyFragranceDescription[] = _(".");
...
static const u8 sEelevateDescription[] = _(".");
static const u8 sFireManeDescription[] = _(".");
static const u8 sTrainingGroundDescription[] = _(".");
static const u8 sGrappleGuardDescription[] = _(".");
static const u8 sThreadlockDescription[] = _(".");
static const u8 sTrapTerritoryDescription[] = _(".");
static const u8 sSilkenAmbushDescription[] = _(".");
static const u8 sChargedWebDescription[] = _(".");
static const u8 sRogueTacticsDescription[] = _(".");
static const u8 sDirtyFightingDescription[] = _(".");
static const u8 sPoisonousNestDescription[] = _(".");
static const u8 sSpiderQueenDescription[] = _(".");
static const u8 sInfusedCoreDescription[] = _(".");
static const u8 sTugestenAlloyDescription[] = _(".");
static const u8 sWyrmHideDescription[] = _(".");
static const u8 sStaticShellDescription[] = _(".");
static const u8 sBedrockDescription[] = _(".");
static const u8 sWhiteoutDescription[] = _(".");
static const u8 sBerserkFuryDescription[] = _(".");
static const u8 sIntoxicateDescription[] = _(".");
static const u8 sThirdEyeDescription[] = _(".");
static const u8 sPsionizeDescription[] = _(".");
static const u8 sScryDescription[] = _(".");
static const u8 sWishUponAStarDescription[] = _(".");
static const u8 sOraclesProphecyDescription[] = _(".");
static const u8 sStarlightVeilDescription[] = _(".");
static const u8 sMilleniumCometDescription[] = _(".");
static const u8 sSixthSenseDescription[] = _(".");
static const u8 sHealingFactorDescription[] = _(".");
static const u8 sWaterloggingDescription[] = _(".");
static const u8 sBattleAuraDescription[] = _(".");
static const u8 sTerraformDescription[] = _(".");
static const u8 sFirstStrikeDescription[] = _(".");
static const u8 sDoubleStrikeDescription[] = _(".");
static const u8 sHasteDescription[] = _(".");
static const u8 sLifelinkDescription[] = _(".");
static const u8 sReachDescription[] = _(".");
static const u8 sTrampleDescription[] = _(".");
static const u8 sDeathtouchDescription[] = _(".");
static const u8 sCryostasisDescription[] = _(".");
static const u8 sGeneralistDescription[] = _(".");
static const u8 sHexproofDescription[] = _(".");
static const u8 sHerdLeaderDescription[] = _(".");
static const u8 sMenaceDescription[] = _(".");
static const u8 sPlaneswalkerDescription[] = _(".");
static const u8 sVigilanceDescription[] = _(".");
static const u8 sHypnoticGazeDescription[] = _(".");
static const u8 sIndomitableDescription[] = _(".");
static const u8 sNightstalkerDescription[] = _(".");
static const u8 sVengefulSpiritDescription[] = _(".");
static const u8 sSpiritualOfferingsDescription[] = _(".");
static const u8 sChargeUpDescription[] = _(".");
static const u8 sBattleTranceDescription[] = _(".");
static const u8 sLoveSerenadeDescription[] = _(".");
static const u8 sLostTechnologyDescription[] = _(".");
static const u8 sClayVesselDescription[] = _(".");
static const u8 sAnimatedConstructDescription[] = _(".");
static const u8 sOceansCovenantDescription[] = _(".");
static const u8 sDarkBribeDescription[] = _(".");
static const u8 sRevenantCoralDescription[] = _(".");
static const u8 sCoralBleachingDescription[] = _(".");
static const u8 sZooxanthellaeDescription[] = _(".");
static const u8 sDinoflagellateDescription[] = _(".");
static const u8 sAlgalShieldDescription[] = _(".");
static const u8 sBarrierReefDescription[] = _(".");
static const u8 sMutualismDescription[] = _(".");
static const u8 sUntappedPotencialDescription[] = _(".");
static const u8 sLittleChampionDescription[] = _(".");
static const u8 sUnstableCoreDescription[] = _(".");
static const u8 sBerryBulkDescription[] = _(".");
static const u8 sDebilitateDescription[] = _(".");
static const u8 sPolarCurrentDescription[] = _(".");
static const u8 sKillerWhaleDescription[] = _(".");
static const u8 sEcholocationDescription[] = _(".");
static const u8 sFirebrandDescription[] = _(".");
static const u8 sMasterFencerDescription[] = _(".");
static const u8 sEnGardeDescription[] = _(".");
static const u8 sRuthlessPredatorDescription[] = _(".");
static const u8 sReignOfAngerDescription[] = _(".");
static const u8 sReindeerRiderDescription[] = _(".");
static const u8 sDeflectorHullDescription[] = _(".");
static const u8 sLurkingMenaceDescription[] = _(".");
static const u8 sLostKnowledgeDescription[] = _(".");
static const u8 sClearMindedDescription[] = _(".");
...
static const u8 sHawkEyeDescription[] = _(".");
static const u8 sVultureEyeDescription[] = _(".");
static const u8 sFalconEyeDescription[] = _(".");
static const u8 sOwlEyeDescription[] = _(".");
static const u8 sEagleEyeDescription[] = _(".");
static const u8 sBugColonyDescription[] = _(".");
static const u8 sWardingBellsDescription[] = _(".");
static const u8 sBeeQueenDescription[] = _(".");
static const u8 sMastermindDescription[] = _(".");
static const u8 sMesmerizeDescription[] = _(".");
static const u8 sWarDrumsDescription[] = _(".");
static const u8 sToxicDustDescription[] = _(".");
static const u8 sBubbleMaskDescription[] = _(".");
static const u8 sTimeSkipDescription[] = _(".");
static const u8 sViralBoostDescription[] = _(".");
static const u8 sFertilizerDescription[] = _(".");
static const u8 sMegamorphosisDescription[] = _(".");
static const u8 sArchmorphosisDescription[] = _(".");
static const u8 sProboscisDescription[] = _(".");
static const u8 sMycelialNetworkDescription[] = _(".");
static const u8 sFloressenceDescription[] = _(".");
static const u8 sPoseidonGuardDescription[] = _(".");
static const u8 sVerdantOvergrowDescription[] = _(".");
static const u8 sInfernoBlazeDescription[] = _(".");
static const u8 sRagingTorrentDescription[] = _(".");
static const u8 sFishHarpoonDescription[] = _(".");
static const u8 sGoremasterDescription[] = _(".");
static const u8 sWildStallionDescription[] = _(".");
static const u8 sGallopHerdDescription[] = _(".");
static const u8 sGillFilterDescription[] = _(".");
static const u8 sBranchialShieldDescription[] = _(".");
static const u8 sRelentlessFistDescription[] = _(".");
static const u8 sBrawlerFistDescription[] = _(".");
static const u8 sGentleFistDescription[] = _(".");
static const u8 sComboFistDescription[] = _(".");
static const u8 sPhytoparasiteDescription[] = _(".");
static const u8 sDandelionDriftDescription[] = _(".");
static const u8 sCottonCushionDescription[] = _(".");
static const u8 sSeedScatterDescription[] = _(".");
static const u8 sCrazyVinesDescription[] = _(".");
static const u8 sYokaiDescription[] = _(".");
static const u8 sOniDescription[] = _(".");
static const u8 sMonkeyKingDescription[] = _(".");
static const u8 sPrimateTroopDescription[] = _(".");
static const u8 sStringVeilDescription[] = _(".");
static const u8 sUltraSpacianDescription[] = _(".");
static const u8 sRocketBoostersDescription[] = _(".");
static const u8 sPowderDustDescription[] = _(".");
static const u8 sIcebreakerDescription[] = _(".");
static const u8 sDragonbornDescription[] = _(".");
static const u8 sEarthwormDescription[] = _(".");
static const u8 sWeaponBondDescription[] = _(".");
static const u8 sEldritchStrikeDescription[] = _(".");
static const u8 sSharedBulwarkDescription[] = _(".");
static const u8 sRadiantCrystalDescription[] = _(".");
static const u8 sPrismaticCoreDescription[] = _(".");
static const u8 sRenewingSpinesDescription[] = _(".");
static const u8 sAdamantineClawsDescription[] = _(".");
static const u8 sCriticalMassDescription[] = _(".");
static const u8 sPerfectMimicDescription[] = _(".");
static const u8 sCoalIgnitionDescription[] = _(".");
static const u8 sWarPriestDescription[] = _(".");
static const u8 sSnakeEyeDescription[] = _(".");
static const u8 sPhotosynthesisDescription[] = _(".");
static const u8 sMasterChefDescription[] = _(".");
static const u8 sOmeleteMakerDescription[] = _(".");
static const u8 sCrowdedNestDescription[] = _(".");
static const u8 sPlayDeadDescription[] = _(".");
static const u8 sSlowMetabolismDescription[] = _(".");
static const u8 sThickSkinDescription[] = _(".");
static const u8 sParrotMimicryDescription[] = _(".");
static const u8 sTransmutationDescription[] = _(".");
static const u8 sFleetFootworkDescription[] = _(".");
static const u8 sStormsFavorDescription[] = _(".");
static const u8 sGoodLuckDescription[] = _(".");
static const u8 sReliabilityDescription[] = _(".");
static const u8 sTrustworthyDescription[] = _(".");
static const u8 sFastLearningDescription[] = _(".");
static const u8 sFrostbornDescription[] = _(".");
static const u8 sBreakthroughDescription[] = _(".");
static const u8 sLostEmotionsDescription[] = _(".");
static const u8 sLostWillpowerDescription[] = _(".");
static const u8 sRiftwalkDescription[] = _(".");
static const u8 sSpacetimeStrainDescription[] = _(".");
static const u8 sAntimatterVeilDescription[] = _(".");
static const u8 sTunnelRunnerDescription[] = _(".");
static const u8 sHyperactiveDescription[] = _(".");
static const u8 sSkyDiverDescription[] = _(".");
static const u8 sCannonModeDescription[] = _(".");
static const u8 sJetModeDescription[] = _(".");
static const u8 sHoarfrostSkinDescription[] = _(".");
static const u8 sAsteroidBeltDescription[] = _(".");
static const u8 sReflectDamageDescription[] = _(".");
static const u8 sJackFrostDescription[] = _(".");
static const u8 sDunewardDescription[] = _(".");
static const u8 sTurbulenceDescription[] = _(".");
static const u8 sVampireAscendantDescription[] = _(".");
static const u8 sWatchfulEyeballDescription[] = _(".");
static const u8 sIronWillDescription[] = _(".");
static const u8 sOilyLocksDescription[] = _(".");
static const u8 sCurlyHairDescription[] = _(".");
static const u8 sMegaManeDescription[] = _(".");
static const u8 sMocousCoatDescription[] = _(".");
static const u8 sHealingAromaDescription[] = _(".");
static const u8 sMalignateDescription[] = _(".");
static const u8 sGravitropismDescription[] = _(".");
static const u8 sPhototropismDescription[] = _(".");
static const u8 sLurelightDescription[] = _(".");
static const u8 sDeepDwellerDescription[] = _(".");
static const u8 sBenthicOrganismDescription[] = _(".");
...
static const u8 sPreciseFistDescriptionExtended[] = _("Punching moves have critical \nrate increased by 1 and the ch-\nance of secondary effects is d-\noubled. Special Technique: Dyn-\namic Punch's Accuracy is incre-\nased to 100%.");
...
static const u8 sNightSynthesisDescriptionExtended[] = _("The Pokémon behave as though \nthe weather were harsh sunligh-\nt while under gloom moonlight.\nHarsh Sunlight: Boosts Fire-t-\nype moves by 50% and weakens W-\nater-type moves by 50%, Solar \nBeam and Solar Blade become on-\ne-turn moves, Growth have its \neffect doubled, Synthesis rest-\nore more HP.");
...
static const u8 sDesertFlowerDescriptionExtended[] = _("The Pokémon behave as though \nthe weather were raining while\nunder harsh sunlight or on sa-\nndy terrain. Rain: Boosts Wate-\nr-type moves by 50% and weaken-\ns the power of Fire-type moves\nby 50%, Thunder and Hurricane\nignore Accuracy and Evasion c-\nhecks.");
...
static const u8 sTimeSkipDescriptionExtended[] = _("(Not Implemented)");
...
static const u8 sFertilizerDescriptionExtended[] = _("While Grassy Terrain is activ-\ne, all Grass-type Pokémon's mo-\nves on the field behave as tho-\nugh the weather were harsh sun-\nlight, regardless of the actua-\nl weather on the field.");
