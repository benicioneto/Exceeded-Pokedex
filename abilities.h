...
static const u8 sTogetherWeStandDescriptionExtended[] = _("At the end of each turn, if t-\nhe Pokémon has a status condit-\nion during its Schooling form,\nit loses HP equal to 1/16 of \nits maximum HP to heal any sta-\ntus condition. Also, the Pokém-\non is immune to Intimidade or \nFrighten during its Schooling \nform.");
