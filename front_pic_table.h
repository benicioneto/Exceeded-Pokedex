const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(PARAS_ZOMBIFIED, gMonFrontPic_ParasZombified),
    SPECIES_SPRITE(PARASECT_ZOMBIFIED, gMonFrontPic_ParasectZombified),
    ...
    SPECIES_SPRITE(SLUGMA_GRANITIC, gMonFrontPic_SlugmaGranitic),
    SPECIES_SPRITE(MAGCARGO_GRANITIC, gMonFrontPic_MagcargoGranitic),
    ...
    SPECIES_SPRITE(PYROAR_MEGA, gMonFrontPic_PyroarMega),
    ...
    SPECIES_SPRITE(FLOETTE_MEGA, gMonFrontPic_FloetteMega),
    SPECIES_SPRITE(BARBARACLE_MEGA, gMonFrontPic_BarbaracleMega),
    SPECIES_SPRITE(ZYGARDE_MEGA, gMonFrontPic_ZygardeMega),
    SPECIES_SPRITE(DRAMPA_MEGA, gMonFrontPic_DrampaMega),
    SPECIES_SPRITE(FALINKS_MEGA, gMonFrontPic_FalinksMega),
    SPECIES_SPRITE(HEATRAN_MEGA, gMonFrontPic_HeatranMega),
    SPECIES_SPRITE(DARKRAI_MEGA, gMonFrontPic_DarkraiMega),
    SPECIES_SPRITE(ZERAORA_MEGA, gMonFrontPic_ZeraoraMega),
    ...
    SPECIES_SPRITE(ABSOL_MEGA_Z, gMonFrontPic_AbsolMegaZ),
    SPECIES_SPRITE(STARAPTOR_MEGA, gMonFrontPic_StaraptorMega),
    //SPECIES_SPRITE(GARCHOMP_MEGA_Z, gMonFrontPic_GarchompMegaZ),
    SPECIES_SPRITE(LUCARIO_MEGA_Z, gMonFrontPic_LucarioMegaZ),
    SPECIES_SPRITE(GOLURK_MEGA, gMonFrontPic_GolurkMega),
    SPECIES_SPRITE(MEOWSTIC_M_MEGA, gMonFrontPic_MeowsticMega),
    SPECIES_SPRITE(MEOWSTIC_F_MEGA, gMonFrontPic_MeowsticMega),
    SPECIES_SPRITE(CRABOMINABLE_MEGA, gMonFrontPic_CrabominableMega),
    SPECIES_SPRITE(GOLISOPOD_MEGA, gMonFrontPic_GolisopodMega),
    SPECIES_SPRITE(MAGEARNA_MEGA, gMonFrontPic_MagearnaMega),
    SPECIES_SPRITE(MAGEARNA_ORIGINAL_MEGA, gMonFrontPic_MagearnaOriginalMega),
    SPECIES_SPRITE(SCOVILLAIN_MEGA, gMonFrontPic_ScovillainMega),
    SPECIES_SPRITE(BAXCALIBUR_MEGA, gMonFrontPic_BaxcaliburMega),
    SPECIES_SPRITE(TATSUGIRI_CURLY_MEGA, gMonFrontPic_TatsugiriCurlyMega),
    ...
    SPECIES_SPRITE(MAGEARNA_ORIGINAL, gMonFrontPic_MagearnaOriginalColor),
...
const struct CompressedSpriteSheet gMonFrontPicTableFemale[] =
{
    ...
    SPECIES_SPRITE(BASCULEGION, gMonFrontPic_BasculegionFemale),
