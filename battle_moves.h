const struct BattleMove gBattleMoves[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_CUT] =
    {
        .effect = EFFECT_USER_ALWAYS_CRITICAL_ON_HIT,
        .power = 50,
        .type = TYPE_NORMAL,
        .accuracy = 95,
        .pp = 20,
    ...
    [MOVE_AEROBLAST] =
    {
        ...
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .flags2 = FLAG_WIND_MOVE | FLAG_LIFT_ENTRY_HAZARDS | FLAG_SCENT_MARK_AFFECTED,
        .split = SPLIT_SPECIAL,
        .zMovePower = 180,
        .zMoveEffect = Z_EFFECT_NONE,
    },
    ...
    [MOVE_DRAGON_DANCE] =
    {
        .effect = EFFECT_USER_ATTACK_SPEED_UP_1,
        .power = 0,
        .type = TYPE_DRAGON,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_SHADOW_BLAST] =
    {
        ...
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .flags2 = FLAG_WIND_MOVE | FLAG_LIFT_ENTRY_HAZARDS | FLAG_SHADOW_MOVE | FLAG_SCENT_MARK_AFFECTED,
        .split = SPLIT_SPECIAL,
        .zMovePower = 180,
        .zMoveEffect = Z_EFFECT_NONE,
    },
