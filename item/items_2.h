...
// Valuable items
    ...
    [ITEM_TINY_MUSHROOM] =
    {
        ...
        .price = 500,
        .holdEffect = HOLD_EFFECT_MUSHROOM,
    ...
    [ITEM_RED_NECTAR] =
    {
        ...
        .pocket = POCKET_ITEMS,
            ...
            .secondaryId = FORM_CHANGE_ITEM_USE,
        #else
            .type = ITEM_USE_BAG_MENU,
            .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        #endif
...
// Hold items
    ...
    [ITEM_QUICK_CLAW] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 80,
        .flingAdditionalEffect = INCREASED_PRIORITY,
        .equipSlot = EQUIP_SLOT_1,
    },
    ...
    [ITEM_RAZOR_CLAW] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 80,
        .flingAdditionalEffect = ALWAYS_CRITICAL,
        .equipSlot = EQUIP_SLOT_1,
    },
...
// TMs/HMs
    ...
    [ITEM_TM54_HEAT_CRASH] =
    {
        .name = _("TM54"),
        .itemId = ITEM_TM54_HEAT_CRASH,
        .price = 3000,
    ...
    [ITEM_TM55_BODY_PRESS] =
    {
        .name = _("TM55"),
        .itemId = ITEM_TM55_BODY_PRESS,
        .price = 3000,
    ...
    [ITEM_TM57_BURNING_TERRAIN] =
    {
        .name = _("TM57"),
        .itemId = ITEM_TM57_BURNING_TERRAIN,
        .price = 3000,
    ...
    [ITEM_TM58_NATURE_POWER] =
    {
        .name = _("TM58"),
        .itemId = ITEM_TM58_NATURE_POWER,
        .price = 3000,
    ...
    [ITEM_TM59_NATURAL_GIFT] =
    {
        .name = _("TM59"),
        .itemId = ITEM_TM59_NATURAL_GIFT,
        .price = 3000,
    ...
    [ITEM_TM60_TRI_ATTACK] =
    {
        .name = _("TM60"),
        .itemId = ITEM_TM60_TRI_ATTACK,
        .price = 3000,
    ...
    [ITEM_TM61_WILD_CHARGE] =
    {
        .name = _("TM61"),
        .itemId = ITEM_TM61_WILD_CHARGE,
        .price = 3000,
    ...
    [ITEM_TM62_FROZEN_TERRAIN] =
    {
        .name = _("TM62"),
        .itemId = ITEM_TM62_FROZEN_TERRAIN,
        .price = 3000,
    ...
    [ITEM_TM63_SANDY_TERRAIN] =
    {
        .name = _("TM63"),
        .itemId = ITEM_TM63_SANDY_TERRAIN,
        .price = 3000,
    ...
    [ITEM_TM64_SWAMPY_TERRAIN] =
    {
        .name = _("TM64"),
        .itemId = ITEM_TM64_SWAMPY_TERRAIN,
        .price = 3000,
    ...
    [ITEM_TM67_ZAP_CANNON] =
    {
        .name = _("TM67"),
        .itemId = ITEM_TM67_ZAP_CANNON,
        .price = 3000,
    ...
    [ITEM_TM68_CHILLING_WATER] =
    {
        .name = _("TM68"),
        .itemId = ITEM_TM68_CHILLING_WATER,
        .price = 3000,
...
// New items
    ...
    {
        .name = _("Paralyze Orb"),
        .itemId = ITEM_PARALYZE_ORB,
        .price = 4000,
        .holdEffect = HOLD_EFFECT_PARALYZE_ORB,
        .description = sParalyzeOrbDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Confuse Orb"),
        .itemId = ITEM_CONFUSE_ORB,
        .price = 4000,
        .holdEffect = HOLD_EFFECT_CONFUSE_ORB,
        .description = sConfuseOrbDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Blank Plate"),
        .itemId = ITEM_BLANK_PLATE,
        .price = 1000,
        .holdEffect = HOLD_EFFECT_PLATE,
        .holdEffectParam = 20,
        .description = sBlankPlateDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
    ...
    [ITEM_LEGEND_PLATE] =
    {
        ...
        .price = 1000,
        .holdEffect = HOLD_EFFECT_LEGEND_PLATE,
    ...
    {
        .name = _("Deviolite"),
        .itemId = ITEM_DEVIOLITE,
        .price = 4000,
        .holdEffect = HOLD_EFFECT_DEVIOLITE,
        .holdEffectParam = 50,
        .description = sDevioliteDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 40,
    ...
    [ITEM_SUPPRESSION_HELMET] =
    {
        .name = _("Suppression Helm"),
        .itemId = ITEM_SUPPRESSION_HELMET,
        .price = 4000,
        .holdEffect = HOLD_EFFECT_SUPPRESSION_HELMET,
        .description = sSuppressionHelmetDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 100,
    ...
    [ITEM_DNA_SPLICERS] =
    {
        ...
        #ifdef POKEMON_EXPANSION
            .type = ITEM_USE_PARTY_MENU,
            .fieldUseFunc = ItemUseOutOfBattle_MonFuse,
            .secondaryId = FORM_CHANGE_ITEM_USE,
        #else
            .type = ITEM_USE_BAG_MENU,
            .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
    ...
    [ITEM_DNA_METEORITE] =
    {
        .name = _("DNA Meteorite"),
        .itemId = ITEM_DNA_METEORITE,
        .price = 0,
        .holdEffect = HOLD_EFFECT_DNA_METEORITE,
        .description = sDnaMeteoriteDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_BLACK_TRIANGLE] =
    {
        .name = _("Black Meteorite"),
        .itemId = ITEM_BLACK_TRIANGLE,
        .price = 0,
        .holdEffect = HOLD_EFFECT_DNA_METEORITE,
        .description = sBlackTriangleDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_BlackTriangle,
        .flingPower = 30,
        .equipSlot = EQUIP_SLOT_3,
    },
    ...
    [ITEM_INTRIGUING_STONE] =
    {
        ...
        .price = 3000,
        .holdEffect = 0,
        .description = sIntriguingStoneDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 100,
    ...
    [ITEM_RAINBOW_WING] =
    {
        ...
        .price = 0,
        .holdEffect = HOLD_EFFECT_RAINBOW_WING,
        .holdEffectParam = 5,
    ...
    [ITEM_SILVER_WING] =
    {
        ...
        .price = 0,
        .holdEffect = HOLD_EFFECT_SILVER_WING,
        .holdEffectParam = 5,
    ...
    {
        .name = _("Muramasa"),
        .itemId = ITEM_MURAMASA,
        .price = 0,
        .holdEffect = HOLD_EFFECT_MURAMASA,
        .holdEffectParam = 10,
        .description = sMuramasaDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Masamune"),
        .itemId = ITEM_MASAMUNE,
        .price = 0,
        .holdEffect = HOLD_EFFECT_MASAMUNE,
        .holdEffectParam = 30,
        .description = sMasamuneDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_DRAGON_SLAYER] =
    {
        ...
        .itemId = ITEM_DRAGON_SLAYER,
        .price = 0,
        .holdEffect = HOLD_EFFECT_DRAGON_SLAYER,
        .holdEffectParam = 20,
        .description = sDragonSlayerDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_DRAGON_BREATH] =
    {
        ...
        .itemId = ITEM_DRAGON_BREATH,
        .price = 0,
        .holdEffect = HOLD_EFFECT_DRAGON_BREATH,
        .holdEffectParam = 5,
        .description = sDragonBreathDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_BONE_WAND] =
    {
        ...
        .price = 0,
        .holdEffect = HOLD_EFFECT_BONE_WAND,
        .holdEffectParam = 5,
        .description = sBoneWandDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Skull Ring"),
        .itemId = ITEM_SKULL_RING,
        .price = 0,
        .holdEffect = HOLD_EFFECT_SKULL_RING,
        .holdEffectParam = 10,
        .description = sSkullRingDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_ASSASSIN_DAGGER] =
    {
        .name = _("Assassin Dagger"),
        .itemId = ITEM_ASSASSIN_DAGGER,
        .price = 0,
        .holdEffect = HOLD_EFFECT_ASSASSIN_DAGGER,
        .holdEffectParam = 5,
        .description = sAssassinDaggerDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_GOLDEN_HAMMER] =
    {
        .name = _("Golden Hammer"),
        .itemId = ITEM_GOLDEN_HAMMER,
        .price = 0,
        .holdEffect = HOLD_EFFECT_GOLDEN_HAMMER,
        .description = sGoldenHammerDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_SAFETY_HELMET] =
    {
        .name = _("Safety Helmet"),
        .itemId = ITEM_SAFETY_HELMET,
        .price = 0,
        .holdEffect = HOLD_EFFECT_SAFETY_HELMET,
        .description = sSafetyHelmetDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Poison Knife"),
        .itemId = ITEM_POISON_KNIFE,
        .price = 0,
        .holdEffect = HOLD_EFFECT_POISON_KNIFE,
        .holdEffectParam = 20,
        .description = sPoisonKnifeDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Thief Gloves"),
        .itemId = ITEM_THIEF_GLOVES,
        .price = 0,
        .holdEffect = HOLD_EFFECT_THIEF_GLOVES,
        .holdEffectParam = 5,
        .description = sThiefGlovesDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_STRONG_SHIELD] =
    {
        .name = _("Strong Shield"),
        .itemId = ITEM_STRONG_SHIELD,
        .price = 0,
        .holdEffect = HOLD_EFFECT_STRONG_SHIELD,
        .description = sStrongShieldDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_HEALING_STAFF] =
    {
        .name = _("Healing Staff"),
        .itemId = ITEM_HEALING_STAFF,
        .price = 0,
        .holdEffect = HOLD_EFFECT_HEALING_STAFF,
        .description = sHealingStaffDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Shackles"),
        .itemId = ITEM_SHACKLES,
        .price = 0,
        .holdEffect = HOLD_EFFECT_SHACKLES,
        .holdEffectParam = 30,
        .description = sShacklesDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_WATERDROP_BROOCH] =
    {
        .name = _("Waterdrop Brooch"),
        .itemId = ITEM_WATERDROP_BROOCH,
        .price = 0,
        .holdEffect = HOLD_EFFECT_RESIST_ACCESSORY,
        .holdEffectParam = 5,
        .secondaryId = TYPE_WATER,
        .description = sWaterdropBroochDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    [ITEM_SAKKAT] =
    {
        ...
        .itemId = ITEM_SAKKAT,
        .price = 0,
        .holdEffect = HOLD_EFFECT_SAKKAT,
        .holdEffectParam = 10,
        .description = sSakkatDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Fireblender"),
        .itemId = ITEM_FIREBLENDER,
        .price = 0,
        .holdEffect = HOLD_EFFECT_FIREBLENDER,
        .description = sFireblenderDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
    ...
    {
        .name = _("Ice Falchion"),
        .itemId = ITEM_ICE_FALCHION,
        .price = 0,
        .holdEffect = HOLD_EFFECT_ICE_FALCHION,
        .description = sIceFalchionDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
