...
static const struct InGameTrade sIngameTrades[] =
{
    ...
    [INGAME_TRADE_EAST_SHELLOS] = 
    {
        .nickname = _("Shelly"),
        .species = SPECIES_SHELLOS_EAST_SEA, //SPECIES_SHELLOS_EAST_SEA,
        .ivs = {15, 22, 15, 14, 14, 14},
        .abilityNum = 0, 
        .otId = 38726,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x8B,
        ...
        .otGender = MALE, 
        .sheen = 10,
        .requestedSpecies = SPECIES_SHELLOS
    },
    [INGAME_TRADE_HERDIER] = 
    {
        .nickname = _("Duke"),
    ...
    [INGAME_TRADE_ALOLAN_SANDSHREW] = 
    {
        .nickname = _("Tatuzin"),
        .species = SPECIES_SANDSHREW_ALOLAN,
        .ivs = {5, 28, 31, 18, 18, 21},
        .abilityNum = 2, 
        .otId = 34864,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x82,
    ...
    [INGAME_TRADE_ALOLAN_RAICHU] = 
    {
        .nickname = _("Marquin"),
        .species = SPECIES_RAICHU_ALOLAN,
        .ivs = {25, 23, 15, 24, 20, 10},
        .abilityNum = 0, 
        .otId = 24864,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x89,
    ...
    [INGAME_TRADE_ALOLAN_GEODUDE] = 
    {
        .nickname = _("Rodrigo"),
        .species = SPECIES_GEODUDE_ALOLAN,
        .ivs = {25, 29, 31, 12, 5, 10},
        .abilityNum = 0, 
        .otId = 54864,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x77,
    ...
    [INGAME_TRADE_ALOLAN_MEOWTH] = 
    {
        .nickname = _("Xanin"),
        .species = SPECIES_MEOWTH_ALOLAN,
        .ivs = {23, 28, 18, 31, 5, 25},
        .abilityNum = 0, 
        .otId = 15208,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x70,
    ...
    [INGAME_TRADE_ALOLAN_EXEGGUTOR] = 
    {
        .nickname = _("Palmeiras"),
    ...
    [INGAME_TRADE_ALOLAN_MAROWAK] = 
    {
        .nickname = _("Waka Waka"),
        .species = SPECIES_MAROWAK_ALOLAN,
        .ivs = {23, 31, 31, 31, 5, 25},
        .abilityNum = 0, 
        .otId = 54724,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x70,
    ...
    [INGAME_TRADE_PALDEAN_WOOPER] = 
    {
        .nickname = _("Wup"),
        .species = SPECIES_WOOPER_PALDEAN,
        .ivs = {31, 31, 22, 30, 15, 25},
        .abilityNum = 0, 
        .otId = 74804,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x58,
    ...
    [INGAME_TRADE_POLTHCAGEIST] = 
    {
        .nickname = _("Cha"),
        .species = SPECIES_POLTCHAGEIST,
        .ivs = {30, 5, 23, 30, 31, 28},
        .abilityNum = 0, 
        .otId = 58946,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x51,
        ...
        .otGender = FEMALE, 
        .sheen = 10,
        .requestedSpecies = SPECIES_POLTEAGEIST
    },
    [INGAME_TRADE_WIGGLET] = 
    {
        .nickname = _("Wiggy"),
        .species = SPECIES_WIGLETT,
        .ivs = {16, 31, 23, 31, 31, 28},
        .abilityNum = 0, 
        .otId = 67074,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x51,
    ...
    [INGAME_TRADE_TOEDSCOOL] = 
    {
        .nickname = _("Toad"),
        .species = SPECIES_TOEDSCOOL,
        .ivs = {31, 24, 30, 26, 31, 28},
        .abilityNum = 0, 
        .otId = 68147,
        .conditions = {5, 5, 5, 30, 5},
        .personality = 0x61,
