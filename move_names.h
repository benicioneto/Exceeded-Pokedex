const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_LUNAR_BLESSING] = _("Lunar Blessng"),
    ...
    [MOVE_WATERBURST_SHURIKEN] = _("Waterburst Shur."),
    [MOVE_GATLING_GULP_MISSILE] = _("GatlingGMissile"),
    [MOVE_DEATHROLL] = _("Deathroll"),
    [MOVE_UNDERGROUND_BITE] = _("Underground Bite"),
    [MOVE_INK_JET] = _("Ink Jet"),
    [MOVE_AQUA_TORNADO] = _("Aqua Tornado"),
    [MOVE_TYRANNICAL_RAMPAGE] = _("Tyrannical Ramp."),
    [MOVE_THUNDERSTORM] = _("Thunderstorm"),
    [MOVE_PHANTOM_FOREST] = _("Phantom Forest"),
    [MOVE_REVOLVING_RUIN] = _("Revolving Ruin"),
    [MOVE_RUBBLE_ROUSER] = _("Rubble Rouser"),
    [MOVE_SNOW_GLOBE] = _("Snow Globe"),
    [MOVE_HYDRO_TYPHOON] = _("Hydro Typhoon"),
    [MOVE_BLAZING_BICYCLE_KICK] = _("B. Bicycle Kick"),
    [MOVE_COUP_DE_GRACE] = _("Coup De Grace"),
    [MOVE_FANCIFUL_FIREWORKS] = _("Fancy Fireworks"),
    [MOVE_MOCKING_SHOUT] = _("Mocking Shout"),
    [MOVE_STREAM_IMPULSE] = _("Stream Impulse"),
    [MOVE_SPICY_BREATH] = _("Spicy Breath"),
    [MOVE_DARK_BARGAIN] = _("Dark Bargain"),
    [MOVE_BLOOD_PACT] = _("Blood Pact"),
    [MOVE_FOG] = _("Fog"),
    [MOVE_NEUROTOXIN] = _("Neurotoxin"),
    [MOVE_TOUGH_IT_OUT] = _("Tough It Out"),
    [MOVE_RECKLESS_SWING] = _("Reckless Swing"),
    [MOVE_UNDERTOW] = _("Undertow"),
    [MOVE_PHOENIX_DOWN] = _("Phoenix Down"),
    [MOVE_NONE_SPECIAL] = _("None Special"),
    [MOVE_FOREST_BLESSING] = _("Forest Blessing"),
    [MOVE_FOREST_FURY] = _("Forest Fury"),
    [MOVE_CRAFTY_CLOTHES] = _("Crafty Clothes"),
    [MOVE_DRAGON_COMBO] = _("Dragon Combo"),
    [MOVE_KI_EXPLOSION] = _("Ki Explosion"),
    [MOVE_HELL_GATE] = _("Hell Gate"),
    ...
    [MOVE_AURORA_DANCE] = _("Aurora Dance"),
    ...
    [MOVE_ZANTETSUKEN] = _("Zantetsuken"),
    [MOVE_DROP_WEIGHTS] = _("Drop Weights"),
    [MOVE_COMPUTE_AND_CRUSH] = _("Compute & Crush"),
    [MOVE_IGNITE_MIDNIGHT] = _("Ignite Midnight"),
    [MOVE_COTTON_CLOUD_CRASH] = _("Cotton Cloud Cr."),
    [MOVE_MOONLIGHT_PRANCE] = _("Moonlight Prance"),
    [MOVE_TRIPLE_TRAMPLE] = _("Triple Trample"),
    [MOVE_DREEP_AND_DESTROY] = _("Dreep & Destroy"),
    [MOVE_INFINITE_PSYBURN] = _("Infinite Psyburn"),
    [MOVE_SOVEREIGN_SWORD] = _("Sovereign Sword"),
    [MOVE_AZURE_SPY_VISION] = _("Azure Spy Vision"),
    [MOVE_MYSTICAL_MIRAGE] = _("Mystical Mirage"),
    [MOVE_SLOWBEAM] = _("Slowbeam"),
    [MOVE_NIGHTFALL_DAZE] = _("Nightfall Daze"),
    [MOVE_SPINNING_FLAME_FIST] = _("Spinning F. Fist"),
    [MOVE_SPINNING_FLAME_KICK] = _("Spinning F. Kick"),
    [MOVE_GLACIAL_STAGE] = _("Glacial Stage"),
    [MOVE_LAPRAS_EXPRESS] = _("Lapras Express"),
    [MOVE_FLOWERY_FIELDS_FOREVER] = _("Flowery Forever"),
    [MOVE_GREEN_ILLUSION_DIVE] = _("Green Illusion D"),
    [MOVE_RED_ILLUSION_DIVE] = _("Red Illusion Di."),
    [MOVE_EMERALD_TWO_STEP] = _("Emerald Two Step"),
    [MOVE_FAIRY_FROLIC] = _("Fairy Frolic"),
    [MOVE_EBON_FIST] = _("Ebon Fist"),
    [MOVE_FLOWING_FISTS] = _("Flowing Fists"),
    [MOVE_PSYCHIC_SOLAIRE] = _("Psychic Solaire"),
    [MOVE_RIGHT_AS_RAIN] = _("Right As Rain"),
    [MOVE_SHOWTIME] = _("Showtime"),
    [MOVE_PLASMA_GALE] = _("Plasma Gale"),
    ...
    [MOVE_MARRIAGETOXIN] = _("Marriagetoxin"),
    [MOVE_MASSIVE_BLOOM] = _("Massive Bloom"),
    [MOVE_ALLERGIC_EXPLOSION] = _("Allergic Explos."),
    [MOVE_STEAM_CRUSH] = _("Steam Crush"),
    [MOVE_GUARD_PRESS] = _("Guard Press"),
    [MOVE_IMPROVISED_BLOW] = _("Improvised Blow"),
    [MOVE_BLACK_SHROUD] = _("Black Shroud"),
    [MOVE_COMBUSTION] = _("Combustion"),
    [MOVE_ABSORB_INTELLECT] = _("Absorb Intellect"),
    [MOVE_SMASHING_PUMPKINS] = _("SmashingPumpkins"),
    [MOVE_FIRE_WALL] = _("Fire Wall"),
    [MOVE_SEAWEED_SNARE] = _("Seaweed Snare"),
    [MOVE_SOVEREIGN_SLIDE] = _("Sovereign Slide"),
    [MOVE_TRIAD_BLITZ] = _("Triad Blitz"),
    [MOVE_KISS_BLISS_KABOOM] = _("KissBliss Kaboom"),
    [MOVE_FULL_POWER_PSY_AY_AY] = _("Full Power Psy"),
    [MOVE_COLOSSEUM_TERRAIN] = _("ColosseumTerrain"),
    [MOVE_DRACONIC_TERRAIN] = _("Draconic Terrain"),
    [MOVE_WORST_NIGHTMARE] = _("Worst Nightmare"),
    [MOVE_HIGH_VOLTAGE_SIEGE] = _("HighVoltageSiege"),
    [MOVE_ULTRA_SWOLE_SLAM] = _("Ultra Swole Slam"),
    [MOVE_EXPLOSIVE_HEAT_HAZE] = _("ExplosivHeatHaze"),
    [MOVE_VERDANT_ANGER] = _("Verdant Anger"),
    [MOVE_RENEVANT_REND] = _("Renevant Rend"),
    [MOVE_PSYKABOOM] = _("Psykaboom"),
    [MOVE_ICE_WING_WHITEOUT] = _("IceWing Whiteout"),
    [MOVE_MIST_BLAST] = _("Mist Blast"),
    [MOVE_EON_BLAST] = _("Eon Blast"),
    [MOVE_FIREBIRD_INFERNO] = _("Firebird Inferno"),
    [MOVE_FLUFFY_CREAM_SUPREME] = _("Fluffy Cream"),
    [MOVE_LUNGING_LEEK_NOVA] = _("Lunging LeekNova"),
    [MOVE_AQUAMARINE_SPLASH] = _("AquamarineSplash"),
    [MOVE_INVERSE_ROOM] = _("Inverse Room"),
    [MOVE_WEIGHT_ROOM] = _("Weight Room"),
    [MOVE_AVERAGE_ROOM] = _("Average Room"),
    [MOVE_DINNER_ROOM] = _("Dinner Room"),
    [MOVE_LIVING_ROOM] = _("Living Room"),
    [MOVE_NULL_ROOM] = _("Null Room"),
    [MOVE_BONE_LUNGE] = _("Bone Lunge"),
    [MOVE_SOBERING_PUNCH] = _("Sobering Punch"),
    [MOVE_OASIS_WELLSPRING] = _("Oasis Wellspring"),
    [MOVE_CROWSTORM] = _("Crowstorm"),
    [MOVE_SKYROCKET_BLAST] = _("Skyrocket Blast"),
    [MOVE_IRON_CAGE] = _("Iron Cage"),
    [MOVE_DEHYDRATE] = _("Dehydrate"),
    [MOVE_KUNG_FU_HUSTLE] = _("Kung Fu Hustle"),
    [MOVE_MILK_SHOT] = _("Milk Shot"),
    [MOVE_ANCIENT_WINGS] = _("Ancient Wings"),
    [MOVE_ANCIENT_SHELL] = _("Ancient Shell"),
    [MOVE_ANCIENT_SLASH] = _("Ancient Slash"),
    [MOVE_ANCIENT_WEED] = _("Ancient Weed"),
    [MOVE_ANCIENT_CHARGE] = _("Ancient Charge"),
    [MOVE_ANCIENT_MAW] = _("Ancient Maw"),
    [MOVE_ANCIENT_ICE] = _("Ancient Ice"),
    [MOVE_ICE_JAVELIN] = _("Ice Javelin"),
    [MOVE_COTTON_PUNCH] = _("Cotton Punch"),
    [MOVE_MANDRAGORA_HOWL] = _("Mandragora Howl"),
    [MOVE_ELEMENTAL_PUNCH] = _("Elemental Punch"),
    [MOVE_HONE_HORNS] = _("Hone Horns"),
    [MOVE_LICK_WOUNDS] = _("Lick Wounds"),
    [MOVE_TONGUE_FLURRY] = _("Tongue Flurry"),
    [MOVE_MEGA_LICK] = _("Mega Lick"),
    [MOVE_FULL_MOON_KICK] = _("Full Moon Kick"),
    [MOVE_NEW_MOON_KICK] = _("New Moon Kick"),
    [MOVE_PITCH_NOISE] = _("Pitch Noise"),
    [MOVE_SWEET_BITE] = _("Sweet Bite"),
    [MOVE_CHILLING_WHISP] = _("Chilling Whisp"),
    [MOVE_GREEK_GIFT] = _("Greek Gift"),
    [MOVE_HUNGRY_FEAST] = _("Hungry Feast"),
    [MOVE_RAVENOUS_BITE] = _("Ravenous Bite"),
    [MOVE_CORAL_FILTER] = _("Coral Filter"),
    [MOVE_DESTRUCTIVE_DRILL] = _("DestructiveDrill"),
    [MOVE_COMET] = _("Comet"),
    [MOVE_CATACLYSM] = _("Cataclysm"),
    [MOVE_PILLAGE] = _("Pillage"),
    [MOVE_DISRUPT] = _("Disrupt"),
    [MOVE_BRAINSTORM] = _("Brainstorm"),
    [MOVE_SWARM_PUNCH] = _("Swarm Punch"),
    [MOVE_FRIED_EGG] = _("Fried Egg"),
    [MOVE_SPOILED_EGG] = _("Spoiled Egg"),
    [MOVE_EGG_DROP] = _("Egg Drop"),
    [MOVE_FOSSIL_EGG] = _("Fossil Egg"),
    [MOVE_DRAGON_EGG] = _("Dragon Egg"),
    [MOVE_FLYTRAP_BITE] = _("Flytrap Bite"),
    ...
    [MOVE_WINTER_TIME] = _("Winter Time"),
    [MOVE_DEFLORESTATION] = _("Deflorestation"),
    [MOVE_STONE_WALL] = _("Stone Wall"),
    [MOVE_SCRAPYARD_TERRAIN] = _("ScrapyardTerrain"),
    [MOVE_ICY_KISS] = _("Icy Kiss"),
    ...
    [MOVE_SPECIAL_PHARMACY] = _("Special Pharmacy"),
    [MOVE_PSYTRICK] = _("Psytrick"),
    [MOVE_DAZE_BARRAGE] = _("Daze Barrage"),
    [MOVE_BULL_RUSH] = _("Bull Rush"),
    [MOVE_GATHER_LIGHT] = _("Gather Light"),
    [MOVE_PHOTON_CUT] = _("Photon Cut"),
    [MOVE_MATTER_RUPTURE] = _("Matter Rupture"),
    [MOVE_DEEPSEA_RIFT] = _("Deepsea Rift"),
    [MOVE_CHRONO_GEAR] = _("Chrono Gear"),
    [MOVE_FULL_BLOOM_AROMA] = _("Full Bloom Aroma"),
