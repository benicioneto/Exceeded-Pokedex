const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_URSARING]              = {{EVO_ITEM_USE_NIGHT, ITEM_PEAT_BLOCK, SPECIES_URSALUNA}},
    ...
    [SPECIES_ROCKRUFF_OWN_TEMPO]    = {{EVO_LEVEL_OWN_TEMPO_DUSK, 25, SPECIES_LYCANROC_DUSK},
                                       {EVO_LEVEL_VITAL_SPIRIT_DAY, 25, SPECIES_LYCANROC},
                                       {EVO_LEVEL_INSOMNIA_NIGHT, 25, SPECIES_LYCANROC_MIDNIGHT}},
    ...
    [SPECIES_QWILFISH_HISUIAN]      = {{EVO_MOVE_COUNT, 10, SPECIES_OVERQWIL}},
    [SPECIES_STANTLER]              = {{EVO_MOVE_COUNT, 10, SPECIES_WYRDEER}},
    [SPECIES_SNEASEL_HISUIAN]       = {{EVO_ITEM_HOLD_DAY, ITEM_RAZOR_CLAW, SPECIES_SNEASLER}},
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_RECOIL_DMG, 294, SPECIES_BASCULEGION}},
