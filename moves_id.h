...
//Custom moves
#define MOVES_COUNT_LAST_GEN (MOVES_COUNT_GEN9)
#define MOVE_KINGS_GRACE (MOVES_COUNT_LAST_GEN + 0)
#define MOVE_FROZEN_TERRAIN (MOVES_COUNT_LAST_GEN + 1)
#define MOVE_CURSED_TERRAIN (MOVES_COUNT_LAST_GEN + 2)
#define MOVE_RAVINE_TERRAIN (MOVES_COUNT_LAST_GEN + 3)
#define MOVE_BURNING_TERRAIN (MOVES_COUNT_LAST_GEN + 4)
#define MOVE_SANDY_TERRAIN (MOVES_COUNT_LAST_GEN + 5)
#define MOVE_SWAMP_TERRAIN (MOVES_COUNT_LAST_GEN + 6)
#define MOVE_VENOMOUS_TERRAIN (MOVES_COUNT_LAST_GEN + 7)
#define MOVE_ROSE_WHIP (MOVES_COUNT_LAST_GEN + 8)
#define MOVE_GEOGEYSER (MOVES_COUNT_LAST_GEN + 9)
#define MOVE_FEATHER_SHOT (MOVES_COUNT_LAST_GEN + 10)
#define MOVE_WITCHCRAFT (MOVES_COUNT_LAST_GEN + 11)
#define MOVE_EXCALIBUR (MOVES_COUNT_LAST_GEN + 12)
#define MOVE_SHIELD_BASH (MOVES_COUNT_LAST_GEN + 13)
#define MOVE_DRAGON_BONE (MOVES_COUNT_LAST_GEN + 14)
#define MOVE_DRACO_IMPACT (MOVES_COUNT_LAST_GEN + 15)
#define MOVE_WARM_UP (MOVES_COUNT_LAST_GEN + 16)
#define MOVE_CHRISTMAS_GIFT (MOVES_COUNT_LAST_GEN + 17)
#define MOVE_ARTIC_GLIDE (MOVES_COUNT_LAST_GEN + 18)
#define MOVE_COIN_SHOWER (MOVES_COUNT_LAST_GEN + 19)
#define MOVE_MAMMOTH_MASH (MOVES_COUNT_LAST_GEN + 20)
#define MOVE_BERRY_BELLY_FLOP (MOVES_COUNT_LAST_GEN + 21)
#define MOVE_NAP_SLAM (MOVES_COUNT_LAST_GEN + 22)
#define MOVE_POWER_NAP (MOVES_COUNT_LAST_GEN + 23)
#define MOVE_SEISMIC_SLAM (MOVES_COUNT_LAST_GEN + 24)
#define MOVE_BARRAGE_BLOW (MOVES_COUNT_LAST_GEN + 25)
#define MOVE_QUEEN_ASCENDANT (MOVES_COUNT_LAST_GEN + 26)
#define MOVE_LIVID_OUTRAGE (MOVES_COUNT_LAST_GEN + 27)
#define MOVE_AURA_CANNON (MOVES_COUNT_LAST_GEN + 28)
#define MOVE_RINGS_UNBOUND (MOVES_COUNT_LAST_GEN + 29)
#define MOVE_NOCK_LOCK (MOVES_COUNT_LAST_GEN + 30)
#define MOVE_BLISS_ASSISTANCE (MOVES_COUNT_LAST_GEN + 31)
#define MOVE_FAIRY_SINGULARITY (MOVES_COUNT_LAST_GEN + 32)
#define MOVE_MIDNIGHT_SLASH (MOVES_COUNT_LAST_GEN + 33)
#define MOVE_PHANTOM_AMBUSH (MOVES_COUNT_LAST_GEN + 34)
#define MOVE_FLAME_SWEEP (MOVES_COUNT_LAST_GEN + 35)
#define MOVE_WATERBURST_SHURIKEN (MOVES_COUNT_LAST_GEN + 36)
#define MOVE_GATLING_GULP_MISSILE (MOVES_COUNT_LAST_GEN + 37)
#define MOVE_DEATHROLL (MOVES_COUNT_LAST_GEN + 38)
#define MOVE_UNDERGROUND_BITE (MOVES_COUNT_LAST_GEN + 39)
#define MOVE_INK_JET (MOVES_COUNT_LAST_GEN + 40)
#define MOVE_AQUA_TORNADO (MOVES_COUNT_LAST_GEN + 41)
#define MOVE_TYRANNICAL_RAMPAGE (MOVES_COUNT_LAST_GEN + 42)
#define MOVE_THUNDERSTORM (MOVES_COUNT_LAST_GEN + 43)
#define MOVE_PHANTOM_FOREST (MOVES_COUNT_LAST_GEN + 44)
#define MOVE_REVOLVING_RUIN (MOVES_COUNT_LAST_GEN + 45)
#define MOVE_RUBBLE_ROUSER (MOVES_COUNT_LAST_GEN + 46)
#define MOVE_SNOW_GLOBE (MOVES_COUNT_LAST_GEN + 47)
#define MOVE_HYDRO_TYPHOON (MOVES_COUNT_LAST_GEN + 48)
#define MOVE_BLAZING_BICYCLE_KICK (MOVES_COUNT_LAST_GEN + 49)
#define MOVE_COUP_DE_GRACE (MOVES_COUNT_LAST_GEN + 50)
#define MOVE_FANCIFUL_FIREWORKS (MOVES_COUNT_LAST_GEN + 51)
#define MOVE_MOCKING_SHOUT (MOVES_COUNT_LAST_GEN + 52)
#define MOVE_STREAM_IMPULSE (MOVES_COUNT_LAST_GEN + 53)
#define MOVE_SPICY_BREATH (MOVES_COUNT_LAST_GEN + 54)
#define MOVE_DARK_BARGAIN (MOVES_COUNT_LAST_GEN + 55)
#define MOVE_BLOOD_PACT (MOVES_COUNT_LAST_GEN + 56)
#define MOVE_FOG (MOVES_COUNT_LAST_GEN + 57)
#define MOVE_NEUROTOXIN (MOVES_COUNT_LAST_GEN + 58)
#define MOVE_TOUGH_IT_OUT (MOVES_COUNT_LAST_GEN + 59)
#define MOVE_RECKLESS_SWING (MOVES_COUNT_LAST_GEN + 60)
#define MOVE_UNDERTOW (MOVES_COUNT_LAST_GEN + 61)
#define MOVE_PHOENIX_DOWN (MOVES_COUNT_LAST_GEN + 62)
#define MOVE_NONE_SPECIAL (MOVES_COUNT_LAST_GEN + 63)
#define MOVE_FOREST_BLESSING (MOVES_COUNT_LAST_GEN + 64)
#define MOVE_FOREST_FURY (MOVES_COUNT_LAST_GEN + 65)
#define MOVE_CRAFTY_CLOTHES (MOVES_COUNT_LAST_GEN + 66)
#define MOVE_DRAGON_COMBO (MOVES_COUNT_LAST_GEN + 67)
#define MOVE_KI_EXPLOSION (MOVES_COUNT_LAST_GEN + 68)
#define MOVE_HELL_GATE (MOVES_COUNT_LAST_GEN + 69)
#define MOVE_CORDYCEPS (MOVES_COUNT_LAST_GEN + 70)
#define MOVE_AQUA_FANG (MOVES_COUNT_LAST_GEN + 71)
#define MOVE_BLOOMSDAY (MOVES_COUNT_LAST_GEN + 72)
#define MOVE_QUAKE_HAMMER (MOVES_COUNT_LAST_GEN + 73)
#define MOVE_HOME_RUN (MOVES_COUNT_LAST_GEN + 74)
#define MOVE_HELLBLAZE (MOVES_COUNT_LAST_GEN + 75)
#define MOVE_DIAMOND_DUST (MOVES_COUNT_LAST_GEN + 76)
#define MOVE_MOONFALL (MOVES_COUNT_LAST_GEN + 77)
#define MOVE_FALLING_STARS (MOVES_COUNT_LAST_GEN + 78)
#define MOVE_ALI_SHUFFLE (MOVES_COUNT_LAST_GEN + 79)
#define MOVE_ATOMIC_BREATH (MOVES_COUNT_LAST_GEN + 80)
#define MOVE_PROTON_SCREAM (MOVES_COUNT_LAST_GEN + 81)
#define MOVE_FORCE_CHOKE (MOVES_COUNT_LAST_GEN + 82)
#define MOVE_FORCE_LIGHTNING (MOVES_COUNT_LAST_GEN + 83)
#define MOVE_TRASH (MOVES_COUNT_LAST_GEN + 84)
#define MOVE_HEAT_SIPHON (MOVES_COUNT_LAST_GEN + 85)
#define MOVE_DESPAIR_KISS (MOVES_COUNT_LAST_GEN + 86)
#define MOVE_AURORA_DANCE (MOVES_COUNT_LAST_GEN + 87)
#define MOVE_MUSTARD_GAS (MOVES_COUNT_LAST_GEN + 88)
#define MOVE_ABSOLUTE_ZERO (MOVES_COUNT_LAST_GEN + 89)
#define MOVE_FIRE_IN_THE_HOLE (MOVES_COUNT_LAST_GEN + 90)
#define MOVE_BAD_BREATH (MOVES_COUNT_LAST_GEN + 91)
#define MOVE_WATER_BALL (MOVES_COUNT_LAST_GEN + 92)
#define MOVE_DRAGON_FANG (MOVES_COUNT_LAST_GEN + 93)
#define MOVE_BELLY_BASH (MOVES_COUNT_LAST_GEN + 94)
#define MOVE_FORCE_HEALING (MOVES_COUNT_LAST_GEN + 95)
#define MOVE_SHADOW_STORM (MOVES_COUNT_LAST_GEN + 96)
#define MOVE_SHADOW_CHILL (MOVES_COUNT_LAST_GEN + 97)
#define MOVE_SHADOW_FIRE (MOVES_COUNT_LAST_GEN + 98)
#define MOVE_SHADOW_BOLT (MOVES_COUNT_LAST_GEN + 99)
#define MOVE_SHADOW_BLAST (MOVES_COUNT_LAST_GEN + 100)
#define MOVE_SHADOW_END (MOVES_COUNT_LAST_GEN + 101)
#define MOVE_DARK_HARVEST (MOVES_COUNT_LAST_GEN + 102)
#define MOVE_BLACK_MAGIC (MOVES_COUNT_LAST_GEN + 103)
#define MOVE_JUSTICE_KICK (MOVES_COUNT_LAST_GEN + 104)
#define MOVE_SOUL_BLADES (MOVES_COUNT_LAST_GEN + 105)
#define MOVE_CONVERGENCE (MOVES_COUNT_LAST_GEN + 106)
#define MOVE_TWIN_BITE (MOVES_COUNT_LAST_GEN + 107)
#define MOVE_PUNISHING_KICK (MOVES_COUNT_LAST_GEN + 108)
#define MOVE_FLYING_SIDE_KICK (MOVES_COUNT_LAST_GEN + 109)
#define MOVE_SOUL_ENERGY (MOVES_COUNT_LAST_GEN + 110)
#define MOVE_JACK_O_LANTERN (MOVES_COUNT_LAST_GEN + 111)
#define MOVE_EERIE_TUNE (MOVES_COUNT_LAST_GEN + 112)
#define MOVE_HALLOWEEN (MOVES_COUNT_LAST_GEN + 113)
#define MOVE_DOUBLE_LARIAT (MOVES_COUNT_LAST_GEN + 114)
#define MOVE_WONDER_WISH (MOVES_COUNT_LAST_GEN + 115)
#define MOVE_PLAY_WITH_ME (MOVES_COUNT_LAST_GEN + 116)
#define MOVE_BACK_STAB (MOVES_COUNT_LAST_GEN + 117)
#define MOVE_THORN_TRAP (MOVES_COUNT_LAST_GEN + 118)
#define MOVE_DONDOZO_BITE (MOVES_COUNT_LAST_GEN + 119)
#define MOVE_ZANTETSUKEN (MOVES_COUNT_LAST_GEN + 120)
#define MOVE_DROP_WEIGHTS (MOVES_COUNT_LAST_GEN + 121)
#define MOVE_COMPUTE_AND_CRUSH (MOVES_COUNT_LAST_GEN + 122)
#define MOVE_IGNITE_MIDNIGHT (MOVES_COUNT_LAST_GEN + 123)
#define MOVE_COTTON_CLOUD_CRASH (MOVES_COUNT_LAST_GEN + 124)
#define MOVE_MOONLIGHT_PRANCE (MOVES_COUNT_LAST_GEN + 125)
#define MOVE_TRIPLE_TRAMPLE (MOVES_COUNT_LAST_GEN + 126)
#define MOVE_DREEP_AND_DESTROY (MOVES_COUNT_LAST_GEN + 127)
#define MOVE_INFINITE_PSYBURN (MOVES_COUNT_LAST_GEN + 128)
#define MOVE_SOVEREIGN_SWORD (MOVES_COUNT_LAST_GEN + 129)
#define MOVE_AZURE_SPY_VISION (MOVES_COUNT_LAST_GEN + 130)
#define MOVE_MYSTICAL_MIRAGE (MOVES_COUNT_LAST_GEN + 131)
#define MOVE_SLOWBEAM (MOVES_COUNT_LAST_GEN + 132)
#define MOVE_NIGHTFALL_DAZE (MOVES_COUNT_LAST_GEN + 133)
#define MOVE_SPINNING_FLAME_FIST (MOVES_COUNT_LAST_GEN + 134)
#define MOVE_SPINNING_FLAME_KICK (MOVES_COUNT_LAST_GEN + 135)
#define MOVE_GLACIAL_STAGE (MOVES_COUNT_LAST_GEN + 136)
#define MOVE_LAPRAS_EXPRESS (MOVES_COUNT_LAST_GEN + 137)
#define MOVE_FLOWERY_FIELDS_FOREVER (MOVES_COUNT_LAST_GEN + 138)
#define MOVE_GREEN_ILLUSION_DIVE (MOVES_COUNT_LAST_GEN + 139)
#define MOVE_RED_ILLUSION_DIVE (MOVES_COUNT_LAST_GEN + 140)
#define MOVE_EMERALD_TWO_STEP (MOVES_COUNT_LAST_GEN + 141)
#define MOVE_FAIRY_FROLIC (MOVES_COUNT_LAST_GEN + 142)
#define MOVE_EBON_FIST (MOVES_COUNT_LAST_GEN + 143)
#define MOVE_FLOWING_FISTS (MOVES_COUNT_LAST_GEN + 144)
#define MOVE_PSYCHIC_SOLAIRE (MOVES_COUNT_LAST_GEN + 145)
#define MOVE_RIGHT_AS_RAIN (MOVES_COUNT_LAST_GEN + 146)
#define MOVE_SHOWTIME (MOVES_COUNT_LAST_GEN + 147)
#define MOVE_PLASMA_GALE (MOVES_COUNT_LAST_GEN + 148)
#define MOVE_CHAOS_GLOWER (MOVES_COUNT_LAST_GEN + 149)
#define MOVE_STARLIGHT_RECITAL (MOVES_COUNT_LAST_GEN + 150)
#define MOVE_FLORAL_FLOURISH (MOVES_COUNT_LAST_GEN + 151)
#define MOVE_MOONY_NIGHT (MOVES_COUNT_LAST_GEN + 152)
#define MOVE_LEGEND_POWER (MOVES_COUNT_LAST_GEN + 153)
#define MOVE_DRAGON_CURRENT (MOVES_COUNT_LAST_GEN + 154)
#define MOVE_PSYSHIELD (MOVES_COUNT_LAST_GEN + 155)
#define MOVE_MIDNIGHT_BEAM (MOVES_COUNT_LAST_GEN + 156)
#define MOVE_BANSHEES_CRY (MOVES_COUNT_LAST_GEN + 157)
#define MOVE_POLLINATION_TERRAIN (MOVES_COUNT_LAST_GEN + 158)
#define MOVE_MARRIAGETOXIN (MOVES_COUNT_LAST_GEN + 159)
#define MOVE_MASSIVE_BLOOM (MOVES_COUNT_LAST_GEN + 160)
#define MOVE_ALLERGIC_EXPLOSION (MOVES_COUNT_LAST_GEN + 161)
#define MOVE_STEAM_CRUSH (MOVES_COUNT_LAST_GEN + 162)
#define MOVE_GUARD_PRESS (MOVES_COUNT_LAST_GEN + 163)
#define MOVE_IMPROVISED_BLOW (MOVES_COUNT_LAST_GEN + 164)
#define MOVE_BLACK_SHROUD (MOVES_COUNT_LAST_GEN + 165)
#define MOVE_COMBUSTION (MOVES_COUNT_LAST_GEN + 166)
#define MOVE_ABSORB_INTELLECT (MOVES_COUNT_LAST_GEN + 167)
#define MOVE_SMASHING_PUMPKINS (MOVES_COUNT_LAST_GEN + 168)
#define MOVE_FIRE_WALL (MOVES_COUNT_LAST_GEN + 169)
#define MOVE_SEAWEED_SNARE (MOVES_COUNT_LAST_GEN + 170)
#define MOVE_SOVEREIGN_SLIDE (MOVES_COUNT_LAST_GEN + 171)
#define MOVE_TRIAD_BLITZ (MOVES_COUNT_LAST_GEN + 172)
#define MOVE_KISS_BLISS_KABOOM (MOVES_COUNT_LAST_GEN + 173)
#define MOVE_FULL_POWER_PSY_AY_AY (MOVES_COUNT_LAST_GEN + 174)
#define MOVE_COLOSSEUM_TERRAIN (MOVES_COUNT_LAST_GEN + 175)
#define MOVE_DRACONIC_TERRAIN (MOVES_COUNT_LAST_GEN + 176)
#define MOVE_WORST_NIGHTMARE (MOVES_COUNT_LAST_GEN + 177)
#define MOVE_HIGH_VOLTAGE_SIEGE (MOVES_COUNT_LAST_GEN + 178)
#define MOVE_ULTRA_SWOLE_SLAM (MOVES_COUNT_LAST_GEN + 179)
#define MOVE_EXPLOSIVE_HEAT_HAZE (MOVES_COUNT_LAST_GEN + 180)
#define MOVE_VERDANT_ANGER (MOVES_COUNT_LAST_GEN + 181)
#define MOVE_RENEVANT_REND (MOVES_COUNT_LAST_GEN + 182)
#define MOVE_PSYKABOOM (MOVES_COUNT_LAST_GEN + 183)
#define MOVE_ICE_WING_WHITEOUT (MOVES_COUNT_LAST_GEN + 184)
#define MOVE_MIST_BLAST (MOVES_COUNT_LAST_GEN + 185)
#define MOVE_EON_BLAST (MOVES_COUNT_LAST_GEN + 186)
#define MOVE_FIREBIRD_INFERNO (MOVES_COUNT_LAST_GEN + 187)
#define MOVE_FLUFFY_CREAM_SUPREME (MOVES_COUNT_LAST_GEN + 188)
#define MOVE_LUNGING_LEEK_NOVA (MOVES_COUNT_LAST_GEN + 189)
#define MOVE_AQUAMARINE_SPLASH (MOVES_COUNT_LAST_GEN + 190)
#define MOVE_INVERSE_ROOM (MOVES_COUNT_LAST_GEN + 191)
#define MOVE_WEIGHT_ROOM (MOVES_COUNT_LAST_GEN + 192)
#define MOVE_AVERAGE_ROOM (MOVES_COUNT_LAST_GEN + 193)
#define MOVE_DINNER_ROOM (MOVES_COUNT_LAST_GEN + 194)
#define MOVE_LIVING_ROOM (MOVES_COUNT_LAST_GEN + 195)
#define MOVE_NULL_ROOM (MOVES_COUNT_LAST_GEN + 196)
#define MOVE_BONE_LUNGE (MOVES_COUNT_LAST_GEN + 197)
#define MOVE_SOBERING_PUNCH (MOVES_COUNT_LAST_GEN + 198)
#define MOVE_OASIS_WELLSPRING (MOVES_COUNT_LAST_GEN + 199)
#define MOVE_CROWSTORM (MOVES_COUNT_LAST_GEN + 200)
#define MOVE_SKYROCKET_BLAST (MOVES_COUNT_LAST_GEN + 201)
#define MOVE_IRON_CAGE (MOVES_COUNT_LAST_GEN + 202)
#define MOVE_DEHYDRATE (MOVES_COUNT_LAST_GEN + 203)
#define MOVE_KUNG_FU_HUSTLE (MOVES_COUNT_LAST_GEN + 204)
#define MOVE_MILK_SHOT (MOVES_COUNT_LAST_GEN + 205)
#define MOVE_ANCIENT_WINGS (MOVES_COUNT_LAST_GEN + 206)
#define MOVE_ANCIENT_SHELL (MOVES_COUNT_LAST_GEN + 207)
#define MOVE_ANCIENT_SLASH (MOVES_COUNT_LAST_GEN + 208)
#define MOVE_ANCIENT_WEED (MOVES_COUNT_LAST_GEN + 209)
#define MOVE_ANCIENT_CHARGE (MOVES_COUNT_LAST_GEN + 210)
#define MOVE_ANCIENT_MAW (MOVES_COUNT_LAST_GEN + 211)
#define MOVE_ANCIENT_ICE (MOVES_COUNT_LAST_GEN + 212)
#define MOVE_ICE_JAVELIN (MOVES_COUNT_LAST_GEN + 213)
#define MOVE_COTTON_PUNCH (MOVES_COUNT_LAST_GEN + 214)
#define MOVE_MANDRAGORA_HOWL (MOVES_COUNT_LAST_GEN + 215)
#define MOVE_ELEMENTAL_PUNCH (MOVES_COUNT_LAST_GEN + 216)
#define MOVE_HONE_HORNS (MOVES_COUNT_LAST_GEN + 217)
#define MOVE_LICK_WOUNDS (MOVES_COUNT_LAST_GEN + 218)
#define MOVE_TONGUE_FLURRY (MOVES_COUNT_LAST_GEN + 219)
#define MOVE_MEGA_LICK (MOVES_COUNT_LAST_GEN + 220)
#define MOVE_FULL_MOON_KICK (MOVES_COUNT_LAST_GEN + 221)
#define MOVE_NEW_MOON_KICK (MOVES_COUNT_LAST_GEN + 222)
#define MOVE_PITCH_NOISE (MOVES_COUNT_LAST_GEN + 223)
#define MOVE_SWEET_BITE (MOVES_COUNT_LAST_GEN + 224)
#define MOVE_CHILLING_WHISP (MOVES_COUNT_LAST_GEN + 225)
#define MOVE_GREEK_GIFT (MOVES_COUNT_LAST_GEN + 226)
#define MOVE_HUNGRY_FEAST (MOVES_COUNT_LAST_GEN + 227)
#define MOVE_RAVENOUS_BITE (MOVES_COUNT_LAST_GEN + 228)
#define MOVE_CORAL_FILTER (MOVES_COUNT_LAST_GEN + 229)
#define MOVE_DESTRUCTIVE_DRILL (MOVES_COUNT_LAST_GEN + 230)
#define MOVE_COMET (MOVES_COUNT_LAST_GEN + 231)
#define MOVE_CATACLYSM (MOVES_COUNT_LAST_GEN + 232)
#define MOVE_PILLAGE (MOVES_COUNT_LAST_GEN + 233)
#define MOVE_DELIBIRD_RIDE (MOVES_COUNT_LAST_GEN + 234)
#define MOVE_DISRUPT (MOVES_COUNT_LAST_GEN + 235)
#define MOVE_BRAINSTORM (MOVES_COUNT_LAST_GEN + 236)
#define MOVE_SWARM_PUNCH (MOVES_COUNT_LAST_GEN + 237)
#define MOVE_FRIED_EGG (MOVES_COUNT_LAST_GEN + 238)
#define MOVE_SPOILED_EGG (MOVES_COUNT_LAST_GEN + 239)
#define MOVE_EGG_DROP (MOVES_COUNT_LAST_GEN + 240)
#define MOVE_FOSSIL_EGG (MOVES_COUNT_LAST_GEN + 241)
#define MOVE_DRAGON_EGG (MOVES_COUNT_LAST_GEN + 242)
#define MOVE_FLYTRAP_BITE (MOVES_COUNT_LAST_GEN + 243)
#define MOVE_ACIDIC_MAW (MOVES_COUNT_LAST_GEN + 244)
#define MOVE_NECTAR_SIPHON (MOVES_COUNT_LAST_GEN + 245)
#define MOVE_HEAT_ARMOR (MOVES_COUNT_LAST_GEN + 246)
#define MOVE_SIRENS_MELODY (MOVES_COUNT_LAST_GEN + 247)
#define MOVE_CHRONO_CHORUS (MOVES_COUNT_LAST_GEN + 248)
#define MOVE_FAIRYTIME_ARIA (MOVES_COUNT_LAST_GEN + 249)
#define MOVE_SUMMER_TIME (MOVES_COUNT_LAST_GEN + 250)
#define MOVE_WINTER_TIME (MOVES_COUNT_LAST_GEN + 251)
#define MOVE_DEFLORESTATION (MOVES_COUNT_LAST_GEN + 252)
#define MOVE_STONE_WALL (MOVES_COUNT_LAST_GEN + 253)
#define MOVE_SCRAPYARD_TERRAIN (MOVES_COUNT_LAST_GEN + 254)
#define MOVE_ICY_KISS (MOVES_COUNT_LAST_GEN + 255)
#define MOVE_HEATED_KISS (MOVES_COUNT_LAST_GEN + 256)
#define MOVE_VENOMBANE (MOVES_COUNT_LAST_GEN + 257)
#define MOVE_FISH_HARPOON (MOVES_COUNT_LAST_GEN + 258)
#define MOVE_BOLTING_SHOT (MOVES_COUNT_LAST_GEN + 259)
#define MOVE_ENGINE_ROAR (MOVES_COUNT_LAST_GEN + 260)
#define MOVE_REVERSAL_POWER (MOVES_COUNT_LAST_GEN + 261)
#define MOVE_SUPERSONIC_BREAK (MOVES_COUNT_LAST_GEN + 262)
#define MOVE_STELLAR_PUNCH (MOVES_COUNT_LAST_GEN + 263)
#define MOVE_ICE_CHAINS (MOVES_COUNT_LAST_GEN + 264)
#define MOVE_SEVERE_POISON (MOVES_COUNT_LAST_GEN + 265)
#define MOVE_ELECTRO_RAILGUN (MOVES_COUNT_LAST_GEN + 266)
#define MOVE_MOONY_PUNCH (MOVES_COUNT_LAST_GEN + 267)
#define MOVE_ECLIPSE (MOVES_COUNT_LAST_GEN + 268)
#define MOVE_LUNAR_FLARE (MOVES_COUNT_LAST_GEN + 269)
#define MOVE_MIGRAINE (MOVES_COUNT_LAST_GEN + 270)
#define MOVE_SEASONAL_HORN (MOVES_COUNT_LAST_GEN + 271)
#define MOVE_MIASMA_BEAM (MOVES_COUNT_LAST_GEN + 272)
#define MOVE_QUASAR_PULSE (MOVES_COUNT_LAST_GEN + 273)
#define MOVE_DUBIOUS_POTION (MOVES_COUNT_LAST_GEN + 274)
#define MOVE_SLUG_SHOT (MOVES_COUNT_LAST_GEN + 275)
#define MOVE_BACKLASH (MOVES_COUNT_LAST_GEN + 276)
#define MOVE_MAGICAL_BULLET (MOVES_COUNT_LAST_GEN + 277)
#define MOVE_SPECIAL_PHARMACY (MOVES_COUNT_LAST_GEN + 278)
#define MOVE_PSYTRICK (MOVES_COUNT_LAST_GEN + 279)
#define MOVE_DAZE_BARRAGE (MOVES_COUNT_LAST_GEN + 280)
#define MOVE_BULL_RUSH (MOVES_COUNT_LAST_GEN + 281)
// NEW
#define MOVE_GATHER_LIGHT (MOVES_COUNT_LAST_GEN + 282)
#define MOVE_PHOTON_CUT (MOVES_COUNT_LAST_GEN + 283)
#define MOVE_MATTER_RUPTURE (MOVES_COUNT_LAST_GEN + 284)
#define MOVE_DEEPSEA_RIFT (MOVES_COUNT_LAST_GEN + 285)
#define MOVE_CHRONO_GEAR (MOVES_COUNT_LAST_GEN + 286)
#define MOVE_FULL_BLOOM_AROMA (MOVES_COUNT_LAST_GEN + 287)
#define MOVE_ENDLESS_ICE_SPIKES (MOVES_COUNT_LAST_GEN + 288)
#define MOVE_LUMIERE_OF_DEMISE (MOVES_COUNT_LAST_GEN + 289)
#define MOVE_SHINING_METEOR_CRUSH (MOVES_COUNT_LAST_GEN + 290)

#define MOVES_COUNT_CUSTOM (MOVES_COUNT_LAST_GEN + 291)
