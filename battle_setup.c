...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_WALLACE_1, TRAINER_WALLACE_2, TRAINER_WALLACE_3, TRAINER_WALLACE_4, TRAINER_WALLACE_5, SOOTOPOLIS_CITY),
