...
#define SPECIES_TOXTRICITY_GIGANTAMAX                   GIGANTAMAX_START + 25
#define SPECIES_TOXTRICITY_AMPED_GIGANTAMAX             SPECIES_TOXTRICITY_GIGANTAMAX
...
#define SPECIES_URSHIFU_GIGANTAMAX                      GIGANTAMAX_START + 33
#define SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_GIGANTAMAX  SPECIES_URSHIFU_GIGANTAMAX
#define SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX   GIGANTAMAX_START + 34

#define CUSTOM_START                                    SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX

//Custom
#define SPECIES_REMORAID_COMMENSAL                      CUSTOM_START + 1
#define SPECIES_ONIX_CRYSTAL                            CUSTOM_START + 2
#define SPECIES_SNORLAX_SNOW                            CUSTOM_START + 3
#define SPECIES_ZYGARDE_CELL                            CUSTOM_START + 4
#define SPECIES_ZYGARDE_CORE                            CUSTOM_START + 5
#define SPECIES_SPIRITOMB_1                             CUSTOM_START + 6
#define SPECIES_SPIRITOMB_2                             CUSTOM_START + 7
#define SPECIES_SPIRITOMB_3                             CUSTOM_START + 8
#define SPECIES_MYSTIC_EGG                              CUSTOM_START + 9
#define SPECIES_PIKACHU_FLYING                          CUSTOM_START + 10
#define SPECIES_PIKACHU_SURFING                         CUSTOM_START + 11
#define SPECIES_COCOON_EGG                              CUSTOM_START + 12
#define SPECIES_SLUGMA_GRANITIC                         CUSTOM_START + 13
#define SPECIES_MAGCARGO_GRANITIC                       CUSTOM_START + 14
#define SPECIES_PARAS_ZOMBIFIED                         CUSTOM_START + 15
#define SPECIES_PARASECT_ZOMBIFIED                      CUSTOM_START + 16
#define SPECIES_SUDOWOODO_GOLDEN                        CUSTOM_START + 17
#define SPECIES_EEVEE_GENETIC                           CUSTOM_START + 18
#define SPECIES_VAPOREON_GENETIC                        CUSTOM_START + 19
#define SPECIES_JOLTEON_GENETIC                         CUSTOM_START + 20
#define SPECIES_FLAREON_GENETIC                         CUSTOM_START + 21
#define SPECIES_THU_FI_ZER                              CUSTOM_START + 22
#define SPECIES_THU_FI_ZER_GALARIAN                     CUSTOM_START + 23
#define SPECIES_SHADOW_LUGIA                            CUSTOM_START + 24
